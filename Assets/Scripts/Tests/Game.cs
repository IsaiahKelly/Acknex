...
namespace Tests
{
    public class Game : IAcknexRuntime
    {
        ...
        public Game()
        {
            ...
            _callbacks.Add("WAYGUARD1", WAYGUARD1);
            _callbacks.Add("WAYGUARD2", WAYGUARD2);
            _callbacks.Add("WAYGUARD3", WAYGUARD3);
            _callbacks.Add("DROPTROOPS2", DROPTROOPS2);
            _callbacks.Add("DROPTROOPS3", DROPTROOPS3);
            _callbacks.Add("REPTFLEE", REPTFLEE);
            _callbacks.Add("LOCATEREPT", LOCATEREPT);
            _callbacks.Add("WALLTIMER", WALLTIMER);
