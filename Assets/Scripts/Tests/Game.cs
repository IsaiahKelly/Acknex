...
namespace Tests
{
    public class Game : IAcknexRuntime
    {
        ...
        public Game()
        {
            ...
            _callbacks.Add("DROPINHOLE", DROPINHOLE);
            _callbacks.Add("OPENDOOR", OPENDOOR);
            _callbacks.Add("SETSHUTLEON", SETSHUTLEON);
            _callbacks.Add("CLOSESHUTLEDOOR", CLOSESHUTLEDOOR);
            _callbacks.Add("SHUTLEGOING", SHUTLEGOING);
            _callbacks.Add("SETSHUTLEWAY", SETSHUTLEWAY);
            _callbacks.Add("SHUTLEPARAM1", SHUTLEPARAM1);
            _callbacks.Add("SHUTLEPARAM2", SHUTLEPARAM2);
            _callbacks.Add("SHUTLEPARAM3", SHUTLEPARAM3);
            _callbacks.Add("SHUTLEPARAM4", SHUTLEPARAM4);
            _callbacks.Add("SHUTLEPARAM5", SHUTLEPARAM5);
            _callbacks.Add("SHUTLEPARAM6", SHUTLEPARAM6);
            _callbacks.Add("OPENSHUTLEDOOR", OPENSHUTLEDOOR);
            _callbacks.Add("STOPSETING", STOPSETING);
            _callbacks.Add("BIOIMPASSABLE", BIOIMPASSABLE);
            _callbacks.Add("BIOPASSABLE", BIOPASSABLE);
            _callbacks.Add("GOCITY", GOCITY);
            _callbacks.Add("GOCATEDRAL", GOCATEDRAL);
            _callbacks.Add("CHANGEHEIGHT", CHANGEHEIGHT);
            _callbacks.Add("SELECTOR", SELECTOR);
            _callbacks.Add("SETPASS1", SETPASS1);
            _callbacks.Add("SETPASS2", SETPASS2);
            _callbacks.Add("SETPASS3", SETPASS3);
            _callbacks.Add("SETPASS4", SETPASS4);
            _callbacks.Add("SETPASS5", SETPASS5);
            _callbacks.Add("SETPASS6", SETPASS6);
            _callbacks.Add("SETPASS7", SETPASS7);
            _callbacks.Add("SETPASS8", SETPASS8);
            _callbacks.Add("RESETPASS", RESETPASS);
            _callbacks.Add("OPENPASS1", OPENPASS1);
            _callbacks.Add("OPENPASS2", OPENPASS2);
            _callbacks.Add("OPENMIBDOOR", OPENMIBDOOR);
            _callbacks.Add("OPENBIODOOR", OPENBIODOOR);
            _callbacks.Add("OPENGRAYDOOR", OPENGRAYDOOR);
            _callbacks.Add("SETTRAPMIB", SETTRAPMIB);
            _callbacks.Add("WARNINGG", WARNINGG);
            _callbacks.Add("WARNINGB", WARNINGB);
            _callbacks.Add("WARNINGY", WARNINGY);
            _callbacks.Add("OPENGY1", OPENGY1);
            _callbacks.Add("OPENGY3", OPENGY3);
            _callbacks.Add("OPENGY7", OPENGY7);
            _callbacks.Add("OPENGY8", OPENGY8);
            _callbacks.Add("OPENGY9", OPENGY9);
            _callbacks.Add("OPENGY10", OPENGY10);
            _callbacks.Add("ROTATION", ROTATION);
            _callbacks.Add("PICKKEY1", PICKKEY1);
            _callbacks.Add("PICKKEY2", PICKKEY2);
            _callbacks.Add("PICKKEY3", PICKKEY3);
            _callbacks.Add("PICKKEY4", PICKKEY4);
            ...
            _callbacks.Add("GRAYTURN", GRAYTURN);
            _callbacks.Add("GRAYBACKOFF", GRAYBACKOFF);
            _callbacks.Add("GRAYWAIT", GRAYWAIT);
            _callbacks.Add("GRAYSLEEP", GRAYSLEEP);
            _callbacks.Add("GRAYWANDER", GRAYWANDER);
            _callbacks.Add("GRAYHIDE", GRAYHIDE);
            _callbacks.Add("GRAYWARNING", GRAYWARNING);
            _callbacks.Add("GRAYLOOKFOR", GRAYLOOKFOR);
            _callbacks.Add("GRAYFOLLOWATTACK", GRAYFOLLOWATTACK);
            _callbacks.Add("GRAYFOLLOWWARNING", GRAYFOLLOWWARNING);
            _callbacks.Add("GRAYTAUNT", GRAYTAUNT);
            _callbacks.Add("GRAYTAUNTSHOOT", GRAYTAUNTSHOOT);
            _callbacks.Add("GRAYAIM", GRAYAIM);
            _callbacks.Add("GRAYSHOOT", GRAYSHOOT);
            _callbacks.Add("GRAYESCAPE", GRAYESCAPE);
            _callbacks.Add("GRAYIMPLODE", GRAYIMPLODE);
            _callbacks.Add("GRAYHIT", GRAYHIT);
            _callbacks.Add("CYCLEGRAYBACKOFF", CYCLEGRAYBACKOFF);
            _callbacks.Add("CYCLEGRAYATTACK", CYCLEGRAYATTACK);
            _callbacks.Add("CYCLEGRAYHIDE", CYCLEGRAYHIDE);
            _callbacks.Add("CYCLEGRAYSHOOT", CYCLEGRAYSHOOT);
            _callbacks.Add("CYCLEGRAYWARNING", CYCLEGRAYWARNING);
            ...
            _callbacks.Add("ALARMOFF", ALARMOFF);
            _callbacks.Add("SETTROOPB", SETTROOPB);
            _callbacks.Add("HANGARTRAP", HANGARTRAP);
            _callbacks.Add("DEPOTREINFORCE", DEPOTREINFORCE);
            _callbacks.Add("BEDROOMREINFORCE", BEDROOMREINFORCE);
            _callbacks.Add("SETBRIEF", SETBRIEF);
            _callbacks.Add("SETBACK", SETBACK);
            _callbacks.Add("SETMIBA", SETMIBA);
            _callbacks.Add("SETMIBB", SETMIBB);
            _callbacks.Add("SETMIBC", SETMIBC);
            _callbacks.Add("CLOSEMIB", CLOSEMIB);
            _callbacks.Add("SETBIOA", SETBIOA);
            _callbacks.Add("SETATTACKA", SETATTACKA);
            _callbacks.Add("SETBIOREINFORCE", SETBIOREINFORCE);
            _callbacks.Add("CLOSEBIO", CLOSEBIO);
            _callbacks.Add("SETGRAYA", SETGRAYA);
            _callbacks.Add("SETGRAYB", SETGRAYB);
        ...
        public IEnumerator SHOWMAINMENU(IAcknexObject MY, IAcknexObject THERE)
        {
            ...
            _world.PlaySound(BIP03SND_8, 0.5f);
        ...
        public IEnumerator ENDOFLEVEL(IAcknexObject MY, IAcknexObject THERE)
        {
            ...
            _world.PlaySound(BIP03SND_4, 0.5f);
            var MENUITEM_7 = _world.GetObject(ObjectType.Skill, "MENUITEM");
        ...
        public IEnumerator KILLPLAYER(IAcknexObject MY, IAcknexObject THERE)
        {
            ...
            _world.PlaySound(DEATH00SND_9, 1f);
            {
        ...
        public IEnumerator DROPINHOLE(IAcknexObject MY, IAcknexObject THERE)
        {
            {
                var startTime = Time.time;
                var endTime = startTime + TimeUtils.FramesToTime((int)8f);
            ...
            var CTHOLERGN_3 = _world.AcknexObject.GetAcknexObject("CTHOLERGN");
            var temp_4 = CTHOLERGN_3.GetFloat("HERE");
            if (temp_4 == 0f)
            {
                yield break;
            }
            {
                var enumerator = FINISHPLAYER(MY, THERE);
                while (enumerator.MoveNext())
                {
                    var current = enumerator.Current;
                    if (current != null)
        ...
        {
            var DOOR10SND_0 = _world.AcknexObject.GetAcknexObject("DOOR10SND");
            var LOCKWALL_2 = _world.GetSynonymObject("LOCKWALL");
            _world.PlaySound(DOOR10SND_0, 0.3f, LOCKWALL_2);
            UP:
            var UPDOWNDOOR_5 = _world.GetSynonymObject("UPDOWNDOOR");
            var temp_6 = UPDOWNDOOR_5.GetFloat("CEIL_HGT");
            var UPDOWNDOOR_8 = _world.GetSynonymObject("UPDOWNDOOR");
            UPDOWNDOOR_8.SetFloat("CEIL_HGT", temp_6 + 0.2f);
            ...
            var CEILPOS_12 = _world.GetObject(ObjectType.Skill, "CEILPOS");
            var CEILPOS_12_val = CEILPOS_12.GetFloat("VAL");
            var UPDOWNDOOR_14 = _world.GetSynonymObject("UPDOWNDOOR");
            var temp_15 = UPDOWNDOOR_14.GetFloat("CEIL_HGT");
            if (temp_15 < CEILPOS_12_val)
            {
                goto UP;
            }
            {
                var startTime = Time.time;
                var endTime = startTime + TimeUtils.TicksToTime((int)35f);
                while (Time.time < endTime)
                {
                    yield return _waitForEndOfFrame;
                }
            }
            var DOOR10SND_17 = _world.AcknexObject.GetAcknexObject("DOOR10SND");
            var LOCKWALL_19 = _world.GetSynonymObject("LOCKWALL");
            _world.PlaySound(DOOR10SND_17, 0.3f, LOCKWALL_19);
            DOWN:
            var UPDOWNDOOR_22 = _world.GetSynonymObject("UPDOWNDOOR");
            var temp_23 = UPDOWNDOOR_22.GetFloat("CEIL_HGT");
            var UPDOWNDOOR_25 = _world.GetSynonymObject("UPDOWNDOOR");
            UPDOWNDOOR_25.SetFloat("CEIL_HGT", temp_23 + -0.2f);
            var RENDER_MODE_27 = _world.GetObject(ObjectType.Skill, "RENDER_MODE");
            RENDER_MODE_27.SetFloat("VAL", 1f);
            {
                var startTime = Time.time;
                var endTime = startTime + TimeUtils.TicksToTime((int)1f);
                while (Time.time < endTime)
            ...
            var UPDOWNDOOR_30 = _world.GetSynonymObject("UPDOWNDOOR");
            var temp_31 = UPDOWNDOOR_30.GetFloat("FLOOR_HGT");
            var UPDOWNDOOR_33 = _world.GetSynonymObject("UPDOWNDOOR");
            var temp_34 = UPDOWNDOOR_33.GetFloat("CEIL_HGT");
            if (temp_34 > temp_31)
            {
                goto DOWN;
            }
            var LOCKTEX_35 = _world.GetSynonymObject("LOCKTEX");
            var LOCKWALL_37 = _world.GetSynonymObject("LOCKWALL");
            LOCKWALL_37.SetAcknexObjectAll("TEXTURE", LOCKTEX_35);
            _world.SetSynonymObject("UPDOWNDOOR", null);
            _world.SetSynonymObject("LOCKWALL", null);
            _world.SetSynonymObject("LOCKTEX", null);
            //Unknown keyword: 
            yield break;
        }
        public IEnumerator SETSHUTLEON(IAcknexObject MY, IAcknexObject THERE)
        {
            var SHUTLEGENIUSTNG_2 = _world.AcknexObject.GetAcknexObject("SHUTLEGENIUSTNG");
            var temp_3 = SHUTLEGENIUSTNG_2.GetFloat("FLAG4");
            if (temp_3 == 0f)
            {
                goto MESSAGE;
            }
            var SHUTLEGENIUSTNG_6 = _world.AcknexObject.GetAcknexObject("SHUTLEGENIUSTNG");
            var temp_7 = SHUTLEGENIUSTNG_6.GetFloat("FLAG1");
            if (temp_7 == 1f)
            {
                yield break;
            }
            var WMT19ONTEX_8 = _world.AcknexObject.GetAcknexObject("WMT19ONTEX");
            var SHUTLEONOFFWALL_10 = _world.AcknexObject.GetAcknexObject("SHUTLEONOFFWALL");
            SHUTLEONOFFWALL_10.SetAcknexObject("TEXTURE", WMT19ONTEX_8);
            var CLOSESHUTLEDOOR_11 = _world.AcknexObject.GetAcknexObject("CLOSESHUTLEDOOR");
            var SHUTLERGN_13 = _world.AcknexObject.GetAcknexObject("SHUTLERGN");
            SHUTLERGN_13.SetAcknexObject("EACH_TICK", CLOSESHUTLEDOOR_11);
            var SHUTLEGENIUSTNG_16 = _world.AcknexObject.GetAcknexObject("SHUTLEGENIUSTNG");
            SHUTLEGENIUSTNG_16.SetFloat("FLAG1", 1f);
            var WALK_PERIOD_18 = _world.GetObject(ObjectType.Skill, "WALK_PERIOD");
            WALK_PERIOD_18.SetFloat("VAL", 0f);
            var SHUTLEGENIUSTNG_21 = _world.AcknexObject.GetAcknexObject("SHUTLEGENIUSTNG");
            var temp_22 = SHUTLEGENIUSTNG_21.GetFloat("FLAG2");
            if (temp_22 == 0f)
            {
                var SHUTLEACTIONWAY2_23 = _world.GetSynonymObject("SHUTLEACTIONWAY2");
                var SHUTLEDOORRGN_25 = _world.AcknexObject.GetAcknexObject("SHUTLEDOORRGN");
                SHUTLEDOORRGN_25.SetAcknexObject("EACH_TICK", SHUTLEACTIONWAY2_23);
            }
            var SHUTLEGENIUSTNG_28 = _world.AcknexObject.GetAcknexObject("SHUTLEGENIUSTNG");
            var temp_29 = SHUTLEGENIUSTNG_28.GetFloat("FLAG2");
            if (temp_29 == 1f)
            {
                var SHUTLEACTIONWAY1_30 = _world.GetSynonymObject("SHUTLEACTIONWAY1");
                var SHUTLEDOORRGN_32 = _world.AcknexObject.GetAcknexObject("SHUTLEDOORRGN");
                SHUTLEDOORRGN_32.SetAcknexObject("EACH_TICK", SHUTLEACTIONWAY1_30);
            }
            yield break;
            MESSAGE:
            var WRN20STR_33 = _world.AcknexObject.GetAcknexObject("WRN20STR");
            _world.SetSynonymObject("MESSAGE_TEXT", WRN20STR_33);
            {
                var enumerator = DISPLAYMESSAGE(MY, THERE);
                while (enumerator.MoveNext())
                {
        ...
        public IEnumerator CLOSESHUTLEDOOR(IAcknexObject MY, IAcknexObject THERE)
        {
            var SHUTLEDOORRGN_2 = _world.AcknexObject.GetAcknexObject("SHUTLEDOORRGN");
            var temp_3 = SHUTLEDOORRGN_2.GetFloat("CEIL_HGT");
            var SHUTLEDOORRGN_5 = _world.AcknexObject.GetAcknexObject("SHUTLEDOORRGN");
            SHUTLEDOORRGN_5.SetFloat("CEIL_HGT", temp_3 + -0.1f);
            var SHUTLERGN_7 = _world.AcknexObject.GetAcknexObject("SHUTLERGN");
            var temp_8 = SHUTLERGN_7.GetFloat("FLOOR_HGT");
            var SHUTLEDOORRGN_10 = _world.AcknexObject.GetAcknexObject("SHUTLEDOORRGN");
            var temp_11 = SHUTLEDOORRGN_10.GetFloat("CEIL_HGT");
            if (temp_11 < temp_8)
            {
                goto ENDCLOSE;
            }
            yield break;
            ENDCLOSE:
            var SHUTLERGN_12 = _world.AcknexObject.GetAcknexObject("SHUTLERGN");
            var HERE_13 = _world.GetSynonymObject("HERE");
            if (HERE_13 != SHUTLERGN_12)
            {
                goto ABORT;
            }
            var SHUTLERGN_16 = _world.AcknexObject.GetAcknexObject("SHUTLERGN");
            SHUTLERGN_16.SetFloat("AMBIENT", 1f);
            var SHUTLEDOORWALL_19 = _world.AcknexObject.GetAcknexObject("SHUTLEDOORWALL");
            SHUTLEDOORWALL_19.SetFloatAll("PASSABLE", 0f);
            var SHUTLEGOING_20 = _world.AcknexObject.GetAcknexObject("SHUTLEGOING");
            var SHUTLERGN_22 = _world.AcknexObject.GetAcknexObject("SHUTLERGN");
            SHUTLERGN_22.SetAcknexObject("EACH_TICK", SHUTLEGOING_20);
            yield break;
            ABORT:
            var SHUTLEDOORRGN_25 = _world.AcknexObject.GetAcknexObject("SHUTLEDOORRGN");
            SHUTLEDOORRGN_25.SetAcknexObject("EACH_TICK", null);
            var OPENSHUTLEDOOR_26 = _world.AcknexObject.GetAcknexObject("OPENSHUTLEDOOR");
            var SHUTLERGN_28 = _world.AcknexObject.GetAcknexObject("SHUTLERGN");
            SHUTLERGN_28.SetAcknexObject("EACH_TICK", OPENSHUTLEDOOR_26);
            //Unknown keyword: 
            yield break;
        }
        public IEnumerator SHUTLEGOING(IAcknexObject MY, IAcknexObject THERE)
        {
            var VZ_0 = _world.GetObject(ObjectType.Skill, "VZ");
            var VZ_0_val = VZ_0.GetFloat("VAL");
            var PLAYER_Z_1 = _world.GetObject(ObjectType.Skill, "PLAYER_Z");
            var PLAYER_Z_1_val = PLAYER_Z_1.GetFloat("VAL");
            var PLAYER_Z_2 = _world.GetObject(ObjectType.Skill, "PLAYER_Z");
            PLAYER_Z_2.SetFloat("VAL", PLAYER_Z_1_val + VZ_0_val);
            var VZ_3 = _world.GetObject(ObjectType.Skill, "VZ");
            var VZ_3_val = VZ_3.GetFloat("VAL");
            var SHUTLERGN_5 = _world.AcknexObject.GetAcknexObject("SHUTLERGN");
            var temp_6 = SHUTLERGN_5.GetFloat("FLOOR_HGT");
            var SHUTLERGN_8 = _world.AcknexObject.GetAcknexObject("SHUTLERGN");
            SHUTLERGN_8.SetFloat("FLOOR_HGT", temp_6 + VZ_3_val);
            var VZ_9 = _world.GetObject(ObjectType.Skill, "VZ");
            var VZ_9_val = VZ_9.GetFloat("VAL");
            var SHUTLEWINDOWRGN_11 = _world.AcknexObject.GetAcknexObject("SHUTLEWINDOWRGN");
            var temp_12 = SHUTLEWINDOWRGN_11.GetFloat("FLOOR_HGT");
            var SHUTLEWINDOWRGN_14 = _world.AcknexObject.GetAcknexObject("SHUTLEWINDOWRGN");
            SHUTLEWINDOWRGN_14.SetFloat("FLOOR_HGT", temp_12 + VZ_9_val);
            var VZ_15 = _world.GetObject(ObjectType.Skill, "VZ");
            var VZ_15_val = VZ_15.GetFloat("VAL");
            var SHUTLERGN_17 = _world.AcknexObject.GetAcknexObject("SHUTLERGN");
            var temp_18 = SHUTLERGN_17.GetFloat("CEIL_HGT");
            var SHUTLERGN_20 = _world.AcknexObject.GetAcknexObject("SHUTLERGN");
            SHUTLERGN_20.SetFloat("CEIL_HGT", temp_18 + VZ_15_val);
            var VZ_21 = _world.GetObject(ObjectType.Skill, "VZ");
            var VZ_21_val = VZ_21.GetFloat("VAL");
            var SHUTLEWINDOWRGN_23 = _world.AcknexObject.GetAcknexObject("SHUTLEWINDOWRGN");
            var temp_24 = SHUTLEWINDOWRGN_23.GetFloat("CEIL_HGT");
            var SHUTLEWINDOWRGN_26 = _world.AcknexObject.GetAcknexObject("SHUTLEWINDOWRGN");
            SHUTLEWINDOWRGN_26.SetFloat("CEIL_HGT", temp_24 + VZ_21_val);
            var SHUTLERGN_27 = _world.AcknexObject.GetAcknexObject("SHUTLERGN");
            var VX_28 = _world.GetObject(ObjectType.Skill, "VX");
            var VX_28_val = VX_28.GetFloat("VAL");
            var VY_29 = _world.GetObject(ObjectType.Skill, "VY");
            var VY_29_val = VY_29.GetFloat("VAL");
            _world.Shift(SHUTLERGN_27, VX_28_val, VY_29_val);
            var SHUTLEBORDERRGN_30 = _world.AcknexObject.GetAcknexObject("SHUTLEBORDERRGN");
            var VX_31 = _world.GetObject(ObjectType.Skill, "VX");
            var VX_31_val = VX_31.GetFloat("VAL");
            var VY_32 = _world.GetObject(ObjectType.Skill, "VY");
            var VY_32_val = VY_32.GetFloat("VAL");
            _world.Shift(SHUTLEBORDERRGN_30, VX_31_val, VY_32_val);
            var SHUTLEBORDER2RGN_33 = _world.AcknexObject.GetAcknexObject("SHUTLEBORDER2RGN");
            var VX_34 = _world.GetObject(ObjectType.Skill, "VX");
            var VX_34_val = VX_34.GetFloat("VAL");
            var VY_35 = _world.GetObject(ObjectType.Skill, "VY");
            var VY_35_val = VY_35.GetFloat("VAL");
            _world.Shift(SHUTLEBORDER2RGN_33, VX_34_val, VY_35_val);
            var SHUTLEWINDOWRGN_36 = _world.AcknexObject.GetAcknexObject("SHUTLEWINDOWRGN");
            var VX_37 = _world.GetObject(ObjectType.Skill, "VX");
            var VX_37_val = VX_37.GetFloat("VAL");
            var VY_38 = _world.GetObject(ObjectType.Skill, "VY");
            var VY_38_val = VY_38.GetFloat("VAL");
            _world.Shift(SHUTLEWINDOWRGN_36, VX_37_val, VY_38_val);
            var SHUTLEDOORRGN_39 = _world.AcknexObject.GetAcknexObject("SHUTLEDOORRGN");
            var VX_40 = _world.GetObject(ObjectType.Skill, "VX");
            var VX_40_val = VX_40.GetFloat("VAL");
            var VY_41 = _world.GetObject(ObjectType.Skill, "VY");
            var VY_41_val = VY_41.GetFloat("VAL");
            _world.Shift(SHUTLEDOORRGN_39, VX_40_val, VY_41_val);
            var VXFLOOR_42 = _world.GetObject(ObjectType.Skill, "VXFLOOR");
            var VXFLOOR_42_val = VXFLOOR_42.GetFloat("VAL");
            var SHUTLERGN_44 = _world.AcknexObject.GetAcknexObject("SHUTLERGN");
            var temp_45 = SHUTLERGN_44.GetFloat("FLOOR_OFFS_X");
            var SHUTLERGN_47 = _world.AcknexObject.GetAcknexObject("SHUTLERGN");
            SHUTLERGN_47.SetFloat("FLOOR_OFFS_X", temp_45 + VXFLOOR_42_val);
            var VXFLOOR_48 = _world.GetObject(ObjectType.Skill, "VXFLOOR");
            var VXFLOOR_48_val = VXFLOOR_48.GetFloat("VAL");
            var SHUTLEWINDOWRGN_50 = _world.AcknexObject.GetAcknexObject("SHUTLEWINDOWRGN");
            var temp_51 = SHUTLEWINDOWRGN_50.GetFloat("FLOOR_OFFS_X");
            var SHUTLEWINDOWRGN_53 = _world.AcknexObject.GetAcknexObject("SHUTLEWINDOWRGN");
            SHUTLEWINDOWRGN_53.SetFloat("FLOOR_OFFS_X", temp_51 + VXFLOOR_48_val);
            var VXCEIL_54 = _world.GetObject(ObjectType.Skill, "VXCEIL");
            var VXCEIL_54_val = VXCEIL_54.GetFloat("VAL");
            var SHUTLERGN_56 = _world.AcknexObject.GetAcknexObject("SHUTLERGN");
            var temp_57 = SHUTLERGN_56.GetFloat("CEIL_OFFS_X");
            var SHUTLERGN_59 = _world.AcknexObject.GetAcknexObject("SHUTLERGN");
            SHUTLERGN_59.SetFloat("CEIL_OFFS_X", temp_57 + VXCEIL_54_val);
            var VXCEIL_60 = _world.GetObject(ObjectType.Skill, "VXCEIL");
            var VXCEIL_60_val = VXCEIL_60.GetFloat("VAL");
            var SHUTLEWINDOWRGN_62 = _world.AcknexObject.GetAcknexObject("SHUTLEWINDOWRGN");
            var temp_63 = SHUTLEWINDOWRGN_62.GetFloat("CEIL_OFFS_X");
            var SHUTLEWINDOWRGN_65 = _world.AcknexObject.GetAcknexObject("SHUTLEWINDOWRGN");
            SHUTLEWINDOWRGN_65.SetFloat("CEIL_OFFS_X", temp_63 + VXCEIL_60_val);
            var VYFLOOR_66 = _world.GetObject(ObjectType.Skill, "VYFLOOR");
            var VYFLOOR_66_val = VYFLOOR_66.GetFloat("VAL");
            var SHUTLERGN_68 = _world.AcknexObject.GetAcknexObject("SHUTLERGN");
            var temp_69 = SHUTLERGN_68.GetFloat("FLOOR_OFFS_Y");
            var SHUTLERGN_71 = _world.AcknexObject.GetAcknexObject("SHUTLERGN");
            SHUTLERGN_71.SetFloat("FLOOR_OFFS_Y", temp_69 + VYFLOOR_66_val);
            var VYFLOOR_72 = _world.GetObject(ObjectType.Skill, "VYFLOOR");
            var VYFLOOR_72_val = VYFLOOR_72.GetFloat("VAL");
            var SHUTLEWINDOWRGN_74 = _world.AcknexObject.GetAcknexObject("SHUTLEWINDOWRGN");
            var temp_75 = SHUTLEWINDOWRGN_74.GetFloat("FLOOR_OFFS_Y");
            var SHUTLEWINDOWRGN_77 = _world.AcknexObject.GetAcknexObject("SHUTLEWINDOWRGN");
            SHUTLEWINDOWRGN_77.SetFloat("FLOOR_OFFS_Y", temp_75 + VYFLOOR_72_val);
            var VYCEIL_78 = _world.GetObject(ObjectType.Skill, "VYCEIL");
            var VYCEIL_78_val = VYCEIL_78.GetFloat("VAL");
            var SHUTLERGN_80 = _world.AcknexObject.GetAcknexObject("SHUTLERGN");
            var temp_81 = SHUTLERGN_80.GetFloat("CEIL_OFFS_Y");
            var SHUTLERGN_83 = _world.AcknexObject.GetAcknexObject("SHUTLERGN");
            SHUTLERGN_83.SetFloat("CEIL_OFFS_Y", temp_81 + VYCEIL_78_val);
            var VYCEIL_84 = _world.GetObject(ObjectType.Skill, "VYCEIL");
            var VYCEIL_84_val = VYCEIL_84.GetFloat("VAL");
            var SHUTLEWINDOWRGN_86 = _world.AcknexObject.GetAcknexObject("SHUTLEWINDOWRGN");
            var temp_87 = SHUTLEWINDOWRGN_86.GetFloat("CEIL_OFFS_Y");
            var SHUTLEWINDOWRGN_89 = _world.AcknexObject.GetAcknexObject("SHUTLEWINDOWRGN");
            SHUTLEWINDOWRGN_89.SetFloat("CEIL_OFFS_Y", temp_87 + VYCEIL_84_val);
            var SHUTLEGENIUSTNG_91 = _world.AcknexObject.GetAcknexObject("SHUTLEGENIUSTNG");
            var SHUTLEGENIUSTNG_93 = _world.AcknexObject.GetAcknexObject("SHUTLEGENIUSTNG");
            var temp_94 = SHUTLEGENIUSTNG_93.GetFloat("X");
            var SHUTLE1WALL_97 = _world.AcknexObject.GetAcknexObject("SHUTLE1WALL");
            var temp_98 = SHUTLE1WALL_97.GetFloat("X1");
            var SHUTLE2WALL_101 = _world.AcknexObject.GetAcknexObject("SHUTLE2WALL");
            var temp_102 = SHUTLE2WALL_101.GetFloat("X1");
            SHUTLEGENIUSTNG_91.SetFloat("X", (temp_98 + temp_102) / 2f);
            var SHUTLEGENIUSTNG_107 = _world.AcknexObject.GetAcknexObject("SHUTLEGENIUSTNG");
            var SHUTLEGENIUSTNG_109 = _world.AcknexObject.GetAcknexObject("SHUTLEGENIUSTNG");
            var temp_110 = SHUTLEGENIUSTNG_109.GetFloat("Y");
            var SHUTLE1WALL_113 = _world.AcknexObject.GetAcknexObject("SHUTLE1WALL");
            var temp_114 = SHUTLE1WALL_113.GetFloat("Y1");
            var SHUTLE2WALL_117 = _world.AcknexObject.GetAcknexObject("SHUTLE2WALL");
            var temp_118 = SHUTLE2WALL_117.GetFloat("Y1");
            SHUTLEGENIUSTNG_107.SetFloat("Y", (temp_114 + temp_118) / 2f);
            var SHUTLERGN_122 = _world.AcknexObject.GetAcknexObject("SHUTLERGN");
            var VR_123 = _world.GetObject(ObjectType.Skill, "VR");
            var VR_123_val = VR_123.GetFloat("VAL");
            _world.Rotate(SHUTLERGN_122, VR_123_val);
            var SHUTLEBORDERRGN_124 = _world.AcknexObject.GetAcknexObject("SHUTLEBORDERRGN");
            var VR_125 = _world.GetObject(ObjectType.Skill, "VR");
            var VR_125_val = VR_125.GetFloat("VAL");
            _world.Rotate(SHUTLEBORDERRGN_124, VR_125_val);
            var SHUTLEBORDER2RGN_126 = _world.AcknexObject.GetAcknexObject("SHUTLEBORDER2RGN");
            var VR_127 = _world.GetObject(ObjectType.Skill, "VR");
            var VR_127_val = VR_127.GetFloat("VAL");
            _world.Rotate(SHUTLEBORDER2RGN_126, VR_127_val);
            var SHUTLEWINDOWRGN_128 = _world.AcknexObject.GetAcknexObject("SHUTLEWINDOWRGN");
            var VR_129 = _world.GetObject(ObjectType.Skill, "VR");
            var VR_129_val = VR_129.GetFloat("VAL");
            _world.Rotate(SHUTLEWINDOWRGN_128, VR_129_val);
            var SHUTLEDOORRGN_130 = _world.AcknexObject.GetAcknexObject("SHUTLEDOORRGN");
            var VR_131 = _world.GetObject(ObjectType.Skill, "VR");
            var VR_131_val = VR_131.GetFloat("VAL");
            _world.Rotate(SHUTLEDOORRGN_130, VR_131_val);
            var VR_132 = _world.GetObject(ObjectType.Skill, "VR");
            var VR_132_val = VR_132.GetFloat("VAL");
            var SHUTLERGN_134 = _world.AcknexObject.GetAcknexObject("SHUTLERGN");
            //Unknown Property Type: Region.FLOOR_ANGLE
            var SHUTLERGN_137 = _world.AcknexObject.GetAcknexObject("SHUTLERGN");
            //Unknown Property Type: Region.FLOOR_ANGLE
            var VR_138 = _world.GetObject(ObjectType.Skill, "VR");
            var VR_138_val = VR_138.GetFloat("VAL");
            var SHUTLEWINDOWRGN_140 = _world.AcknexObject.GetAcknexObject("SHUTLEWINDOWRGN");
            //Unknown Property Type: Region.FLOOR_ANGLE
            var SHUTLEWINDOWRGN_143 = _world.AcknexObject.GetAcknexObject("SHUTLEWINDOWRGN");
            //Unknown Property Type: Region.FLOOR_ANGLE
            var VR_144 = _world.GetObject(ObjectType.Skill, "VR");
            var VR_144_val = VR_144.GetFloat("VAL");
            var SHUTLERGN_146 = _world.AcknexObject.GetAcknexObject("SHUTLERGN");
            //Unknown Property Type: Region.CEIL_ANGLE
            var SHUTLERGN_149 = _world.AcknexObject.GetAcknexObject("SHUTLERGN");
            //Unknown Property Type: Region.CEIL_ANGLE
            var VR_150 = _world.GetObject(ObjectType.Skill, "VR");
            var VR_150_val = VR_150.GetFloat("VAL");
            var SHUTLEWINDOWRGN_152 = _world.AcknexObject.GetAcknexObject("SHUTLEWINDOWRGN");
            //Unknown Property Type: Region.CEIL_ANGLE
            var SHUTLEWINDOWRGN_155 = _world.AcknexObject.GetAcknexObject("SHUTLEWINDOWRGN");
            //Unknown Property Type: Region.CEIL_ANGLE
            var RENDER_MODE_157 = _world.GetObject(ObjectType.Skill, "RENDER_MODE");
            RENDER_MODE_157.SetFloat("VAL", 1f);
            //Unknown keyword: 
            yield break;
        }
        public IEnumerator SETSHUTLEWAY(IAcknexObject MY, IAcknexObject THERE)
        {
            var SHUTLEGENIUSTNG_2 = _world.AcknexObject.GetAcknexObject("SHUTLEGENIUSTNG");
            var temp_3 = SHUTLEGENIUSTNG_2.GetFloat("FLAG1");
            if (temp_3 == 1f)
            {
                goto MESSAGE;
            }
            var SHUTLEGENIUSTNG_6 = _world.AcknexObject.GetAcknexObject("SHUTLEGENIUSTNG");
            SHUTLEGENIUSTNG_6.SetFloat("FLAG4", 1f);
            var SHUTLEGENIUSTNG_9 = _world.AcknexObject.GetAcknexObject("SHUTLEGENIUSTNG");
            var temp_10 = SHUTLEGENIUSTNG_9.GetFloat("FLAG2");
            if (temp_10 == 1f)
            {
                goto SETWAY2;
            }
            var CARD01SND_11 = _world.AcknexObject.GetAcknexObject("CARD01SND");
            _world.PlaySound(CARD01SND_11, 0.3f);
            var SHUTLETEXTUREWAY1_13 = _world.GetSynonymObject("SHUTLETEXTUREWAY1");
            var SHUTLEWAYWALL_15 = _world.AcknexObject.GetAcknexObject("SHUTLEWAYWALL");
            SHUTLEWAYWALL_15.SetAcknexObject("TEXTURE", SHUTLETEXTUREWAY1_13);
            var SHUTLEGENIUSTNG_18 = _world.AcknexObject.GetAcknexObject("SHUTLEGENIUSTNG");
            SHUTLEGENIUSTNG_18.SetFloat("FLAG2", 1f);
            yield break;
            SETWAY2:
            var CARD01SND_19 = _world.AcknexObject.GetAcknexObject("CARD01SND");
            _world.PlaySound(CARD01SND_19, 0.3f);
            var SHUTLEGENIUSTNG_23 = _world.AcknexObject.GetAcknexObject("SHUTLEGENIUSTNG");
            SHUTLEGENIUSTNG_23.SetFloat("FLAG2", 0f);
            var SHUTLETEXTUREWAY2_24 = _world.GetSynonymObject("SHUTLETEXTUREWAY2");
            var SHUTLEWAYWALL_26 = _world.AcknexObject.GetAcknexObject("SHUTLEWAYWALL");
            SHUTLEWAYWALL_26.SetAcknexObject("TEXTURE", SHUTLETEXTUREWAY2_24);
            yield break;
            MESSAGE:
            var WRN21STR_27 = _world.AcknexObject.GetAcknexObject("WRN21STR");
            _world.SetSynonymObject("MESSAGE_TEXT", WRN21STR_27);
            {
                var enumerator = DISPLAYMESSAGE(MY, THERE);
                while (enumerator.MoveNext())
                {
        ...
        public IEnumerator SHUTLEPARAM1(IAcknexObject MY, IAcknexObject THERE)
        {
            var SHUTLEGENIUSTNG_2 = _world.AcknexObject.GetAcknexObject("SHUTLEGENIUSTNG");
            var temp_3 = SHUTLEGENIUSTNG_2.GetFloat("FLAG1");
            if (temp_3 == 0f)
            ...
            var SHUTLEGENIUSTNG_6 = _world.AcknexObject.GetAcknexObject("SHUTLEGENIUSTNG");
            var temp_7 = SHUTLEGENIUSTNG_6.GetFloat("X");
            if (temp_7 < -414f)
            {
                goto FASEEND;
            }
            var SHUTLEGENIUSTNG_10 = _world.AcknexObject.GetAcknexObject("SHUTLEGENIUSTNG");
            var temp_11 = SHUTLEGENIUSTNG_10.GetFloat("X");
            if (temp_11 < -400f)
            {
                goto FASE7;
            }
            var SHUTLEGENIUSTNG_14 = _world.AcknexObject.GetAcknexObject("SHUTLEGENIUSTNG");
            var temp_15 = SHUTLEGENIUSTNG_14.GetFloat("X");
            if (temp_15 < -232f)
            {
                goto FASE6;
            }
            var SHUTLEGENIUSTNG_18 = _world.AcknexObject.GetAcknexObject("SHUTLEGENIUSTNG");
            var temp_19 = SHUTLEGENIUSTNG_18.GetFloat("X");
            if (temp_19 < -224f)
            {
                goto FASE5;
            }
            var SHUTLEGENIUSTNG_22 = _world.AcknexObject.GetAcknexObject("SHUTLEGENIUSTNG");
            var temp_23 = SHUTLEGENIUSTNG_22.GetFloat("X");
            if (temp_23 < -160f)
            {
                goto FASE4;
            }
            var SHUTLEGENIUSTNG_26 = _world.AcknexObject.GetAcknexObject("SHUTLEGENIUSTNG");
            var temp_27 = SHUTLEGENIUSTNG_26.GetFloat("X");
            if (temp_27 < -151f)
            {
                goto FASE3;
            }
            var SHUTLEGENIUSTNG_30 = _world.AcknexObject.GetAcknexObject("SHUTLEGENIUSTNG");
            var temp_31 = SHUTLEGENIUSTNG_30.GetFloat("X");
            if (temp_31 < -100f)
            {
                goto FASE2;
            }
            FASE1:
            var SHUTLEGENIUSTNG_34 = _world.AcknexObject.GetAcknexObject("SHUTLEGENIUSTNG");
            var temp_35 = SHUTLEGENIUSTNG_34.GetFloat("FLAG3");
            if (temp_35 == 0f)
            {
                goto UNLOCK;
            }
            var VX_37 = _world.GetObject(ObjectType.Skill, "VX");
            VX_37.SetFloat("VAL", -0.12209f);
            var VY_39 = _world.GetObject(ObjectType.Skill, "VY");
            VY_39.SetFloat("VAL", -0.25f);
            var VZ_41 = _world.GetObject(ObjectType.Skill, "VZ");
            VZ_41.SetFloat("VAL", -0.03651f);
            var VR_43 = _world.GetObject(ObjectType.Skill, "VR");
            VR_43.SetFloat("VAL", -0.01826f);
            var VXCEIL_45 = _world.GetObject(ObjectType.Skill, "VXCEIL");
            VXCEIL_45.SetFloat("VAL", 3.906f);
            var VXFLOOR_47 = _world.GetObject(ObjectType.Skill, "VXFLOOR");
            VXFLOOR_47.SetFloat("VAL", 3.906f);
            var VYCEIL_49 = _world.GetObject(ObjectType.Skill, "VYCEIL");
            VYCEIL_49.SetFloat("VAL", 8f);
            var VYFLOOR_51 = _world.GetObject(ObjectType.Skill, "VYFLOOR");
            VYFLOOR_51.SetFloat("VAL", 8f);
            yield break;
            FASE2:
            var VX_53 = _world.GetObject(ObjectType.Skill, "VX");
            VX_53.SetFloat("VAL", -0.5f);
            var VY_55 = _world.GetObject(ObjectType.Skill, "VY");
            VY_55.SetFloat("VAL", 0f);
            var VZ_57 = _world.GetObject(ObjectType.Skill, "VZ");
            VZ_57.SetFloat("VAL", 0.078431f);
            var VR_59 = _world.GetObject(ObjectType.Skill, "VR");
            VR_59.SetFloat("VAL", 0f);
            var VXCEIL_61 = _world.GetObject(ObjectType.Skill, "VXCEIL");
            VXCEIL_61.SetFloat("VAL", 16f);
            var VXFLOOR_63 = _world.GetObject(ObjectType.Skill, "VXFLOOR");
            VXFLOOR_63.SetFloat("VAL", 16f);
            var VYCEIL_65 = _world.GetObject(ObjectType.Skill, "VYCEIL");
            VYCEIL_65.SetFloat("VAL", 0f);
            var VYFLOOR_67 = _world.GetObject(ObjectType.Skill, "VYFLOOR");
            VYFLOOR_67.SetFloat("VAL", 0f);
            yield break;
            FASE3:
            var VX_69 = _world.GetObject(ObjectType.Skill, "VX");
            VX_69.SetFloat("VAL", -0.5f);
            var VY_71 = _world.GetObject(ObjectType.Skill, "VY");
            VY_71.SetFloat("VAL", 0.5f);
            var VZ_73 = _world.GetObject(ObjectType.Skill, "VZ");
            VZ_73.SetFloat("VAL", -0.222222f);
            var VR_75 = _world.GetObject(ObjectType.Skill, "VR");
            VR_75.SetFloat("VAL", -0.04363f);
            var VXCEIL_77 = _world.GetObject(ObjectType.Skill, "VXCEIL");
            VXCEIL_77.SetFloat("VAL", 16f);
            var VXFLOOR_79 = _world.GetObject(ObjectType.Skill, "VXFLOOR");
            VXFLOOR_79.SetFloat("VAL", 16f);
            var VYCEIL_81 = _world.GetObject(ObjectType.Skill, "VYCEIL");
            VYCEIL_81.SetFloat("VAL", -16f);
            var VYFLOOR_83 = _world.GetObject(ObjectType.Skill, "VYFLOOR");
            VYFLOOR_83.SetFloat("VAL", -16f);
            yield break;
            FASE4:
            var VX_85 = _world.GetObject(ObjectType.Skill, "VX");
            VX_85.SetFloat("VAL", -0.5f);
            var VY_87 = _world.GetObject(ObjectType.Skill, "VY");
            VY_87.SetFloat("VAL", 0.5f);
            var VZ_89 = _world.GetObject(ObjectType.Skill, "VZ");
            VZ_89.SetFloat("VAL", -0.078125f);
            var VR_91 = _world.GetObject(ObjectType.Skill, "VR");
            VR_91.SetFloat("VAL", 0f);
            var VXCEIL_93 = _world.GetObject(ObjectType.Skill, "VXCEIL");
            VXCEIL_93.SetFloat("VAL", 16f);
            var VXFLOOR_95 = _world.GetObject(ObjectType.Skill, "VXFLOOR");
            VXFLOOR_95.SetFloat("VAL", 16f);
            var VYCEIL_97 = _world.GetObject(ObjectType.Skill, "VYCEIL");
            VYCEIL_97.SetFloat("VAL", -16f);
            var VYFLOOR_99 = _world.GetObject(ObjectType.Skill, "VYFLOOR");
            VYFLOOR_99.SetFloat("VAL", -16f);
            yield break;
            FASE5:
            var VX_101 = _world.GetObject(ObjectType.Skill, "VX");
            VX_101.SetFloat("VAL", -0.5f);
            var VY_103 = _world.GetObject(ObjectType.Skill, "VY");
            VY_103.SetFloat("VAL", 0.5f);
            var VZ_105 = _world.GetObject(ObjectType.Skill, "VZ");
            VZ_105.SetFloat("VAL", -0.625f);
            var VR_107 = _world.GetObject(ObjectType.Skill, "VR");
            VR_107.SetFloat("VAL", 0.04908f);
            var VXCEIL_109 = _world.GetObject(ObjectType.Skill, "VXCEIL");
            VXCEIL_109.SetFloat("VAL", 16f);
            var VXFLOOR_111 = _world.GetObject(ObjectType.Skill, "VXFLOOR");
            VXFLOOR_111.SetFloat("VAL", 16f);
            var VYCEIL_113 = _world.GetObject(ObjectType.Skill, "VYCEIL");
            VYCEIL_113.SetFloat("VAL", -16f);
            var VYFLOOR_115 = _world.GetObject(ObjectType.Skill, "VYFLOOR");
            VYFLOOR_115.SetFloat("VAL", -16f);
            yield break;
            FASE6:
            var VX_117 = _world.GetObject(ObjectType.Skill, "VX");
            VX_117.SetFloat("VAL", -0.5f);
            var VY_119 = _world.GetObject(ObjectType.Skill, "VY");
            VY_119.SetFloat("VAL", 0f);
            var VZ_121 = _world.GetObject(ObjectType.Skill, "VZ");
            VZ_121.SetFloat("VAL", -0.238095f);
            var VR_123 = _world.GetObject(ObjectType.Skill, "VR");
            VR_123.SetFloat("VAL", 0f);
            var VXCEIL_125 = _world.GetObject(ObjectType.Skill, "VXCEIL");
            VXCEIL_125.SetFloat("VAL", 16f);
            var VXFLOOR_127 = _world.GetObject(ObjectType.Skill, "VXFLOOR");
            VXFLOOR_127.SetFloat("VAL", 16f);
            var VYCEIL_129 = _world.GetObject(ObjectType.Skill, "VYCEIL");
            VYCEIL_129.SetFloat("VAL", 0f);
            var VYFLOOR_131 = _world.GetObject(ObjectType.Skill, "VYFLOOR");
            VYFLOOR_131.SetFloat("VAL", 0f);
            yield break;
            FASE7:
            var VX_133 = _world.GetObject(ObjectType.Skill, "VX");
            VX_133.SetFloat("VAL", -0.25f);
            var VY_135 = _world.GetObject(ObjectType.Skill, "VY");
            VY_135.SetFloat("VAL", 0.65f);
            var VZ_137 = _world.GetObject(ObjectType.Skill, "VZ");
            VZ_137.SetFloat("VAL", 0.154f);
            var VR_139 = _world.GetObject(ObjectType.Skill, "VR");
            VR_139.SetFloat("VAL", 0.056099f);
            var VXCEIL_141 = _world.GetObject(ObjectType.Skill, "VXCEIL");
            VXCEIL_141.SetFloat("VAL", 8f);
            var VXFLOOR_143 = _world.GetObject(ObjectType.Skill, "VXFLOOR");
            VXFLOOR_143.SetFloat("VAL", 8f);
            var VYCEIL_145 = _world.GetObject(ObjectType.Skill, "VYCEIL");
            VYCEIL_145.SetFloat("VAL", -20.8f);
            var VYFLOOR_147 = _world.GetObject(ObjectType.Skill, "VYFLOOR");
            VYFLOOR_147.SetFloat("VAL", -20.8f);
            yield break;
            UNLOCK:
            var GSHU01SND_148 = _world.AcknexObject.GetAcknexObject("GSHU01SND");
            _world.PlaySound(GSHU01SND_148, 0.3f);
            var GSHU02SND_150 = _world.AcknexObject.GetAcknexObject("GSHU02SND");
            var FMT06SHUTEX_152 = _world.AcknexObject.GetAcknexObject("FMT06SHUTEX");
            FMT06SHUTEX_152.SetAcknexObject("SOUND", GSHU02SND_150);
            var SHUTLEGENIUSTNG_155 = _world.AcknexObject.GetAcknexObject("SHUTLEGENIUSTNG");
            SHUTLEGENIUSTNG_155.SetFloat("FLAG3", 1f);
            goto FASE1;
            LOCK:
            var GSHU01SND_156 = _world.AcknexObject.GetAcknexObject("GSHU01SND");
            _world.PlaySound(GSHU01SND_156, 0.3f);
            var FMT06SHUTEX_160 = _world.AcknexObject.GetAcknexObject("FMT06SHUTEX");
            FMT06SHUTEX_160.SetAcknexObject("SOUND", null);
            var SHUTLEGENIUSTNG_163 = _world.AcknexObject.GetAcknexObject("SHUTLEGENIUSTNG");
            SHUTLEGENIUSTNG_163.SetFloat("FLAG3", 0f);
            FASEEND:
            var SHUTLEGENIUSTNG_166 = _world.AcknexObject.GetAcknexObject("SHUTLEGENIUSTNG");
            var temp_167 = SHUTLEGENIUSTNG_166.GetFloat("FLAG3");
            if (temp_167 == 1f)
            {
                goto LOCK;
            }
            var SHUTLEDOORRGN_170 = _world.AcknexObject.GetAcknexObject("SHUTLEDOORRGN");
            SHUTLEDOORRGN_170.SetFloat("FLOOR_HGT", -90f);
            var SHUTLEDOORRGN_173 = _world.AcknexObject.GetAcknexObject("SHUTLEDOORRGN");
            SHUTLEDOORRGN_173.SetFloat("CEIL_HGT", -89.9f);
            var SHUTLERGN_176 = _world.AcknexObject.GetAcknexObject("SHUTLERGN");
            SHUTLERGN_176.SetFloat("FLOOR_HGT", -90f);
            var SHUTLEWINDOWRGN_179 = _world.AcknexObject.GetAcknexObject("SHUTLEWINDOWRGN");
            SHUTLEWINDOWRGN_179.SetFloat("FLOOR_HGT", -87.5f);
            var SHUTLERGN_182 = _world.AcknexObject.GetAcknexObject("SHUTLERGN");
            SHUTLERGN_182.SetFloat("CEIL_HGT", -84f);
            var SHUTLEWINDOWRGN_185 = _world.AcknexObject.GetAcknexObject("SHUTLEWINDOWRGN");
            SHUTLEWINDOWRGN_185.SetFloat("CEIL_HGT", -85f);
            var VX_186 = _world.GetObject(ObjectType.Skill, "VX");
            var VX_187 = _world.GetObject(ObjectType.Skill, "VX");
            var VX_187_val = VX_187.GetFloat("VAL");
            var SHUTLEGENIUSTNG_192 = _world.AcknexObject.GetAcknexObject("SHUTLEGENIUSTNG");
            var temp_193 = SHUTLEGENIUSTNG_192.GetFloat("X");
            VX_186.SetFloat("VAL", -414f - temp_193);
            var VY_194 = _world.GetObject(ObjectType.Skill, "VY");
            var VY_195 = _world.GetObject(ObjectType.Skill, "VY");
            var VY_195_val = VY_195.GetFloat("VAL");
            var SHUTLEGENIUSTNG_199 = _world.AcknexObject.GetAcknexObject("SHUTLEGENIUSTNG");
            var temp_200 = SHUTLEGENIUSTNG_199.GetFloat("Y");
            VY_194.SetFloat("VAL", 36f - temp_200);
            var SHUTLEGENIUSTNG_203 = _world.AcknexObject.GetAcknexObject("SHUTLEGENIUSTNG");
            SHUTLEGENIUSTNG_203.SetFloat("X", -414f);
            var SHUTLEGENIUSTNG_206 = _world.AcknexObject.GetAcknexObject("SHUTLEGENIUSTNG");
            SHUTLEGENIUSTNG_206.SetFloat("Y", 36f);
            var SHUTLEPARAM3_207 = _world.AcknexObject.GetAcknexObject("SHUTLEPARAM3");
            _world.SetSynonymObject("SHUTLEACTIONWAY1", SHUTLEPARAM3_207);
            var SHUTLEPARAM4_209 = _world.AcknexObject.GetAcknexObject("SHUTLEPARAM4");
            _world.SetSynonymObject("SHUTLEACTIONWAY2", SHUTLEPARAM4_209);
            var WMT19WAY1TEX_211 = _world.AcknexObject.GetAcknexObject("WMT19WAY1TEX");
            _world.SetSynonymObject("SHUTLETEXTUREWAY1", WMT19WAY1TEX_211);
            var WMT19WAY2TEX_213 = _world.AcknexObject.GetAcknexObject("WMT19WAY2TEX");
            _world.SetSynonymObject("SHUTLETEXTUREWAY2", WMT19WAY2TEX_213);
            var WMT19WAY3TEX_215 = _world.AcknexObject.GetAcknexObject("WMT19WAY3TEX");
            var SHUTLEWAYWALL_217 = _world.AcknexObject.GetAcknexObject("SHUTLEWAYWALL");
            SHUTLEWAYWALL_217.SetAcknexObject("TEXTURE", WMT19WAY3TEX_215);
            {
                var enumerator = STOPSETING(MY, THERE);
                while (enumerator.MoveNext())
                {
                    var current = enumerator.Current;
                    if (current != null)
            ...
            var OPENSHUTLEDOOR_218 = _world.AcknexObject.GetAcknexObject("OPENSHUTLEDOOR");
            var SHUTLERGN_220 = _world.AcknexObject.GetAcknexObject("SHUTLERGN");
            SHUTLERGN_220.SetAcknexObject("EACH_TICK", OPENSHUTLEDOOR_218);
            var SHUTLEDOORRGN_223 = _world.AcknexObject.GetAcknexObject("SHUTLEDOORRGN");
            SHUTLEDOORRGN_223.SetAcknexObject("EACH_TICK", null);
            //Unknown keyword: 
            yield break;
        }
        public IEnumerator SHUTLEPARAM2(IAcknexObject MY, IAcknexObject THERE)
        {
            var SHUTLEGENIUSTNG_2 = _world.AcknexObject.GetAcknexObject("SHUTLEGENIUSTNG");
            var temp_3 = SHUTLEGENIUSTNG_2.GetFloat("FLAG1");
            if (temp_3 == 0f)
            ...
            var SHUTLEGENIUSTNG_6 = _world.AcknexObject.GetAcknexObject("SHUTLEGENIUSTNG");
            var temp_7 = SHUTLEGENIUSTNG_6.GetFloat("Y");
            if (temp_7 < -92.5f)
            {
                goto FASEEND;
            }
            var SHUTLEGENIUSTNG_10 = _world.AcknexObject.GetAcknexObject("SHUTLEGENIUSTNG");
            var temp_11 = SHUTLEGENIUSTNG_10.GetFloat("Y");
            if (temp_11 < -81f)
            {
                goto FASE3;
            }
            var SHUTLEGENIUSTNG_14 = _world.AcknexObject.GetAcknexObject("SHUTLEGENIUSTNG");
            var temp_15 = SHUTLEGENIUSTNG_14.GetFloat("Y");
            if (temp_15 < -76f)
            {
                goto FASE2;
            }
            FASE1:
            var SHUTLEGENIUSTNG_18 = _world.AcknexObject.GetAcknexObject("SHUTLEGENIUSTNG");
            var temp_19 = SHUTLEGENIUSTNG_18.GetFloat("FLAG3");
            if (temp_19 == 0f)
            {
                goto UNLOCK;
            }
            var VX_21 = _world.GetObject(ObjectType.Skill, "VX");
            VX_21.SetFloat("VAL", -0.15909f);
            var VY_23 = _world.GetObject(ObjectType.Skill, "VY");
            VY_23.SetFloat("VAL", -0.25f);
            var VZ_25 = _world.GetObject(ObjectType.Skill, "VZ");
            VZ_25.SetFloat("VAL", 0f);
            var VR_27 = _world.GetObject(ObjectType.Skill, "VR");
            VR_27.SetFloat("VAL", -0.023799f);
            var VXCEIL_29 = _world.GetObject(ObjectType.Skill, "VXCEIL");
            VXCEIL_29.SetFloat("VAL", 5.0908f);
            var VXFLOOR_31 = _world.GetObject(ObjectType.Skill, "VXFLOOR");
            VXFLOOR_31.SetFloat("VAL", 5.0908f);
            var VYCEIL_33 = _world.GetObject(ObjectType.Skill, "VYCEIL");
            VYCEIL_33.SetFloat("VAL", 8f);
            var VYFLOOR_35 = _world.GetObject(ObjectType.Skill, "VYFLOOR");
            VYFLOOR_35.SetFloat("VAL", 8f);
            yield break;
            FASE2:
            var VX_37 = _world.GetObject(ObjectType.Skill, "VX");
            VX_37.SetFloat("VAL", -0.43f);
            var VY_39 = _world.GetObject(ObjectType.Skill, "VY");
            VY_39.SetFloat("VAL", -0.025f);
            var VZ_41 = _world.GetObject(ObjectType.Skill, "VZ");
            VZ_41.SetFloat("VAL", 0f);
            var VR_43 = _world.GetObject(ObjectType.Skill, "VR");
            VR_43.SetFloat("VAL", 0f);
            var VXCEIL_45 = _world.GetObject(ObjectType.Skill, "VXCEIL");
            VXCEIL_45.SetFloat("VAL", 13.76f);
            var VXFLOOR_47 = _world.GetObject(ObjectType.Skill, "VXFLOOR");
            VXFLOOR_47.SetFloat("VAL", 13.76f);
            var VYCEIL_49 = _world.GetObject(ObjectType.Skill, "VYCEIL");
            VYCEIL_49.SetFloat("VAL", 0.8f);
            var VYFLOOR_51 = _world.GetObject(ObjectType.Skill, "VYFLOOR");
            VYFLOOR_51.SetFloat("VAL", 0.8f);
            yield break;
            FASE3:
            var VX_53 = _world.GetObject(ObjectType.Skill, "VX");
            VX_53.SetFloat("VAL", 0.336956f);
            var VY_55 = _world.GetObject(ObjectType.Skill, "VY");
            VY_55.SetFloat("VAL", -0.25f);
            var VZ_57 = _world.GetObject(ObjectType.Skill, "VZ");
            VZ_57.SetFloat("VAL", 0f);
            var VR_59 = _world.GetObject(ObjectType.Skill, "VR");
            VR_59.SetFloat("VAL", 0f);
            var VXCEIL_61 = _world.GetObject(ObjectType.Skill, "VXCEIL");
            VXCEIL_61.SetFloat("VAL", -10.7825f);
            var VXFLOOR_63 = _world.GetObject(ObjectType.Skill, "VXFLOOR");
            VXFLOOR_63.SetFloat("VAL", -10.7825f);
            var VYCEIL_65 = _world.GetObject(ObjectType.Skill, "VYCEIL");
            VYCEIL_65.SetFloat("VAL", 8f);
            var VYFLOOR_67 = _world.GetObject(ObjectType.Skill, "VYFLOOR");
            VYFLOOR_67.SetFloat("VAL", 8f);
            yield break;
            UNLOCK:
            var GSHU01SND_68 = _world.AcknexObject.GetAcknexObject("GSHU01SND");
            _world.PlaySound(GSHU01SND_68, 0.3f);
            var GSHU02SND_70 = _world.AcknexObject.GetAcknexObject("GSHU02SND");
            var FMT06SHUTEX_72 = _world.AcknexObject.GetAcknexObject("FMT06SHUTEX");
            FMT06SHUTEX_72.SetAcknexObject("SOUND", GSHU02SND_70);
            var SHUTLEGENIUSTNG_75 = _world.AcknexObject.GetAcknexObject("SHUTLEGENIUSTNG");
            SHUTLEGENIUSTNG_75.SetFloat("FLAG3", 1f);
            goto FASE1;
            LOCK:
            var GSHU01SND_76 = _world.AcknexObject.GetAcknexObject("GSHU01SND");
            _world.PlaySound(GSHU01SND_76, 0.3f);
            var FMT06SHUTEX_80 = _world.AcknexObject.GetAcknexObject("FMT06SHUTEX");
            FMT06SHUTEX_80.SetAcknexObject("SOUND", null);
            var SHUTLEGENIUSTNG_83 = _world.AcknexObject.GetAcknexObject("SHUTLEGENIUSTNG");
            SHUTLEGENIUSTNG_83.SetFloat("FLAG3", 0f);
            FASEEND:
            var SHUTLEGENIUSTNG_86 = _world.AcknexObject.GetAcknexObject("SHUTLEGENIUSTNG");
            var temp_87 = SHUTLEGENIUSTNG_86.GetFloat("FLAG3");
            if (temp_87 == 1f)
            {
                goto LOCK;
            }
            var SHUTLEDOORRGN_90 = _world.AcknexObject.GetAcknexObject("SHUTLEDOORRGN");
            SHUTLEDOORRGN_90.SetFloat("FLOOR_HGT", 0f);
            var SHUTLEDOORRGN_93 = _world.AcknexObject.GetAcknexObject("SHUTLEDOORRGN");
            SHUTLEDOORRGN_93.SetFloat("CEIL_HGT", 0.1f);
            var SHUTLERGN_96 = _world.AcknexObject.GetAcknexObject("SHUTLERGN");
            SHUTLERGN_96.SetFloat("FLOOR_HGT", 0f);
            var SHUTLEWINDOWRGN_99 = _world.AcknexObject.GetAcknexObject("SHUTLEWINDOWRGN");
            SHUTLEWINDOWRGN_99.SetFloat("FLOOR_HGT", 2.5f);
            var SHUTLERGN_102 = _world.AcknexObject.GetAcknexObject("SHUTLERGN");
            SHUTLERGN_102.SetFloat("CEIL_HGT", 6f);
            var SHUTLEWINDOWRGN_105 = _world.AcknexObject.GetAcknexObject("SHUTLEWINDOWRGN");
            SHUTLEWINDOWRGN_105.SetFloat("CEIL_HGT", 5f);
            var VX_106 = _world.GetObject(ObjectType.Skill, "VX");
            var VX_107 = _world.GetObject(ObjectType.Skill, "VX");
            var VX_107_val = VX_107.GetFloat("VAL");
            var SHUTLEGENIUSTNG_112 = _world.AcknexObject.GetAcknexObject("SHUTLEGENIUSTNG");
            var temp_113 = SHUTLEGENIUSTNG_112.GetFloat("X");
            VX_106.SetFloat("VAL", -170.5f - temp_113);
            var VY_114 = _world.GetObject(ObjectType.Skill, "VY");
            var VY_115 = _world.GetObject(ObjectType.Skill, "VY");
            var VY_115_val = VY_115.GetFloat("VAL");
            var SHUTLEGENIUSTNG_120 = _world.AcknexObject.GetAcknexObject("SHUTLEGENIUSTNG");
            var temp_121 = SHUTLEGENIUSTNG_120.GetFloat("Y");
            VY_114.SetFloat("VAL", -92.5f - temp_121);
            var SHUTLEGENIUSTNG_124 = _world.AcknexObject.GetAcknexObject("SHUTLEGENIUSTNG");
            SHUTLEGENIUSTNG_124.SetFloat("X", -170.5f);
            var SHUTLEGENIUSTNG_127 = _world.AcknexObject.GetAcknexObject("SHUTLEGENIUSTNG");
            SHUTLEGENIUSTNG_127.SetFloat("Y", -92.5f);
            var SHUTLEPARAM5_128 = _world.AcknexObject.GetAcknexObject("SHUTLEPARAM5");
            _world.SetSynonymObject("SHUTLEACTIONWAY1", SHUTLEPARAM5_128);
            var SHUTLEPARAM6_130 = _world.AcknexObject.GetAcknexObject("SHUTLEPARAM6");
            _world.SetSynonymObject("SHUTLEACTIONWAY2", SHUTLEPARAM6_130);
            var WMT19WAY1TEX_132 = _world.AcknexObject.GetAcknexObject("WMT19WAY1TEX");
            _world.SetSynonymObject("SHUTLETEXTUREWAY1", WMT19WAY1TEX_132);
            var WMT19WAY3TEX_134 = _world.AcknexObject.GetAcknexObject("WMT19WAY3TEX");
            _world.SetSynonymObject("SHUTLETEXTUREWAY2", WMT19WAY3TEX_134);
            var WMT19WAY2TEX_136 = _world.AcknexObject.GetAcknexObject("WMT19WAY2TEX");
            var SHUTLEWAYWALL_138 = _world.AcknexObject.GetAcknexObject("SHUTLEWAYWALL");
            SHUTLEWAYWALL_138.SetAcknexObject("TEXTURE", WMT19WAY2TEX_136);
            {
                var enumerator = STOPSETING(MY, THERE);
                while (enumerator.MoveNext())
                {
            ...
            var OPENSHUTLEDOOR_139 = _world.AcknexObject.GetAcknexObject("OPENSHUTLEDOOR");
            var SHUTLERGN_141 = _world.AcknexObject.GetAcknexObject("SHUTLERGN");
            SHUTLERGN_141.SetAcknexObject("EACH_TICK", OPENSHUTLEDOOR_139);
            var SHUTLEDOORRGN_144 = _world.AcknexObject.GetAcknexObject("SHUTLEDOORRGN");
            SHUTLEDOORRGN_144.SetAcknexObject("EACH_TICK", null);
            //Unknown keyword: 
            yield break;
        }
        public IEnumerator SHUTLEPARAM3(IAcknexObject MY, IAcknexObject THERE)
        {
            var SHUTLEGENIUSTNG_2 = _world.AcknexObject.GetAcknexObject("SHUTLEGENIUSTNG");
            var temp_3 = SHUTLEGENIUSTNG_2.GetFloat("FLAG1");
            if (temp_3 == 0f)
            ...
            var SHUTLEGENIUSTNG_34 = _world.AcknexObject.GetAcknexObject("SHUTLEGENIUSTNG");
            var temp_35 = SHUTLEGENIUSTNG_34.GetFloat("X");
            if (temp_35 > -408f)
            {
                goto FASE2;
            }
            FASE1:
            var SHUTLEGENIUSTNG_38 = _world.AcknexObject.GetAcknexObject("SHUTLEGENIUSTNG");
            var temp_39 = SHUTLEGENIUSTNG_38.GetFloat("FLAG3");
            if (temp_39 == 0f)
            {
                goto UNLOCK;
            }
            var VX_41 = _world.GetObject(ObjectType.Skill, "VX");
            VX_41.SetFloat("VAL", 0.25f);
            var VY_43 = _world.GetObject(ObjectType.Skill, "VY");
            VY_43.SetFloat("VAL", 0f);
            var VZ_45 = _world.GetObject(ObjectType.Skill, "VZ");
            VZ_45.SetFloat("VAL", 0f);
            var VR_47 = _world.GetObject(ObjectType.Skill, "VR");
            VR_47.SetFloat("VAL", -0.03272f);
            var VXCEIL_49 = _world.GetObject(ObjectType.Skill, "VXCEIL");
            VXCEIL_49.SetFloat("VAL", -8f);
            var VXFLOOR_51 = _world.GetObject(ObjectType.Skill, "VXFLOOR");
            VXFLOOR_51.SetFloat("VAL", -8f);
            var VYCEIL_53 = _world.GetObject(ObjectType.Skill, "VYCEIL");
            VYCEIL_53.SetFloat("VAL", 0f);
            var VYFLOOR_55 = _world.GetObject(ObjectType.Skill, "VYFLOOR");
            VYFLOOR_55.SetFloat("VAL", 0f);
            yield break;
            FASE2:
            var VX_57 = _world.GetObject(ObjectType.Skill, "VX");
            VX_57.SetFloat("VAL", 0.5f);
            var VY_59 = _world.GetObject(ObjectType.Skill, "VY");
            VY_59.SetFloat("VAL", -0.5f);
            var VZ_61 = _world.GetObject(ObjectType.Skill, "VZ");
            VZ_61.SetFloat("VAL", 0.473484f);
            var VR_63 = _world.GetObject(ObjectType.Skill, "VR");
            VR_63.SetFloat("VAL", 0f);
            var VXCEIL_65 = _world.GetObject(ObjectType.Skill, "VXCEIL");
            VXCEIL_65.SetFloat("VAL", -16f);
            var VXFLOOR_67 = _world.GetObject(ObjectType.Skill, "VXFLOOR");
            VXFLOOR_67.SetFloat("VAL", -16f);
            var VYCEIL_69 = _world.GetObject(ObjectType.Skill, "VYCEIL");
            VYCEIL_69.SetFloat("VAL", 16f);
            var VYFLOOR_71 = _world.GetObject(ObjectType.Skill, "VYFLOOR");
            VYFLOOR_71.SetFloat("VAL", 16f);
            yield break;
            FASE3:
            var VX_73 = _world.GetObject(ObjectType.Skill, "VX");
            VX_73.SetFloat("VAL", 0.5f);
            var VY_75 = _world.GetObject(ObjectType.Skill, "VY");
            VY_75.SetFloat("VAL", -0.5f);
            var VZ_77 = _world.GetObject(ObjectType.Skill, "VZ");
            VZ_77.SetFloat("VAL", 0f);
            var VR_79 = _world.GetObject(ObjectType.Skill, "VR");
            VR_79.SetFloat("VAL", 0.049087f);
            var VXCEIL_81 = _world.GetObject(ObjectType.Skill, "VXCEIL");
            VXCEIL_81.SetFloat("VAL", -16f);
            var VXFLOOR_83 = _world.GetObject(ObjectType.Skill, "VXFLOOR");
            VXFLOOR_83.SetFloat("VAL", -16f);
            var VYCEIL_85 = _world.GetObject(ObjectType.Skill, "VYCEIL");
            VYCEIL_85.SetFloat("VAL", 16f);
            var VYFLOOR_87 = _world.GetObject(ObjectType.Skill, "VYFLOOR");
            VYFLOOR_87.SetFloat("VAL", 16f);
            yield break;
            FASE4:
            var VX_89 = _world.GetObject(ObjectType.Skill, "VX");
            VX_89.SetFloat("VAL", 0.5f);
            var VY_91 = _world.GetObject(ObjectType.Skill, "VY");
            VY_91.SetFloat("VAL", 0f);
            var VZ_93 = _world.GetObject(ObjectType.Skill, "VZ");
            VZ_93.SetFloat("VAL", 0f);
            var VR_95 = _world.GetObject(ObjectType.Skill, "VR");
            VR_95.SetFloat("VAL", 0f);
            var VXCEIL_97 = _world.GetObject(ObjectType.Skill, "VXCEIL");
            VXCEIL_97.SetFloat("VAL", -16f);
            var VXFLOOR_99 = _world.GetObject(ObjectType.Skill, "VXFLOOR");
            VXFLOOR_99.SetFloat("VAL", -16f);
            var VYCEIL_101 = _world.GetObject(ObjectType.Skill, "VYCEIL");
            VYCEIL_101.SetFloat("VAL", 0f);
            var VYFLOOR_103 = _world.GetObject(ObjectType.Skill, "VYFLOOR");
            VYFLOOR_103.SetFloat("VAL", 0f);
            yield break;
            FASE5:
            var VX_105 = _world.GetObject(ObjectType.Skill, "VX");
            VX_105.SetFloat("VAL", 0.25f);
            var VY_107 = _world.GetObject(ObjectType.Skill, "VY");
            VY_107.SetFloat("VAL", 0.25f);
            var VZ_109 = _world.GetObject(ObjectType.Skill, "VZ");
            VZ_109.SetFloat("VAL", -0.3125f);
            var VR_111 = _world.GetObject(ObjectType.Skill, "VR");
            VR_111.SetFloat("VAL", 0.016362f);
            var VXCEIL_113 = _world.GetObject(ObjectType.Skill, "VXCEIL");
            VXCEIL_113.SetFloat("VAL", -8f);
            var VXFLOOR_115 = _world.GetObject(ObjectType.Skill, "VXFLOOR");
            VXFLOOR_115.SetFloat("VAL", -8f);
            var VYCEIL_117 = _world.GetObject(ObjectType.Skill, "VYCEIL");
            VYCEIL_117.SetFloat("VAL", -8f);
            var VYFLOOR_119 = _world.GetObject(ObjectType.Skill, "VYFLOOR");
            VYFLOOR_119.SetFloat("VAL", -8f);
            yield break;
            FASE6:
            var VX_121 = _world.GetObject(ObjectType.Skill, "VX");
            VX_121.SetFloat("VAL", 0.25f);
            var VY_123 = _world.GetObject(ObjectType.Skill, "VY");
            VY_123.SetFloat("VAL", 0.25f);
            var VZ_125 = _world.GetObject(ObjectType.Skill, "VZ");
            VZ_125.SetFloat("VAL", -0.3125f);
            var VR_127 = _world.GetObject(ObjectType.Skill, "VR");
            VR_127.SetFloat("VAL", -0.012271f);
            var VXCEIL_129 = _world.GetObject(ObjectType.Skill, "VXCEIL");
            VXCEIL_129.SetFloat("VAL", -8f);
            var VXFLOOR_131 = _world.GetObject(ObjectType.Skill, "VXFLOOR");
            VXFLOOR_131.SetFloat("VAL", -8f);
            var VYCEIL_133 = _world.GetObject(ObjectType.Skill, "VYCEIL");
            VYCEIL_133.SetFloat("VAL", -8f);
            var VYFLOOR_135 = _world.GetObject(ObjectType.Skill, "VYFLOOR");
            VYFLOOR_135.SetFloat("VAL", -8f);
            yield break;
            FASE7:
            var VX_137 = _world.GetObject(ObjectType.Skill, "VX");
            VX_137.SetFloat("VAL", 0.5f);
            var VY_139 = _world.GetObject(ObjectType.Skill, "VY");
            VY_139.SetFloat("VAL", 0f);
            var VZ_141 = _world.GetObject(ObjectType.Skill, "VZ");
            VZ_141.SetFloat("VAL", 0f);
            var VR_143 = _world.GetObject(ObjectType.Skill, "VR");
            VR_143.SetFloat("VAL", 0f);
            var VXCEIL_145 = _world.GetObject(ObjectType.Skill, "VXCEIL");
            VXCEIL_145.SetFloat("VAL", -16f);
            var VXFLOOR_147 = _world.GetObject(ObjectType.Skill, "VXFLOOR");
            VXFLOOR_147.SetFloat("VAL", -16f);
            var VYCEIL_149 = _world.GetObject(ObjectType.Skill, "VYCEIL");
            VYCEIL_149.SetFloat("VAL", 0f);
            var VYFLOOR_151 = _world.GetObject(ObjectType.Skill, "VYFLOOR");
            VYFLOOR_151.SetFloat("VAL", 0f);
            yield break;
            FASE8:
            var VX_153 = _world.GetObject(ObjectType.Skill, "VX");
            VX_153.SetFloat("VAL", 0.25f);
            var VY_155 = _world.GetObject(ObjectType.Skill, "VY");
            VY_155.SetFloat("VAL", 0.392857f);
            var VZ_157 = _world.GetObject(ObjectType.Skill, "VZ");
            VZ_157.SetFloat("VAL", 0f);
            var VR_159 = _world.GetObject(ObjectType.Skill, "VR");
            VR_159.SetFloat("VAL", 0.112199f);
            var VXCEIL_161 = _world.GetObject(ObjectType.Skill, "VXCEIL");
            VXCEIL_161.SetFloat("VAL", -8f);
            var VXFLOOR_163 = _world.GetObject(ObjectType.Skill, "VXFLOOR");
            VXFLOOR_163.SetFloat("VAL", -8f);
            var VYCEIL_165 = _world.GetObject(ObjectType.Skill, "VYCEIL");
            VYCEIL_165.SetFloat("VAL", -12.5696f);
            var VYFLOOR_167 = _world.GetObject(ObjectType.Skill, "VYFLOOR");
            VYFLOOR_167.SetFloat("VAL", -12.5696f);
            yield break;
            UNLOCK:
            var GSHU01SND_168 = _world.AcknexObject.GetAcknexObject("GSHU01SND");
            _world.PlaySound(GSHU01SND_168, 0.3f);
            var GSHU02SND_170 = _world.AcknexObject.GetAcknexObject("GSHU02SND");
            var FMT06SHUTEX_172 = _world.AcknexObject.GetAcknexObject("FMT06SHUTEX");
            FMT06SHUTEX_172.SetAcknexObject("SOUND", GSHU02SND_170);
            var SHUTLEGENIUSTNG_175 = _world.AcknexObject.GetAcknexObject("SHUTLEGENIUSTNG");
            SHUTLEGENIUSTNG_175.SetFloat("FLAG3", 1f);
            goto FASE1;
            LOCK:
            var GSHU01SND_176 = _world.AcknexObject.GetAcknexObject("GSHU01SND");
            _world.PlaySound(GSHU01SND_176, 0.3f);
            var FMT06SHUTEX_180 = _world.AcknexObject.GetAcknexObject("FMT06SHUTEX");
            FMT06SHUTEX_180.SetAcknexObject("SOUND", null);
            var SHUTLEGENIUSTNG_183 = _world.AcknexObject.GetAcknexObject("SHUTLEGENIUSTNG");
            SHUTLEGENIUSTNG_183.SetFloat("FLAG3", 0f);
            FASEEND:
            var SHUTLEGENIUSTNG_186 = _world.AcknexObject.GetAcknexObject("SHUTLEGENIUSTNG");
            var temp_187 = SHUTLEGENIUSTNG_186.GetFloat("FLAG3");
            if (temp_187 == 1f)
            {
                goto LOCK;
            }
            var SHUTLEDOORRGN_190 = _world.AcknexObject.GetAcknexObject("SHUTLEDOORRGN");
            SHUTLEDOORRGN_190.SetFloat("FLOOR_HGT", 0f);
            var SHUTLEDOORRGN_193 = _world.AcknexObject.GetAcknexObject("SHUTLEDOORRGN");
            SHUTLEDOORRGN_193.SetFloat("CEIL_HGT", 0.1f);
            var SHUTLERGN_196 = _world.AcknexObject.GetAcknexObject("SHUTLERGN");
            SHUTLERGN_196.SetFloat("FLOOR_HGT", 0f);
            var SHUTLEWINDOWRGN_199 = _world.AcknexObject.GetAcknexObject("SHUTLEWINDOWRGN");
            SHUTLEWINDOWRGN_199.SetFloat("FLOOR_HGT", 2.5f);
            var SHUTLERGN_202 = _world.AcknexObject.GetAcknexObject("SHUTLERGN");
            SHUTLERGN_202.SetFloat("CEIL_HGT", 6f);
            var SHUTLEWINDOWRGN_205 = _world.AcknexObject.GetAcknexObject("SHUTLEWINDOWRGN");
            SHUTLEWINDOWRGN_205.SetFloat("CEIL_HGT", 5f);
            var VX_206 = _world.GetObject(ObjectType.Skill, "VX");
            var VX_207 = _world.GetObject(ObjectType.Skill, "VX");
            var VX_207_val = VX_207.GetFloat("VAL");
            var SHUTLEGENIUSTNG_212 = _world.AcknexObject.GetAcknexObject("SHUTLEGENIUSTNG");
            var temp_213 = SHUTLEGENIUSTNG_212.GetFloat("X");
            VX_206.SetFloat("VAL", -89.5f - temp_213);
            var VY_214 = _world.GetObject(ObjectType.Skill, "VY");
            var VY_215 = _world.GetObject(ObjectType.Skill, "VY");
            var VY_215_val = VY_215.GetFloat("VAL");
            var SHUTLEGENIUSTNG_220 = _world.AcknexObject.GetAcknexObject("SHUTLEGENIUSTNG");
            var temp_221 = SHUTLEGENIUSTNG_220.GetFloat("Y");
            VY_214.SetFloat("VAL", -59.5f - temp_221);
            var SHUTLEGENIUSTNG_224 = _world.AcknexObject.GetAcknexObject("SHUTLEGENIUSTNG");
            SHUTLEGENIUSTNG_224.SetFloat("X", -89.5f);
            var SHUTLEGENIUSTNG_227 = _world.AcknexObject.GetAcknexObject("SHUTLEGENIUSTNG");
            SHUTLEGENIUSTNG_227.SetFloat("Y", 59.5f);
            var SHUTLEPARAM1_228 = _world.AcknexObject.GetAcknexObject("SHUTLEPARAM1");
            _world.SetSynonymObject("SHUTLEACTIONWAY1", SHUTLEPARAM1_228);
            var SHUTLEPARAM2_230 = _world.AcknexObject.GetAcknexObject("SHUTLEPARAM2");
            _world.SetSynonymObject("SHUTLEACTIONWAY2", SHUTLEPARAM2_230);
            var WMT19WAY3TEX_232 = _world.AcknexObject.GetAcknexObject("WMT19WAY3TEX");
            _world.SetSynonymObject("SHUTLETEXTUREWAY1", WMT19WAY3TEX_232);
            var WMT19WAY2TEX_234 = _world.AcknexObject.GetAcknexObject("WMT19WAY2TEX");
            _world.SetSynonymObject("SHUTLETEXTUREWAY2", WMT19WAY2TEX_234);
            var WMT19WAY1TEX_236 = _world.AcknexObject.GetAcknexObject("WMT19WAY1TEX");
            var SHUTLEWAYWALL_238 = _world.AcknexObject.GetAcknexObject("SHUTLEWAYWALL");
            SHUTLEWAYWALL_238.SetAcknexObject("TEXTURE", WMT19WAY1TEX_236);
            {
                var enumerator = STOPSETING(MY, THERE);
                while (enumerator.MoveNext())
                {
            ...
            var OPENSHUTLEDOOR_239 = _world.AcknexObject.GetAcknexObject("OPENSHUTLEDOOR");
            var SHUTLERGN_241 = _world.AcknexObject.GetAcknexObject("SHUTLERGN");
            SHUTLERGN_241.SetAcknexObject("EACH_TICK", OPENSHUTLEDOOR_239);
            var SHUTLEDOORRGN_244 = _world.AcknexObject.GetAcknexObject("SHUTLEDOORRGN");
            SHUTLEDOORRGN_244.SetAcknexObject("EACH_TICK", null);
            //Unknown keyword: 
            yield break;
        }
        public IEnumerator SHUTLEPARAM4(IAcknexObject MY, IAcknexObject THERE)
        {
            var SHUTLEGENIUSTNG_2 = _world.AcknexObject.GetAcknexObject("SHUTLEGENIUSTNG");
            var temp_3 = SHUTLEGENIUSTNG_2.GetFloat("FLAG1");
            if (temp_3 == 0f)
            ...
            FASE1:
            var SHUTLEGENIUSTNG_30 = _world.AcknexObject.GetAcknexObject("SHUTLEGENIUSTNG");
            var temp_31 = SHUTLEGENIUSTNG_30.GetFloat("FLAG3");
            if (temp_31 == 0f)
            {
                goto UNLOCK;
            }
            var VX_33 = _world.GetObject(ObjectType.Skill, "VX");
            VX_33.SetFloat("VAL", 0.25f);
            var VY_35 = _world.GetObject(ObjectType.Skill, "VY");
            VY_35.SetFloat("VAL", 0f);
            var VZ_37 = _world.GetObject(ObjectType.Skill, "VZ");
            VZ_37.SetFloat("VAL", 0f);
            var VR_39 = _world.GetObject(ObjectType.Skill, "VR");
            VR_39.SetFloat("VAL", -0.03272f);
            var VXCEIL_41 = _world.GetObject(ObjectType.Skill, "VXCEIL");
            VXCEIL_41.SetFloat("VAL", -8f);
            var VXFLOOR_43 = _world.GetObject(ObjectType.Skill, "VXFLOOR");
            VXFLOOR_43.SetFloat("VAL", -8f);
            var VYCEIL_45 = _world.GetObject(ObjectType.Skill, "VYCEIL");
            VYCEIL_45.SetFloat("VAL", 0f);
            var VYFLOOR_47 = _world.GetObject(ObjectType.Skill, "VYFLOOR");
            VYFLOOR_47.SetFloat("VAL", 0f);
            yield break;
            FASE2:
            var VX_49 = _world.GetObject(ObjectType.Skill, "VX");
            VX_49.SetFloat("VAL", 0.5f);
            var VY_51 = _world.GetObject(ObjectType.Skill, "VY");
            VY_51.SetFloat("VAL", -0.5f);
            var VZ_53 = _world.GetObject(ObjectType.Skill, "VZ");
            VZ_53.SetFloat("VAL", 0.473484f);
            var VR_55 = _world.GetObject(ObjectType.Skill, "VR");
            VR_55.SetFloat("VAL", 0f);
            var VXCEIL_57 = _world.GetObject(ObjectType.Skill, "VXCEIL");
            VXCEIL_57.SetFloat("VAL", -16f);
            var VXFLOOR_59 = _world.GetObject(ObjectType.Skill, "VXFLOOR");
            VXFLOOR_59.SetFloat("VAL", -16f);
            var VYCEIL_61 = _world.GetObject(ObjectType.Skill, "VYCEIL");
            VYCEIL_61.SetFloat("VAL", 16f);
            var VYFLOOR_63 = _world.GetObject(ObjectType.Skill, "VYFLOOR");
            VYFLOOR_63.SetFloat("VAL", 16f);
            yield break;
            FASE3:
            var VX_65 = _world.GetObject(ObjectType.Skill, "VX");
            VX_65.SetFloat("VAL", 0.5f);
            var VY_67 = _world.GetObject(ObjectType.Skill, "VY");
            VY_67.SetFloat("VAL", -0.5f);
            var VZ_69 = _world.GetObject(ObjectType.Skill, "VZ");
            VZ_69.SetFloat("VAL", 0f);
            var VR_71 = _world.GetObject(ObjectType.Skill, "VR");
            VR_71.SetFloat("VAL", 0.049087f);
            var VXCEIL_73 = _world.GetObject(ObjectType.Skill, "VXCEIL");
            VXCEIL_73.SetFloat("VAL", -16f);
            var VXFLOOR_75 = _world.GetObject(ObjectType.Skill, "VXFLOOR");
            VXFLOOR_75.SetFloat("VAL", -16f);
            var VYCEIL_77 = _world.GetObject(ObjectType.Skill, "VYCEIL");
            VYCEIL_77.SetFloat("VAL", 16f);
            var VYFLOOR_79 = _world.GetObject(ObjectType.Skill, "VYFLOOR");
            VYFLOOR_79.SetFloat("VAL", 16f);
            yield break;
            FASE4:
            var VX_81 = _world.GetObject(ObjectType.Skill, "VX");
            VX_81.SetFloat("VAL", 0.5f);
            var VY_83 = _world.GetObject(ObjectType.Skill, "VY");
            VY_83.SetFloat("VAL", 0f);
            var VZ_85 = _world.GetObject(ObjectType.Skill, "VZ");
            VZ_85.SetFloat("VAL", 0f);
            var VR_87 = _world.GetObject(ObjectType.Skill, "VR");
            VR_87.SetFloat("VAL", 0f);
            var VXCEIL_89 = _world.GetObject(ObjectType.Skill, "VXCEIL");
            VXCEIL_89.SetFloat("VAL", -16f);
            var VXFLOOR_91 = _world.GetObject(ObjectType.Skill, "VXFLOOR");
            VXFLOOR_91.SetFloat("VAL", -16f);
            var VYCEIL_93 = _world.GetObject(ObjectType.Skill, "VYCEIL");
            VYCEIL_93.SetFloat("VAL", 0f);
            var VYFLOOR_95 = _world.GetObject(ObjectType.Skill, "VYFLOOR");
            VYFLOOR_95.SetFloat("VAL", 0f);
            yield break;
            FASE5:
            var VX_97 = _world.GetObject(ObjectType.Skill, "VX");
            VX_97.SetFloat("VAL", 0.25f);
            var VY_99 = _world.GetObject(ObjectType.Skill, "VY");
            VY_99.SetFloat("VAL", 0.25f);
            var VZ_101 = _world.GetObject(ObjectType.Skill, "VZ");
            VZ_101.SetFloat("VAL", -0.261194f);
            var VR_103 = _world.GetObject(ObjectType.Skill, "VR");
            VR_103.SetFloat("VAL", -0.023444f);
            var VXCEIL_105 = _world.GetObject(ObjectType.Skill, "VXCEIL");
            VXCEIL_105.SetFloat("VAL", -8f);
            var VXFLOOR_107 = _world.GetObject(ObjectType.Skill, "VXFLOOR");
            VXFLOOR_107.SetFloat("VAL", -8f);
            var VYCEIL_109 = _world.GetObject(ObjectType.Skill, "VYCEIL");
            VYCEIL_109.SetFloat("VAL", -8f);
            var VYFLOOR_111 = _world.GetObject(ObjectType.Skill, "VYFLOOR");
            VYFLOOR_111.SetFloat("VAL", -8f);
            yield break;
            FASE6:
            var VX_113 = _world.GetObject(ObjectType.Skill, "VX");
            VX_113.SetFloat("VAL", 0.25f);
            var VY_115 = _world.GetObject(ObjectType.Skill, "VY");
            VY_115.SetFloat("VAL", 0f);
            var VZ_117 = _world.GetObject(ObjectType.Skill, "VZ");
            VZ_117.SetFloat("VAL", -0.261194f);
            var VR_119 = _world.GetObject(ObjectType.Skill, "VR");
            VR_119.SetFloat("VAL", -0.023444f);
            var VXCEIL_121 = _world.GetObject(ObjectType.Skill, "VXCEIL");
            VXCEIL_121.SetFloat("VAL", -8f);
            var VXFLOOR_123 = _world.GetObject(ObjectType.Skill, "VXFLOOR");
            VXFLOOR_123.SetFloat("VAL", -8f);
            var VYCEIL_125 = _world.GetObject(ObjectType.Skill, "VYCEIL");
            VYCEIL_125.SetFloat("VAL", 0f);
            var VYFLOOR_127 = _world.GetObject(ObjectType.Skill, "VYFLOOR");
            VYFLOOR_127.SetFloat("VAL", 0f);
            yield break;
            UNLOCK:
            var GSHU01SND_128 = _world.AcknexObject.GetAcknexObject("GSHU01SND");
            _world.PlaySound(GSHU01SND_128, 0.3f);
            var GSHU02SND_130 = _world.AcknexObject.GetAcknexObject("GSHU02SND");
            var FMT06SHUTEX_132 = _world.AcknexObject.GetAcknexObject("FMT06SHUTEX");
            FMT06SHUTEX_132.SetAcknexObject("SOUND", GSHU02SND_130);
            var SHUTLEGENIUSTNG_135 = _world.AcknexObject.GetAcknexObject("SHUTLEGENIUSTNG");
            SHUTLEGENIUSTNG_135.SetFloat("FLAG3", 1f);
            goto FASE1;
            LOCK:
            var GSHU01SND_136 = _world.AcknexObject.GetAcknexObject("GSHU01SND");
            _world.PlaySound(GSHU01SND_136, 0.3f);
            var FMT06SHUTEX_140 = _world.AcknexObject.GetAcknexObject("FMT06SHUTEX");
            FMT06SHUTEX_140.SetAcknexObject("SOUND", null);
            var SHUTLEGENIUSTNG_143 = _world.AcknexObject.GetAcknexObject("SHUTLEGENIUSTNG");
            SHUTLEGENIUSTNG_143.SetFloat("FLAG3", 0f);
            FASEEND:
            var SHUTLEGENIUSTNG_146 = _world.AcknexObject.GetAcknexObject("SHUTLEGENIUSTNG");
            var temp_147 = SHUTLEGENIUSTNG_146.GetFloat("FLAG3");
            if (temp_147 == 1f)
            {
                goto LOCK;
            }
            var SHUTLEDOORRGN_150 = _world.AcknexObject.GetAcknexObject("SHUTLEDOORRGN");
            SHUTLEDOORRGN_150.SetFloat("FLOOR_HGT", 0f);
            var SHUTLEDOORRGN_153 = _world.AcknexObject.GetAcknexObject("SHUTLEDOORRGN");
            SHUTLEDOORRGN_153.SetFloat("CEIL_HGT", 0.1f);
            var SHUTLERGN_156 = _world.AcknexObject.GetAcknexObject("SHUTLERGN");
            SHUTLERGN_156.SetFloat("FLOOR_HGT", 0f);
            var SHUTLEWINDOWRGN_159 = _world.AcknexObject.GetAcknexObject("SHUTLEWINDOWRGN");
            SHUTLEWINDOWRGN_159.SetFloat("FLOOR_HGT", 2.5f);
            var SHUTLERGN_162 = _world.AcknexObject.GetAcknexObject("SHUTLERGN");
            SHUTLERGN_162.SetFloat("CEIL_HGT", 6f);
            var SHUTLEWINDOWRGN_165 = _world.AcknexObject.GetAcknexObject("SHUTLEWINDOWRGN");
            SHUTLEWINDOWRGN_165.SetFloat("CEIL_HGT", 5f);
            var VX_166 = _world.GetObject(ObjectType.Skill, "VX");
            var VX_167 = _world.GetObject(ObjectType.Skill, "VX");
            var VX_167_val = VX_167.GetFloat("VAL");
            var SHUTLEGENIUSTNG_172 = _world.AcknexObject.GetAcknexObject("SHUTLEGENIUSTNG");
            var temp_173 = SHUTLEGENIUSTNG_172.GetFloat("X");
            VX_166.SetFloat("VAL", -170.5f - temp_173);
            var VY_174 = _world.GetObject(ObjectType.Skill, "VY");
            var VY_175 = _world.GetObject(ObjectType.Skill, "VY");
            var VY_175_val = VY_175.GetFloat("VAL");
            var SHUTLEGENIUSTNG_180 = _world.AcknexObject.GetAcknexObject("SHUTLEGENIUSTNG");
            var temp_181 = SHUTLEGENIUSTNG_180.GetFloat("Y");
            VY_174.SetFloat("VAL", -92.5f - temp_181);
            var SHUTLEGENIUSTNG_184 = _world.AcknexObject.GetAcknexObject("SHUTLEGENIUSTNG");
            SHUTLEGENIUSTNG_184.SetFloat("X", -170.5f);
            var SHUTLEGENIUSTNG_187 = _world.AcknexObject.GetAcknexObject("SHUTLEGENIUSTNG");
            SHUTLEGENIUSTNG_187.SetFloat("Y", -92.5f);
            var SHUTLEPARAM5_188 = _world.AcknexObject.GetAcknexObject("SHUTLEPARAM5");
            _world.SetSynonymObject("SHUTLEACTIONWAY1", SHUTLEPARAM5_188);
            var SHUTLEPARAM6_190 = _world.AcknexObject.GetAcknexObject("SHUTLEPARAM6");
            _world.SetSynonymObject("SHUTLEACTIONWAY2", SHUTLEPARAM6_190);
            var WMT19WAY1TEX_192 = _world.AcknexObject.GetAcknexObject("WMT19WAY1TEX");
            _world.SetSynonymObject("SHUTLETEXTUREWAY1", WMT19WAY1TEX_192);
            var WMT19WAY3TEX_194 = _world.AcknexObject.GetAcknexObject("WMT19WAY3TEX");
            _world.SetSynonymObject("SHUTLETEXTUREWAY2", WMT19WAY3TEX_194);
            var WMT19WAY2TEX_196 = _world.AcknexObject.GetAcknexObject("WMT19WAY2TEX");
            var SHUTLEWAYWALL_198 = _world.AcknexObject.GetAcknexObject("SHUTLEWAYWALL");
            SHUTLEWAYWALL_198.SetAcknexObject("TEXTURE", WMT19WAY2TEX_196);
            {
                var enumerator = STOPSETING(MY, THERE);
                while (enumerator.MoveNext())
                {
            ...
            var OPENSHUTLEDOOR_199 = _world.AcknexObject.GetAcknexObject("OPENSHUTLEDOOR");
            var SHUTLERGN_201 = _world.AcknexObject.GetAcknexObject("SHUTLERGN");
            SHUTLERGN_201.SetAcknexObject("EACH_TICK", OPENSHUTLEDOOR_199);
            var SHUTLEDOORRGN_204 = _world.AcknexObject.GetAcknexObject("SHUTLEDOORRGN");
            SHUTLEDOORRGN_204.SetAcknexObject("EACH_TICK", null);
            //Unknown keyword: 
            yield break;
        }
        public IEnumerator SHUTLEPARAM5(IAcknexObject MY, IAcknexObject THERE)
        {
            var SHUTLEGENIUSTNG_2 = _world.AcknexObject.GetAcknexObject("SHUTLEGENIUSTNG");
            var temp_3 = SHUTLEGENIUSTNG_2.GetFloat("FLAG1");
            if (temp_3 == 0f)
            ...
            var VX_21 = _world.GetObject(ObjectType.Skill, "VX");
            VX_21.SetFloat("VAL", -0.336956f);
            var VY_23 = _world.GetObject(ObjectType.Skill, "VY");
            VY_23.SetFloat("VAL", 0.25f);
            var VZ_25 = _world.GetObject(ObjectType.Skill, "VZ");
            VZ_25.SetFloat("VAL", 0f);
            var VR_27 = _world.GetObject(ObjectType.Skill, "VR");
            VR_27.SetFloat("VAL", -0.068295f);
            var VXCEIL_29 = _world.GetObject(ObjectType.Skill, "VXCEIL");
            VXCEIL_29.SetFloat("VAL", 10.7808f);
            var VXFLOOR_31 = _world.GetObject(ObjectType.Skill, "VXFLOOR");
            VXFLOOR_31.SetFloat("VAL", 10.7808f);
            var VYCEIL_33 = _world.GetObject(ObjectType.Skill, "VYCEIL");
            VYCEIL_33.SetFloat("VAL", -8f);
            var VYFLOOR_35 = _world.GetObject(ObjectType.Skill, "VYFLOOR");
            VYFLOOR_35.SetFloat("VAL", -8f);
            ...
            FASE3:
            var VX_53 = _world.GetObject(ObjectType.Skill, "VX");
            VX_53.SetFloat("VAL", 0.15909f);
            var VY_55 = _world.GetObject(ObjectType.Skill, "VY");
            VY_55.SetFloat("VAL", 0.25f);
            var VZ_57 = _world.GetObject(ObjectType.Skill, "VZ");
            VZ_57.SetFloat("VAL", 0f);
            var VR_59 = _world.GetObject(ObjectType.Skill, "VR");
            VR_59.SetFloat("VAL", -0.023799f);
            var VXCEIL_61 = _world.GetObject(ObjectType.Skill, "VXCEIL");
            VXCEIL_61.SetFloat("VAL", -5.09088f);
            var VXFLOOR_63 = _world.GetObject(ObjectType.Skill, "VXFLOOR");
            VXFLOOR_63.SetFloat("VAL", -5.09088f);
            var VYCEIL_65 = _world.GetObject(ObjectType.Skill, "VYCEIL");
            VYCEIL_65.SetFloat("VAL", -8f);
            var VYFLOOR_67 = _world.GetObject(ObjectType.Skill, "VYFLOOR");
            VYFLOOR_67.SetFloat("VAL", -8f);
            ...
            var SHUTLEGENIUSTNG_112 = _world.AcknexObject.GetAcknexObject("SHUTLEGENIUSTNG");
            var temp_113 = SHUTLEGENIUSTNG_112.GetFloat("X");
            VX_106.SetFloat("VAL", -89.5f - temp_113);
            var VY_114 = _world.GetObject(ObjectType.Skill, "VY");
            var VY_115 = _world.GetObject(ObjectType.Skill, "VY");
            var VY_115_val = VY_115.GetFloat("VAL");
            var SHUTLEGENIUSTNG_120 = _world.AcknexObject.GetAcknexObject("SHUTLEGENIUSTNG");
            var temp_121 = SHUTLEGENIUSTNG_120.GetFloat("Y");
            VY_114.SetFloat("VAL", -59.5f - temp_121);
            var SHUTLEGENIUSTNG_124 = _world.AcknexObject.GetAcknexObject("SHUTLEGENIUSTNG");
            SHUTLEGENIUSTNG_124.SetFloat("X", -89.5f);
            var SHUTLEGENIUSTNG_127 = _world.AcknexObject.GetAcknexObject("SHUTLEGENIUSTNG");
            SHUTLEGENIUSTNG_127.SetFloat("Y", -59.5f);
            var SHUTLEPARAM1_128 = _world.AcknexObject.GetAcknexObject("SHUTLEPARAM1");
            _world.SetSynonymObject("SHUTLEACTIONWAY1", SHUTLEPARAM1_128);
            var SHUTLEPARAM2_130 = _world.AcknexObject.GetAcknexObject("SHUTLEPARAM2");
            _world.SetSynonymObject("SHUTLEACTIONWAY2", SHUTLEPARAM2_130);
            var WMT19WAY3TEX_132 = _world.AcknexObject.GetAcknexObject("WMT19WAY3TEX");
            _world.SetSynonymObject("SHUTLETEXTUREWAY1", WMT19WAY3TEX_132);
            var WMT19WAY2TEX_134 = _world.AcknexObject.GetAcknexObject("WMT19WAY2TEX");
            _world.SetSynonymObject("SHUTLETEXTUREWAY2", WMT19WAY2TEX_134);
            var WMT19WAY1TEX_136 = _world.AcknexObject.GetAcknexObject("WMT19WAY1TEX");
            var SHUTLEWAYWALL_138 = _world.AcknexObject.GetAcknexObject("SHUTLEWAYWALL");
            SHUTLEWAYWALL_138.SetAcknexObject("TEXTURE", WMT19WAY1TEX_136);
            {
                var enumerator = STOPSETING(MY, THERE);
                while (enumerator.MoveNext())
                {
        ...
        public IEnumerator SHUTLEPARAM6(IAcknexObject MY, IAcknexObject THERE)
        {
            var SHUTLEGENIUSTNG_2 = _world.AcknexObject.GetAcknexObject("SHUTLEGENIUSTNG");
            var temp_3 = SHUTLEGENIUSTNG_2.GetFloat("FLAG1");
            if (temp_3 == 0f)
            ...
            VY_51.SetFloat("VAL", -0.5f);
            var VZ_53 = _world.GetObject(ObjectType.Skill, "VZ");
            VZ_53.SetFloat("VAL", 0f);
            var VR_55 = _world.GetObject(ObjectType.Skill, "VR");
            VR_55.SetFloat("VAL", -0.032724f);
            var VXCEIL_57 = _world.GetObject(ObjectType.Skill, "VXCEIL");
            VXCEIL_57.SetFloat("VAL", 16f);
            var VXFLOOR_59 = _world.GetObject(ObjectType.Skill, "VXFLOOR");
            VXFLOOR_59.SetFloat("VAL", 16f);
            ...
            VX_65.SetFloat("VAL", -0.5f);
            var VY_67 = _world.GetObject(ObjectType.Skill, "VY");
            VY_67.SetFloat("VAL", 0f);
            var VZ_69 = _world.GetObject(ObjectType.Skill, "VZ");
            VZ_69.SetFloat("VAL", -1f);
            var VR_71 = _world.GetObject(ObjectType.Skill, "VR");
            VR_71.SetFloat("VAL", 0f);
            var VXCEIL_73 = _world.GetObject(ObjectType.Skill, "VXCEIL");
            VXCEIL_73.SetFloat("VAL", 16f);
            var VXFLOOR_75 = _world.GetObject(ObjectType.Skill, "VXFLOOR");
            VXFLOOR_75.SetFloat("VAL", 16f);
            var VYCEIL_77 = _world.GetObject(ObjectType.Skill, "VYCEIL");
            VYCEIL_77.SetFloat("VAL", 0f);
            var VYFLOOR_79 = _world.GetObject(ObjectType.Skill, "VYFLOOR");
            VYFLOOR_79.SetFloat("VAL", 0f);
            yield break;
            FASE4:
            var VX_81 = _world.GetObject(ObjectType.Skill, "VX");
            VX_81.SetFloat("VAL", -0.5f);
            var VY_83 = _world.GetObject(ObjectType.Skill, "VY");
            VY_83.SetFloat("VAL", 0.5f);
            var VZ_85 = _world.GetObject(ObjectType.Skill, "VZ");
            VZ_85.SetFloat("VAL", 0f);
            var VR_87 = _world.GetObject(ObjectType.Skill, "VR");
            VR_87.SetFloat("VAL", -0.049087f);
            var VXCEIL_89 = _world.GetObject(ObjectType.Skill, "VXCEIL");
            VXCEIL_89.SetFloat("VAL", 16f);
            var VXFLOOR_91 = _world.GetObject(ObjectType.Skill, "VXFLOOR");
            VXFLOOR_91.SetFloat("VAL", 16f);
            var VYCEIL_93 = _world.GetObject(ObjectType.Skill, "VYCEIL");
            VYCEIL_93.SetFloat("VAL", -16f);
            var VYFLOOR_95 = _world.GetObject(ObjectType.Skill, "VYFLOOR");
            VYFLOOR_95.SetFloat("VAL", -16f);
            yield break;
            FASE5:
            var VX_97 = _world.GetObject(ObjectType.Skill, "VX");
            VX_97.SetFloat("VAL", -0.5f);
            var VY_99 = _world.GetObject(ObjectType.Skill, "VY");
            VY_99.SetFloat("VAL", 0.5f);
            var VZ_101 = _world.GetObject(ObjectType.Skill, "VZ");
            VZ_101.SetFloat("VAL", 0f);
            var VR_103 = _world.GetObject(ObjectType.Skill, "VR");
            VR_103.SetFloat("VAL", 0f);
            var VXCEIL_105 = _world.GetObject(ObjectType.Skill, "VXCEIL");
            VXCEIL_105.SetFloat("VAL", 16f);
            var VXFLOOR_107 = _world.GetObject(ObjectType.Skill, "VXFLOOR");
            VXFLOOR_107.SetFloat("VAL", 16f);
            var VYCEIL_109 = _world.GetObject(ObjectType.Skill, "VYCEIL");
            VYCEIL_109.SetFloat("VAL", -16f);
            var VYFLOOR_111 = _world.GetObject(ObjectType.Skill, "VYFLOOR");
            VYFLOOR_111.SetFloat("VAL", -16f);
            yield break;
            FASE6:
            var VX_113 = _world.GetObject(ObjectType.Skill, "VX");
            VX_113.SetFloat("VAL", -0.25f);
            ...
            VY_115.SetFloat("VAL", 0f);
            var VZ_117 = _world.GetObject(ObjectType.Skill, "VZ");
            VZ_117.SetFloat("VAL", 0.517857f);
            var VR_119 = _world.GetObject(ObjectType.Skill, "VR");
            VR_119.SetFloat("VAL", -0.098174f);
            var VXCEIL_121 = _world.GetObject(ObjectType.Skill, "VXCEIL");
            VXCEIL_121.SetFloat("VAL", 8f);
            var VXFLOOR_123 = _world.GetObject(ObjectType.Skill, "VXFLOOR");
            VXFLOOR_123.SetFloat("VAL", 8f);
            ...
            var SHUTLEDOORRGN_150 = _world.AcknexObject.GetAcknexObject("SHUTLEDOORRGN");
            SHUTLEDOORRGN_150.SetFloat("FLOOR_HGT", -90f);
            var SHUTLEDOORRGN_153 = _world.AcknexObject.GetAcknexObject("SHUTLEDOORRGN");
            SHUTLEDOORRGN_153.SetFloat("CEIL_HGT", -89.9f);
            var SHUTLERGN_156 = _world.AcknexObject.GetAcknexObject("SHUTLERGN");
            SHUTLERGN_156.SetFloat("FLOOR_HGT", -90f);
            var SHUTLEWINDOWRGN_159 = _world.AcknexObject.GetAcknexObject("SHUTLEWINDOWRGN");
            SHUTLEWINDOWRGN_159.SetFloat("FLOOR_HGT", -87.5f);
            var SHUTLERGN_162 = _world.AcknexObject.GetAcknexObject("SHUTLERGN");
            SHUTLERGN_162.SetFloat("CEIL_HGT", -84f);
            var SHUTLEWINDOWRGN_165 = _world.AcknexObject.GetAcknexObject("SHUTLEWINDOWRGN");
            SHUTLEWINDOWRGN_165.SetFloat("CEIL_HGT", -85f);
            var VX_166 = _world.GetObject(ObjectType.Skill, "VX");
            var VX_167 = _world.GetObject(ObjectType.Skill, "VX");
            var VX_167_val = VX_167.GetFloat("VAL");
            var SHUTLEGENIUSTNG_172 = _world.AcknexObject.GetAcknexObject("SHUTLEGENIUSTNG");
            var temp_173 = SHUTLEGENIUSTNG_172.GetFloat("X");
            VX_166.SetFloat("VAL", -414f - temp_173);
            var VY_174 = _world.GetObject(ObjectType.Skill, "VY");
            var VY_175 = _world.GetObject(ObjectType.Skill, "VY");
            var VY_175_val = VY_175.GetFloat("VAL");
            var SHUTLEGENIUSTNG_179 = _world.AcknexObject.GetAcknexObject("SHUTLEGENIUSTNG");
            var temp_180 = SHUTLEGENIUSTNG_179.GetFloat("Y");
            VY_174.SetFloat("VAL", 36f - temp_180);
            var SHUTLEGENIUSTNG_183 = _world.AcknexObject.GetAcknexObject("SHUTLEGENIUSTNG");
            SHUTLEGENIUSTNG_183.SetFloat("X", -414f);
            var SHUTLEGENIUSTNG_186 = _world.AcknexObject.GetAcknexObject("SHUTLEGENIUSTNG");
            SHUTLEGENIUSTNG_186.SetFloat("Y", 36f);
            var SHUTLEPARAM3_187 = _world.AcknexObject.GetAcknexObject("SHUTLEPARAM3");
            _world.SetSynonymObject("SHUTLEACTIONWAY1", SHUTLEPARAM3_187);
            var SHUTLEPARAM4_189 = _world.AcknexObject.GetAcknexObject("SHUTLEPARAM4");
            _world.SetSynonymObject("SHUTLEACTIONWAY2", SHUTLEPARAM4_189);
            var WMT19WAY1TEX_191 = _world.AcknexObject.GetAcknexObject("WMT19WAY1TEX");
            _world.SetSynonymObject("SHUTLETEXTUREWAY1", WMT19WAY1TEX_191);
            var WMT19WAY2TEX_193 = _world.AcknexObject.GetAcknexObject("WMT19WAY2TEX");
            _world.SetSynonymObject("SHUTLETEXTUREWAY2", WMT19WAY2TEX_193);
            var WMT19WAY3TEX_195 = _world.AcknexObject.GetAcknexObject("WMT19WAY3TEX");
            var SHUTLEWAYWALL_197 = _world.AcknexObject.GetAcknexObject("SHUTLEWAYWALL");
            SHUTLEWAYWALL_197.SetAcknexObject("TEXTURE", WMT19WAY3TEX_195);
            {
                var enumerator = STOPSETING(MY, THERE);
                while (enumerator.MoveNext())
                {
            ...
            var OPENSHUTLEDOOR_198 = _world.AcknexObject.GetAcknexObject("OPENSHUTLEDOOR");
            var SHUTLERGN_200 = _world.AcknexObject.GetAcknexObject("SHUTLERGN");
            SHUTLERGN_200.SetAcknexObject("EACH_TICK", OPENSHUTLEDOOR_198);
            var SHUTLEDOORRGN_203 = _world.AcknexObject.GetAcknexObject("SHUTLEDOORRGN");
            SHUTLEDOORRGN_203.SetAcknexObject("EACH_TICK", null);
            //Unknown keyword: 
            yield break;
        }
        public IEnumerator OPENSHUTLEDOOR(IAcknexObject MY, IAcknexObject THERE)
        {
            var SHUTLEDOORRGN_2 = _world.AcknexObject.GetAcknexObject("SHUTLEDOORRGN");
            var temp_3 = SHUTLEDOORRGN_2.GetFloat("CEIL_HGT");
            var SHUTLEDOORRGN_5 = _world.AcknexObject.GetAcknexObject("SHUTLEDOORRGN");
            SHUTLEDOORRGN_5.SetFloat("CEIL_HGT", temp_3 + 0.1f);
            var SHUTLERGN_7 = _world.AcknexObject.GetAcknexObject("SHUTLERGN");
            var temp_8 = SHUTLERGN_7.GetFloat("CEIL_HGT");
            var SHUTLEDOORRGN_10 = _world.AcknexObject.GetAcknexObject("SHUTLEDOORRGN");
            var temp_11 = SHUTLEDOORRGN_10.GetFloat("CEIL_HGT");
            if (temp_11 > temp_8)
            {
            ...
            yield break;
            ENDDOOR:
            var SHUTLERGN_14 = _world.AcknexObject.GetAcknexObject("SHUTLERGN");
            SHUTLERGN_14.SetAcknexObject("EACH_TICK", null);
            var SHUTLEGENIUSTNG_17 = _world.AcknexObject.GetAcknexObject("SHUTLEGENIUSTNG");
            SHUTLEGENIUSTNG_17.SetFloat("FLAG1", 0f);
            var SHUTLEDOORWALL_20 = _world.AcknexObject.GetAcknexObject("SHUTLEDOORWALL");
            SHUTLEDOORWALL_20.SetFloatAll("PASSABLE", 1f);
            var WMT19OFFTEX_21 = _world.AcknexObject.GetAcknexObject("WMT19OFFTEX");
            var SHUTLEONOFFWALL_23 = _world.AcknexObject.GetAcknexObject("SHUTLEONOFFWALL");
            SHUTLEONOFFWALL_23.SetAcknexObject("TEXTURE", WMT19OFFTEX_21);
            var SHUTLEGENIUSTNG_26 = _world.AcknexObject.GetAcknexObject("SHUTLEGENIUSTNG");
            SHUTLEGENIUSTNG_26.SetFloat("FLAG2", 0f);
            //Unknown keyword: 
            yield break;
        }
        public IEnumerator STOPSETING(IAcknexObject MY, IAcknexObject THERE)
        {
            var SHUTLERGN_0 = _world.AcknexObject.GetAcknexObject("SHUTLERGN");
            var VX_1 = _world.GetObject(ObjectType.Skill, "VX");
            var VX_1_val = VX_1.GetFloat("VAL");
            var VY_2 = _world.GetObject(ObjectType.Skill, "VY");
            var VY_2_val = VY_2.GetFloat("VAL");
            _world.Shift(SHUTLERGN_0, VX_1_val, VY_2_val);
            var SHUTLEBORDERRGN_3 = _world.AcknexObject.GetAcknexObject("SHUTLEBORDERRGN");
            var VX_4 = _world.GetObject(ObjectType.Skill, "VX");
            var VX_4_val = VX_4.GetFloat("VAL");
            var VY_5 = _world.GetObject(ObjectType.Skill, "VY");
            var VY_5_val = VY_5.GetFloat("VAL");
            _world.Shift(SHUTLEBORDERRGN_3, VX_4_val, VY_5_val);
            var SHUTLEBORDER2RGN_6 = _world.AcknexObject.GetAcknexObject("SHUTLEBORDER2RGN");
            var VX_7 = _world.GetObject(ObjectType.Skill, "VX");
            var VX_7_val = VX_7.GetFloat("VAL");
            var VY_8 = _world.GetObject(ObjectType.Skill, "VY");
            var VY_8_val = VY_8.GetFloat("VAL");
            _world.Shift(SHUTLEBORDER2RGN_6, VX_7_val, VY_8_val);
            var SHUTLEWINDOWRGN_9 = _world.AcknexObject.GetAcknexObject("SHUTLEWINDOWRGN");
            var VX_10 = _world.GetObject(ObjectType.Skill, "VX");
            var VX_10_val = VX_10.GetFloat("VAL");
            var VY_11 = _world.GetObject(ObjectType.Skill, "VY");
            var VY_11_val = VY_11.GetFloat("VAL");
            _world.Shift(SHUTLEWINDOWRGN_9, VX_10_val, VY_11_val);
            var SHUTLEDOORRGN_12 = _world.AcknexObject.GetAcknexObject("SHUTLEDOORRGN");
            var VX_13 = _world.GetObject(ObjectType.Skill, "VX");
            var VX_13_val = VX_13.GetFloat("VAL");
            var VY_14 = _world.GetObject(ObjectType.Skill, "VY");
            var VY_14_val = VY_14.GetFloat("VAL");
            _world.Shift(SHUTLEDOORRGN_12, VX_13_val, VY_14_val);
            var SHUTLEGENIUSTNG_17 = _world.AcknexObject.GetAcknexObject("SHUTLEGENIUSTNG");
            SHUTLEGENIUSTNG_17.SetFloat("FLAG4", 0f);
            var VX_19 = _world.GetObject(ObjectType.Skill, "VX");
            VX_19.SetFloat("VAL", 0f);
            var VY_21 = _world.GetObject(ObjectType.Skill, "VY");
            VY_21.SetFloat("VAL", 0f);
            var VZ_23 = _world.GetObject(ObjectType.Skill, "VZ");
            VZ_23.SetFloat("VAL", 0f);
            var VR_25 = _world.GetObject(ObjectType.Skill, "VR");
            VR_25.SetFloat("VAL", 0f);
            var VXCEIL_27 = _world.GetObject(ObjectType.Skill, "VXCEIL");
            VXCEIL_27.SetFloat("VAL", 0f);
            var VXFLOOR_29 = _world.GetObject(ObjectType.Skill, "VXFLOOR");
            VXFLOOR_29.SetFloat("VAL", 0f);
            var VYCEIL_31 = _world.GetObject(ObjectType.Skill, "VYCEIL");
            VYCEIL_31.SetFloat("VAL", 0f);
            var VYFLOOR_33 = _world.GetObject(ObjectType.Skill, "VYFLOOR");
            VYFLOOR_33.SetFloat("VAL", 0f);
            var WALK_PERIOD_35 = _world.GetObject(ObjectType.Skill, "WALK_PERIOD");
            WALK_PERIOD_35.SetFloat("VAL", 10f);
            var SHUTLERGN_38 = _world.AcknexObject.GetAcknexObject("SHUTLERGN");
            SHUTLERGN_38.SetFloat("AMBIENT", 0.6f);
            //Unknown keyword: 
            yield break;
        }
        public IEnumerator BIOIMPASSABLE(IAcknexObject MY, IAcknexObject THERE)
        {
            var WMT18DBIOEXTWALL_2 = _world.AcknexObject.GetAcknexObject("WMT18DBIOEXTWALL");
            WMT18DBIOEXTWALL_2.SetFloatAll("IMPASSABLE", 1f);
            //Unknown keyword: 
            yield break;
        }
        public IEnumerator BIOPASSABLE(IAcknexObject MY, IAcknexObject THERE)
        {
            var WMT18DBIOEXTWALL_2 = _world.AcknexObject.GetAcknexObject("WMT18DBIOEXTWALL");
            WMT18DBIOEXTWALL_2.SetFloatAll("IMPASSABLE", 0f);
            //Unknown keyword: 
            yield break;
        }
        public IEnumerator GOCITY(IAcknexObject MY, IAcknexObject THERE)
        {
            var PLAYER_X_1 = _world.GetObject(ObjectType.Skill, "PLAYER_X");
            var PLAYER_X_1_val = PLAYER_X_1.GetFloat("VAL");
            var PLAYER_X_2 = _world.GetObject(ObjectType.Skill, "PLAYER_X");
            PLAYER_X_2.SetFloat("VAL", PLAYER_X_1_val + -444.5f);
            var PLAYER_Y_4 = _world.GetObject(ObjectType.Skill, "PLAYER_Y");
            var PLAYER_Y_4_val = PLAYER_Y_4.GetFloat("VAL");
            var PLAYER_Y_5 = _world.GetObject(ObjectType.Skill, "PLAYER_Y");
            PLAYER_Y_5.SetFloat("VAL", PLAYER_Y_4_val + -381f);
            ...
            PLAYER_Z_8.SetFloat("VAL", PLAYER_Z_7_val + -90f);
            //Unknown keyword: LOCATE
            var RENDER_MODE_10 = _world.GetObject(ObjectType.Skill, "RENDER_MODE");
            RENDER_MODE_10.SetFloat("VAL", 2f);
            //Unknown keyword: 
            yield break;
        }
        public IEnumerator GOCATEDRAL(IAcknexObject MY, IAcknexObject THERE)
        {
            var PLAYER_X_1 = _world.GetObject(ObjectType.Skill, "PLAYER_X");
            var PLAYER_X_1_val = PLAYER_X_1.GetFloat("VAL");
            var PLAYER_X_2 = _world.GetObject(ObjectType.Skill, "PLAYER_X");
        ...
        public IEnumerator CHANGEHEIGHT(IAcknexObject MY, IAcknexObject THERE)
        {
            var MY_1 = MY;
            var MY_3 = MY;
            var temp_4 = MY_3.GetFloat("HEIGHT");
            var MY_7 = MY;
            var temp_8 = MY_7.GetFloat("SKILL1");
            MY_1.SetFloat("HEIGHT", (temp_8 + 200f) * UnityEngine.Random.value - 200f);
            //Unknown keyword: 
            yield break;
        }
        public IEnumerator SELECTOR(IAcknexObject MY, IAcknexObject THERE)
        {
            ...
            {
                {
                    var enumerator = OPENPASS1(MY, THERE);
                    while (enumerator.MoveNext())
                    {
                        var current = enumerator.Current;
                        if (current != null)
            ...
            {
                {
                    var enumerator = OPENPASS2(MY, THERE);
                    while (enumerator.MoveNext())
                    {
                        var current = enumerator.Current;
                        if (current != null)
            ...
            if (TOUCHKEY_5_val == 3f)
            {
                {
                    var enumerator = SETSHUTLEON(MY, THERE);
                    while (enumerator.MoveNext())
                    {
                        var current = enumerator.Current;
                        if (current != null)
            ...
            if (TOUCHKEY_7_val == 4f)
            {
                {
                    var enumerator = SETSHUTLEWAY(MY, THERE);
                    while (enumerator.MoveNext())
                    {
                        var current = enumerator.Current;
                        if (current != null)
            ...
            if (TOUCHKEY_9_val == 5f)
            {
                {
                    var enumerator = OPENMIBDOOR(MY, THERE);
                    while (enumerator.MoveNext())
                    {
                        var current = enumerator.Current;
                        if (current != null)
            ...
            if (TOUCHKEY_11_val == 6f)
            {
                {
                    var enumerator = OPENBIODOOR(MY, THERE);
                    while (enumerator.MoveNext())
                    {
                        var current = enumerator.Current;
                        if (current != null)
            ...
            if (TOUCHKEY_13_val == 7f)
            {
                {
                    var enumerator = OPENGRAYDOOR(MY, THERE);
                    while (enumerator.MoveNext())
                    {
                        var current = enumerator.Current;
                        if (current != null)
            ...
            var TOUCHKEY_15 = _world.GetObject(ObjectType.Skill, "TOUCHKEY");
            var TOUCHKEY_15_val = TOUCHKEY_15.GetFloat("VAL");
            if (TOUCHKEY_15_val == 8f)
            {
                {
                    var enumerator = SETTRAPMIB(MY, THERE);
                    while (enumerator.MoveNext())
                    {
                        var current = enumerator.Current;
                        if (current != null)
        ...
        public IEnumerator SETPASS1(IAcknexObject MY, IAcknexObject THERE)
        {
            var TOUCHKEY_1 = _world.GetObject(ObjectType.Skill, "TOUCHKEY");
            TOUCHKEY_1.SetFloat("VAL", 1f);
            var MY_4 = MY;
            var temp_5 = MY_4.GetFloat("DIST");
            var MY_7 = MY;
            MY_7.SetFloat("DIST", temp_5 + 1f);
            //Unknown keyword: 
            yield break;
        }
        public IEnumerator SETPASS2(IAcknexObject MY, IAcknexObject THERE)
        {
            var TOUCHKEY_1 = _world.GetObject(ObjectType.Skill, "TOUCHKEY");
        ...
        public IEnumerator SETPASS3(IAcknexObject MY, IAcknexObject THERE)
        {
            var TOUCHKEY_1 = _world.GetObject(ObjectType.Skill, "TOUCHKEY");
            TOUCHKEY_1.SetFloat("VAL", 3f);
            var MY_4 = MY;
            var temp_5 = MY_4.GetFloat("DIST");
            var MY_7 = MY;
            MY_7.SetFloat("DIST", temp_5 + 1f);
        ...
        public IEnumerator SETPASS4(IAcknexObject MY, IAcknexObject THERE)
        {
            var TOUCHKEY_1 = _world.GetObject(ObjectType.Skill, "TOUCHKEY");
        ...
        public IEnumerator SETPASS5(IAcknexObject MY, IAcknexObject THERE)
        {
            var TOUCHKEY_1 = _world.GetObject(ObjectType.Skill, "TOUCHKEY");
        ...
        public IEnumerator SETPASS6(IAcknexObject MY, IAcknexObject THERE)
        {
            var TOUCHKEY_1 = _world.GetObject(ObjectType.Skill, "TOUCHKEY");
        ...
        public IEnumerator SETPASS7(IAcknexObject MY, IAcknexObject THERE)
        {
            var TOUCHKEY_1 = _world.GetObject(ObjectType.Skill, "TOUCHKEY");
        ...
        public IEnumerator SETPASS8(IAcknexObject MY, IAcknexObject THERE)
        {
            var TOUCHKEY_1 = _world.GetObject(ObjectType.Skill, "TOUCHKEY");
        ...
        public IEnumerator RESETPASS(IAcknexObject MY, IAcknexObject THERE)
        {
            var TOUCHKEY_1 = _world.GetObject(ObjectType.Skill, "TOUCHKEY");
        ...
        public IEnumerator OPENPASS1(IAcknexObject MY, IAcknexObject THERE)
        {
            var LOCKSND_0 = _world.AcknexObject.GetAcknexObject("LOCKSND");
            _world.PlaySound(LOCKSND_0, 0.3f);
            var KEYOPENWMT02TEX_2 = _world.AcknexObject.GetAcknexObject("KEYOPENWMT02TEX");
            var CONTROL1WALL_4 = _world.AcknexObject.GetAcknexObject("CONTROL1WALL");
            CONTROL1WALL_4.SetAcknexObjectAll("TEXTURE", KEYOPENWMT02TEX_2);
            var CONTROL1WALL_7 = _world.AcknexObject.GetAcknexObject("CONTROL1WALL");
            CONTROL1WALL_7.SetAcknexObjectAll("IF_NEAR", null);
            var NULLTEX_8 = _world.AcknexObject.GetAcknexObject("NULLTEX");
            var JAILWALL_10 = _world.AcknexObject.GetAcknexObject("JAILWALL");
            JAILWALL_10.SetAcknexObjectAll("TEXTURE", NULLTEX_8);
            var JAILWALL_13 = _world.AcknexObject.GetAcknexObject("JAILWALL");
            JAILWALL_13.SetFloatAll("IMPASSABLE", 0f);
            var JAILWALL_16 = _world.AcknexObject.GetAcknexObject("JAILWALL");
            JAILWALL_16.SetFloatAll("PASSABLE", 1f);
            var BIODRKLJAILACT_19 = _world.AcknexObject.GetAcknexObject("BIODRKLJAILACT");
            BIODRKLJAILACT_19.SetFloatAll("FRAGILE", 1f);
            var BIOLNCHDACT_22 = _world.AcknexObject.GetAcknexObject("BIOLNCHDACT");
            BIOLNCHDACT_22.SetFloatAll("INVISIBLE", 0f);
        ...
        public IEnumerator OPENPASS2(IAcknexObject MY, IAcknexObject THERE)
        {
            {
                var enumerator = SETBIOREINFORCE(MY, THERE);
                while (enumerator.MoveNext())
                {
                    var current = enumerator.Current;
                    if (current != null)
            ...
            var WRN15STR_0 = _world.AcknexObject.GetAcknexObject("WRN15STR");
            _world.SetSynonymObject("MESSAGE_TEXT", WRN15STR_0);
            {
                var enumerator = DISPLAYMESSAGE(MY, THERE);
                while (enumerator.MoveNext())
                {
            ...
            var KEYOPENWMT02TEX_2 = _world.AcknexObject.GetAcknexObject("KEYOPENWMT02TEX");
            var CONTROL2WALL_4 = _world.AcknexObject.GetAcknexObject("CONTROL2WALL");
            CONTROL2WALL_4.SetAcknexObjectAll("TEXTURE", KEYOPENWMT02TEX_2);
            OPEN:
            var BIODOOR1RGN_7 = _world.AcknexObject.GetAcknexObject("BIODOOR1RGN");
            var temp_8 = BIODOOR1RGN_7.GetFloat("CEIL_HGT");
            var BIODOOR1RGN_10 = _world.AcknexObject.GetAcknexObject("BIODOOR1RGN");
            BIODOOR1RGN_10.SetFloat("CEIL_HGT", temp_8 + 0.1f);
            ...
            var BIODOOR1RGN_16 = _world.AcknexObject.GetAcknexObject("BIODOOR1RGN");
            var temp_17 = BIODOOR1RGN_16.GetFloat("CEIL_HGT");
            if (temp_17 < 16.5f)
            {
                goto OPEN;
            }
            var CONTROL2WALL_20 = _world.AcknexObject.GetAcknexObject("CONTROL2WALL");
            CONTROL2WALL_20.SetAcknexObjectAll("IF_NEAR", null);
            //Unknown keyword: 
            yield break;
        }
        public IEnumerator OPENMIBDOOR(IAcknexObject MY, IAcknexObject THERE)
        {
            var UPDOWNDOOR_1 = _world.GetSynonymObject("UPDOWNDOOR");
            if (UPDOWNDOOR_1 != null)
            {
                yield break;
            }
            ...
            {
                var enumerator = SETMIBA(MY, THERE);
                while (enumerator.MoveNext())
                {
                    var current = enumerator.Current;
                    if (current != null)
            ...
            var MIBDOORRGN_4 = _world.AcknexObject.GetAcknexObject("MIBDOORRGN");
            _world.SetSynonymObject("UPDOWNDOOR", MIBDOORRGN_4);
            var CEILPOS_7 = _world.GetObject(ObjectType.Skill, "CEILPOS");
            CEILPOS_7.SetFloat("VAL", 26.5f);
            var KEYOPENMIBTEX_8 = _world.AcknexObject.GetAcknexObject("KEYOPENMIBTEX");
            var MIBWALL_10 = _world.AcknexObject.GetAcknexObject("MIBWALL");
            MIBWALL_10.SetAcknexObjectAll("TEXTURE", KEYOPENMIBTEX_8);
            var MIBWALL_11 = _world.AcknexObject.GetAcknexObject("MIBWALL");
            _world.SetSynonymObject("LOCKWALL", MIBWALL_11);
            var KEYONMIBTEX_13 = _world.AcknexObject.GetAcknexObject("KEYONMIBTEX");
            _world.SetSynonymObject("LOCKTEX", KEYONMIBTEX_13);
            {
                var enumerator = OPENDOOR(MY, THERE);
                while (enumerator.MoveNext())
                {
                    var current = enumerator.Current;
                    if (current != null)
            ...
            yield break;
            DISPLAY:
            var WRN13STR_15 = _world.AcknexObject.GetAcknexObject("WRN13STR");
            _world.SetSynonymObject("MESSAGE_TEXT", WRN13STR_15);
            {
                var enumerator = DISPLAYMESSAGE(MY, THERE);
                while (enumerator.MoveNext())
                {
        ...
        public IEnumerator OPENBIODOOR(IAcknexObject MY, IAcknexObject THERE)
        {
            var UPDOWNDOOR_1 = _world.GetSynonymObject("UPDOWNDOOR");
            if (UPDOWNDOOR_1 != null)
            {
            ...
            var KEY2_3 = _world.GetObject(ObjectType.Skill, "KEY2");
            var KEY2_3_val = KEY2_3.GetFloat("VAL");
            if (KEY2_3_val != 1f)
            {
                goto DISPLAY;
            }
            var BIODOORRGN_4 = _world.AcknexObject.GetAcknexObject("BIODOORRGN");
            _world.SetSynonymObject("UPDOWNDOOR", BIODOORRGN_4);
            var CEILPOS_7 = _world.GetObject(ObjectType.Skill, "CEILPOS");
            CEILPOS_7.SetFloat("VAL", 17f);
            var KEYOPENLABTEX_8 = _world.AcknexObject.GetAcknexObject("KEYOPENLABTEX");
            var BIOWALL_10 = _world.AcknexObject.GetAcknexObject("BIOWALL");
            BIOWALL_10.SetAcknexObjectAll("TEXTURE", KEYOPENLABTEX_8);
            var BIOWALL_11 = _world.AcknexObject.GetAcknexObject("BIOWALL");
            _world.SetSynonymObject("LOCKWALL", BIOWALL_11);
            var KEYONLABTEX_13 = _world.AcknexObject.GetAcknexObject("KEYONLABTEX");
            _world.SetSynonymObject("LOCKTEX", KEYONLABTEX_13);
            {
                var enumerator = SETBIOA(MY, THERE);
                while (enumerator.MoveNext())
                {
                    var current = enumerator.Current;
                    if (current != null)
            ...
            yield break;
            DISPLAY:
            var WRN11STR_15 = _world.AcknexObject.GetAcknexObject("WRN11STR");
            _world.SetSynonymObject("MESSAGE_TEXT", WRN11STR_15);
            {
                var enumerator = DISPLAYMESSAGE(MY, THERE);
                while (enumerator.MoveNext())
                {
        ...
        public IEnumerator OPENGRAYDOOR(IAcknexObject MY, IAcknexObject THERE)
        {
            var UPDOWNDOOR_1 = _world.GetSynonymObject("UPDOWNDOOR");
            if (UPDOWNDOOR_1 != null)
            {
            ...
            var KEY3_3 = _world.GetObject(ObjectType.Skill, "KEY3");
            var KEY3_3_val = KEY3_3.GetFloat("VAL");
            if (KEY3_3_val != 1f)
            {
                goto DISPLAY;
            }
            var MIBDRKLKILLERACT_6 = _world.AcknexObject.GetAcknexObject("MIBDRKLKILLERACT");
            MIBDRKLKILLERACT_6.SetFloatAll("INVISIBLE", 0f);
            var GRAYDOORRGN_7 = _world.AcknexObject.GetAcknexObject("GRAYDOORRGN");
            _world.SetSynonymObject("UPDOWNDOOR", GRAYDOORRGN_7);
            var CEILPOS_10 = _world.GetObject(ObjectType.Skill, "CEILPOS");
            CEILPOS_10.SetFloat("VAL", 7f);
            var KEYOPENGRAYTEX_11 = _world.AcknexObject.GetAcknexObject("KEYOPENGRAYTEX");
            var GRAYWALL_13 = _world.AcknexObject.GetAcknexObject("GRAYWALL");
            GRAYWALL_13.SetAcknexObjectAll("TEXTURE", KEYOPENGRAYTEX_11);
            var GRAYWALL_14 = _world.AcknexObject.GetAcknexObject("GRAYWALL");
            _world.SetSynonymObject("LOCKWALL", GRAYWALL_14);
            var KEYONGRAYTEX_16 = _world.AcknexObject.GetAcknexObject("KEYONGRAYTEX");
            _world.SetSynonymObject("LOCKTEX", KEYONGRAYTEX_16);
            {
                var enumerator = OPENDOOR(MY, THERE);
                while (enumerator.MoveNext())
                {
            ...
            yield break;
            DISPLAY:
            var WRN14STR_18 = _world.AcknexObject.GetAcknexObject("WRN14STR");
            _world.SetSynonymObject("MESSAGE_TEXT", WRN14STR_18);
            {
                var enumerator = DISPLAYMESSAGE(MY, THERE);
                while (enumerator.MoveNext())
                {
        ...
        public IEnumerator SETTRAPMIB(IAcknexObject MY, IAcknexObject THERE)
        {
            var KEYOPENGRAYTEX_0 = _world.AcknexObject.GetAcknexObject("KEYOPENGRAYTEX");
            var MIBTRAPWALL_2 = _world.AcknexObject.GetAcknexObject("MIBTRAPWALL");
            MIBTRAPWALL_2.SetAcknexObjectAll("TEXTURE", KEYOPENGRAYTEX_0);
            var MIBTRAPRGN_5 = _world.AcknexObject.GetAcknexObject("MIBTRAPRGN");
            MIBTRAPRGN_5.SetFloatAll("CEIL_HGT", 20f);
            {
                var enumerator = SETMIBC(MY, THERE);
                while (enumerator.MoveNext())
                {
                    var current = enumerator.Current;
                    if (current != null)
            ...
            var WRN15STR_6 = _world.AcknexObject.GetAcknexObject("WRN15STR");
            _world.SetSynonymObject("MESSAGE_TEXT", WRN15STR_6);
            {
                var enumerator = DISPLAYMESSAGE(MY, THERE);
                while (enumerator.MoveNext())
                {
        ...
        public IEnumerator WARNINGG(IAcknexObject MY, IAcknexObject THERE)
        {
            var WRN13STR_0 = _world.AcknexObject.GetAcknexObject("WRN13STR");
            _world.SetSynonymObject("MESSAGE_TEXT", WRN13STR_0);
            {
                var enumerator = DISPLAYMESSAGE(MY, THERE);
                while (enumerator.MoveNext())
                {
        ...
        public IEnumerator WARNINGB(IAcknexObject MY, IAcknexObject THERE)
        {
            var WRN11STR_0 = _world.AcknexObject.GetAcknexObject("WRN11STR");
            _world.SetSynonymObject("MESSAGE_TEXT", WRN11STR_0);
            {
                var enumerator = DISPLAYMESSAGE(MY, THERE);
                while (enumerator.MoveNext())
                {
        ...
        public IEnumerator WARNINGY(IAcknexObject MY, IAcknexObject THERE)
        {
            var WRN14STR_0 = _world.AcknexObject.GetAcknexObject("WRN14STR");
            _world.SetSynonymObject("MESSAGE_TEXT", WRN14STR_0);
            {
                var enumerator = DISPLAYMESSAGE(MY, THERE);
                while (enumerator.MoveNext())
                {
        ...
        public IEnumerator OPENGY1(IAcknexObject MY, IAcknexObject THERE)
        {
            var UPDOWNDOOR_1 = _world.GetSynonymObject("UPDOWNDOOR");
            if (UPDOWNDOOR_1 != null)
            {
            ...
            var KEY4_3 = _world.GetObject(ObjectType.Skill, "KEY4");
            var KEY4_3_val = KEY4_3.GetFloat("VAL");
            if (KEY4_3_val != 1f)
            {
                goto DISPLAY;
            }
            var GYDOOR1WALL_4 = _world.AcknexObject.GetAcknexObject("GYDOOR1WALL");
            _world.SetSynonymObject("LOCKWALL", GYDOOR1WALL_4);
            var DMT18TEX_6 = _world.AcknexObject.GetAcknexObject("DMT18TEX");
            _world.SetSynonymObject("LOCKTEX", DMT18TEX_6);
            var GYDOOR1RGN_8 = _world.AcknexObject.GetAcknexObject("GYDOOR1RGN");
            _world.SetSynonymObject("UPDOWNDOOR", GYDOOR1RGN_8);
            var CEILPOS_11 = _world.GetObject(ObjectType.Skill, "CEILPOS");
            CEILPOS_11.SetFloat("VAL", 6.5f);
            {
                var enumerator = OPENDOOR(MY, THERE);
                while (enumerator.MoveNext())
                {
            ...
            yield break;
            DISPLAY:
            var WRN12STR_12 = _world.AcknexObject.GetAcknexObject("WRN12STR");
            _world.SetSynonymObject("MESSAGE_TEXT", WRN12STR_12);
            {
                var enumerator = DISPLAYMESSAGE(MY, THERE);
                while (enumerator.MoveNext())
                {
        ...
        public IEnumerator OPENGY3(IAcknexObject MY, IAcknexObject THERE)
        {
            var UPDOWNDOOR_1 = _world.GetSynonymObject("UPDOWNDOOR");
            if (UPDOWNDOOR_1 != null)
            {
            ...
            var GYDOOR3WALL_2 = _world.AcknexObject.GetAcknexObject("GYDOOR3WALL");
            _world.SetSynonymObject("LOCKWALL", GYDOOR3WALL_2);
            var DMT18TEX_4 = _world.AcknexObject.GetAcknexObject("DMT18TEX");
            _world.SetSynonymObject("LOCKTEX", DMT18TEX_4);
            var GYDOOR3ARGN_6 = _world.AcknexObject.GetAcknexObject("GYDOOR3ARGN");
            _world.SetSynonymObject("UPDOWNDOOR", GYDOOR3ARGN_6);
            var CEILPOS_9 = _world.GetObject(ObjectType.Skill, "CEILPOS");
            CEILPOS_9.SetFloat("VAL", -83.5f);
            {
                var enumerator = OPENDOOR(MY, THERE);
                while (enumerator.MoveNext())
                {
        ...
        public IEnumerator OPENGY7(IAcknexObject MY, IAcknexObject THERE)
        {
            var UPDOWNDOOR_1 = _world.GetSynonymObject("UPDOWNDOOR");
            if (UPDOWNDOOR_1 != null)
            {
            ...
            var GYDOOR7WALL_2 = _world.AcknexObject.GetAcknexObject("GYDOOR7WALL");
            _world.SetSynonymObject("LOCKWALL", GYDOOR7WALL_2);
            var DMT18TEX_4 = _world.AcknexObject.GetAcknexObject("DMT18TEX");
            _world.SetSynonymObject("LOCKTEX", DMT18TEX_4);
            var GYDOOR7RGN_6 = _world.AcknexObject.GetAcknexObject("GYDOOR7RGN");
            _world.SetSynonymObject("UPDOWNDOOR", GYDOOR7RGN_6);
            var CEILPOS_9 = _world.GetObject(ObjectType.Skill, "CEILPOS");
            CEILPOS_9.SetFloat("VAL", 6.5f);
            {
                var enumerator = OPENDOOR(MY, THERE);
                while (enumerator.MoveNext())
                {
        ...
        public IEnumerator OPENGY8(IAcknexObject MY, IAcknexObject THERE)
        {
            var UPDOWNDOOR_1 = _world.GetSynonymObject("UPDOWNDOOR");
            if (UPDOWNDOOR_1 != null)
            {
            ...
            var GYDOOR8WALL_2 = _world.AcknexObject.GetAcknexObject("GYDOOR8WALL");
            _world.SetSynonymObject("LOCKWALL", GYDOOR8WALL_2);
            var DMT18TEX_4 = _world.AcknexObject.GetAcknexObject("DMT18TEX");
            _world.SetSynonymObject("LOCKTEX", DMT18TEX_4);
            var GYDOOR8RGN_6 = _world.AcknexObject.GetAcknexObject("GYDOOR8RGN");
            _world.SetSynonymObject("UPDOWNDOOR", GYDOOR8RGN_6);
            var CEILPOS_9 = _world.GetObject(ObjectType.Skill, "CEILPOS");
            CEILPOS_9.SetFloat("VAL", 6.5f);
            {
                var enumerator = OPENDOOR(MY, THERE);
        ...
        public IEnumerator OPENGY9(IAcknexObject MY, IAcknexObject THERE)
        {
            var UPDOWNDOOR_1 = _world.GetSynonymObject("UPDOWNDOOR");
            if (UPDOWNDOOR_1 != null)
            {
            ...
            var GYDOOR9WALL_2 = _world.AcknexObject.GetAcknexObject("GYDOOR9WALL");
            _world.SetSynonymObject("LOCKWALL", GYDOOR9WALL_2);
            var DMT18TEX_4 = _world.AcknexObject.GetAcknexObject("DMT18TEX");
            _world.SetSynonymObject("LOCKTEX", DMT18TEX_4);
            var GYDOOR9RGN_6 = _world.AcknexObject.GetAcknexObject("GYDOOR9RGN");
            _world.SetSynonymObject("UPDOWNDOOR", GYDOOR9RGN_6);
            var CEILPOS_9 = _world.GetObject(ObjectType.Skill, "CEILPOS");
            CEILPOS_9.SetFloat("VAL", 6.5f);
            {
                var enumerator = OPENDOOR(MY, THERE);
        ...
        public IEnumerator OPENGY10(IAcknexObject MY, IAcknexObject THERE)
        {
            var UPDOWNDOOR_1 = _world.GetSynonymObject("UPDOWNDOOR");
            if (UPDOWNDOOR_1 != null)
            {
            ...
            var GYDOOR10WALL_2 = _world.AcknexObject.GetAcknexObject("GYDOOR10WALL");
            _world.SetSynonymObject("LOCKWALL", GYDOOR10WALL_2);
            var DMT18TEX_4 = _world.AcknexObject.GetAcknexObject("DMT18TEX");
            _world.SetSynonymObject("LOCKTEX", DMT18TEX_4);
            var GYDOOR10RGN_6 = _world.AcknexObject.GetAcknexObject("GYDOOR10RGN");
            _world.SetSynonymObject("UPDOWNDOOR", GYDOOR10RGN_6);
            var CEILPOS_9 = _world.GetObject(ObjectType.Skill, "CEILPOS");
            CEILPOS_9.SetFloat("VAL", 6.5f);
            {
                var enumerator = OPENDOOR(MY, THERE);
        ...
        public IEnumerator ROTATION(IAcknexObject MY, IAcknexObject THERE)
        {
            var ILUMINATION_1 = _world.GetObject(ObjectType.Skill, "ILUMINATION");
            var ILUMINATION_1_val = ILUMINATION_1.GetFloat("VAL");
            if (ILUMINATION_1_val > 0.9f)
            {
                var LUP4_3 = _world.GetObject(ObjectType.Skill, "LUP4");
                LUP4_3.SetFloat("VAL", -0.05f);
            }
            var ILUMINATION_5 = _world.GetObject(ObjectType.Skill, "ILUMINATION");
            var ILUMINATION_5_val = ILUMINATION_5.GetFloat("VAL");
            if (ILUMINATION_5_val < 0.2f)
            {
                var LUP4_7 = _world.GetObject(ObjectType.Skill, "LUP4");
                LUP4_7.SetFloat("VAL", 0.05f);
            }
            var LUP4_9 = _world.GetObject(ObjectType.Skill, "LUP4");
            var LUP4_9_val = LUP4_9.GetFloat("VAL");
            if (LUP4_9_val == 0f)
            {
                var LUP4_11 = _world.GetObject(ObjectType.Skill, "LUP4");
                LUP4_11.SetFloat("VAL", 0.05f);
            }
            var LUP4_12 = _world.GetObject(ObjectType.Skill, "LUP4");
            var LUP4_12_val = LUP4_12.GetFloat("VAL");
            var ILUMINATION_13 = _world.GetObject(ObjectType.Skill, "ILUMINATION");
            var ILUMINATION_13_val = ILUMINATION_13.GetFloat("VAL");
            var ILUMINATION_14 = _world.GetObject(ObjectType.Skill, "ILUMINATION");
            ILUMINATION_14.SetFloat("VAL", ILUMINATION_13_val + LUP4_12_val);
            var ILUMINATION_15 = _world.GetObject(ObjectType.Skill, "ILUMINATION");
            var ILUMINATION_15_val = ILUMINATION_15.GetFloat("VAL");
            var CTHOLERGN_17 = _world.AcknexObject.GetAcknexObject("CTHOLERGN");
            CTHOLERGN_17.SetFloatAll("AMBIENT", ILUMINATION_15_val);
            var ILUMINATION_18 = _world.GetObject(ObjectType.Skill, "ILUMINATION");
            var ILUMINATION_18_val = ILUMINATION_18.GetFloat("VAL");
            var CTOUTCIRCLE1RGN_20 = _world.AcknexObject.GetAcknexObject("CTOUTCIRCLE1RGN");
            CTOUTCIRCLE1RGN_20.SetFloatAll("AMBIENT", ILUMINATION_18_val);
            var ILUMINATION_21 = _world.GetObject(ObjectType.Skill, "ILUMINATION");
            var ILUMINATION_21_val = ILUMINATION_21.GetFloat("VAL");
            var CTOUTCIRCLE2RGN_23 = _world.AcknexObject.GetAcknexObject("CTOUTCIRCLE2RGN");
            CTOUTCIRCLE2RGN_23.SetFloatAll("AMBIENT", ILUMINATION_21_val);
            var ILUMINATION_24 = _world.GetObject(ObjectType.Skill, "ILUMINATION");
            var ILUMINATION_24_val = ILUMINATION_24.GetFloat("VAL");
            var CTOUTCIRCLE3RGN_26 = _world.AcknexObject.GetAcknexObject("CTOUTCIRCLE3RGN");
            CTOUTCIRCLE3RGN_26.SetFloatAll("AMBIENT", ILUMINATION_24_val);
            var ILUMINATION_27 = _world.GetObject(ObjectType.Skill, "ILUMINATION");
            var ILUMINATION_27_val = ILUMINATION_27.GetFloat("VAL");
            var CTOUTCIRCLE4RGN_29 = _world.AcknexObject.GetAcknexObject("CTOUTCIRCLE4RGN");
            CTOUTCIRCLE4RGN_29.SetFloatAll("AMBIENT", ILUMINATION_27_val);
            var ILUMINATION_30 = _world.GetObject(ObjectType.Skill, "ILUMINATION");
            var ILUMINATION_30_val = ILUMINATION_30.GetFloat("VAL");
            var CTRAMPACESSRGN_32 = _world.AcknexObject.GetAcknexObject("CTRAMPACESSRGN");
            CTRAMPACESSRGN_32.SetFloatAll("AMBIENT", ILUMINATION_30_val);
            var ILUMINATION_33 = _world.GetObject(ObjectType.Skill, "ILUMINATION");
            var ILUMINATION_33_val = ILUMINATION_33.GetFloat("VAL");
            var CTRAMPRGN_35 = _world.AcknexObject.GetAcknexObject("CTRAMPRGN");
            CTRAMPRGN_35.SetFloatAll("AMBIENT", ILUMINATION_33_val);
            var ILUMINATION_36 = _world.GetObject(ObjectType.Skill, "ILUMINATION");
            var ILUMINATION_36_val = ILUMINATION_36.GetFloat("VAL");
            var RTALETA1RGN_38 = _world.AcknexObject.GetAcknexObject("RTALETA1RGN");
            RTALETA1RGN_38.SetFloatAll("AMBIENT", ILUMINATION_36_val);
            var ILUMINATION_39 = _world.GetObject(ObjectType.Skill, "ILUMINATION");
            var ILUMINATION_39_val = ILUMINATION_39.GetFloat("VAL");
            var RTALETA2RGN_41 = _world.AcknexObject.GetAcknexObject("RTALETA2RGN");
            RTALETA2RGN_41.SetFloatAll("AMBIENT", ILUMINATION_39_val);
            var ILUMINATION_42 = _world.GetObject(ObjectType.Skill, "ILUMINATION");
            var ILUMINATION_42_val = ILUMINATION_42.GetFloat("VAL");
            var RTALETA3RGN_44 = _world.AcknexObject.GetAcknexObject("RTALETA3RGN");
            RTALETA3RGN_44.SetFloatAll("AMBIENT", ILUMINATION_42_val);
            var ILUMINATION_45 = _world.GetObject(ObjectType.Skill, "ILUMINATION");
            var ILUMINATION_45_val = ILUMINATION_45.GetFloat("VAL");
            var RTALETA4RGN_47 = _world.AcknexObject.GetAcknexObject("RTALETA4RGN");
            RTALETA4RGN_47.SetFloatAll("AMBIENT", ILUMINATION_45_val);
            var CTHOLERGN_50 = _world.AcknexObject.GetAcknexObject("CTHOLERGN");
            var temp_51 = CTHOLERGN_50.GetFloat("VISIBLE");
            if (temp_51 == 1f)
            {
                goto ROTATE;
            }
            var CTOUTCIRCLE1RGN_54 = _world.AcknexObject.GetAcknexObject("CTOUTCIRCLE1RGN");
            var temp_55 = CTOUTCIRCLE1RGN_54.GetFloat("VISIBLE");
            if (temp_55 == 1f)
            {
                goto ROTATE;
            }
            var CTOUTCIRCLE2RGN_58 = _world.AcknexObject.GetAcknexObject("CTOUTCIRCLE2RGN");
            var temp_59 = CTOUTCIRCLE2RGN_58.GetFloat("VISIBLE");
            if (temp_59 == 1f)
            {
                goto ROTATE;
            }
            var CTOUTCIRCLE3RGN_62 = _world.AcknexObject.GetAcknexObject("CTOUTCIRCLE3RGN");
            var temp_63 = CTOUTCIRCLE3RGN_62.GetFloat("VISIBLE");
            if (temp_63 == 1f)
            {
                goto ROTATE;
            }
            var CTOUTCIRCLE4RGN_66 = _world.AcknexObject.GetAcknexObject("CTOUTCIRCLE4RGN");
            var temp_67 = CTOUTCIRCLE4RGN_66.GetFloat("VISIBLE");
            if (temp_67 == 1f)
            {
                goto ROTATE;
            }
            //yield break;
            ROTATE:
            var RTALETA1RGN_68 = _world.AcknexObject.GetAcknexObject("RTALETA1RGN");
            _world.Rotate(RTALETA1RGN_68, 0.01f);
            var RTALETA1RGN_72 = _world.AcknexObject.GetAcknexObject("RTALETA1RGN");
            //Unknown Property Type: Region.FLOOR_ANGLE
            var RTALETA1RGN_75 = _world.AcknexObject.GetAcknexObject("RTALETA1RGN");
            //Unknown Property Type: Region.FLOOR_ANGLE
            var RTALETA2RGN_76 = _world.AcknexObject.GetAcknexObject("RTALETA2RGN");
            _world.Rotate(RTALETA2RGN_76, 0.01f);
            var RTALETA2RGN_80 = _world.AcknexObject.GetAcknexObject("RTALETA2RGN");
            //Unknown Property Type: Region.FLOOR_ANGLE
            var RTALETA2RGN_83 = _world.AcknexObject.GetAcknexObject("RTALETA2RGN");
            //Unknown Property Type: Region.FLOOR_ANGLE
            var RTALETA2RGN_86 = _world.AcknexObject.GetAcknexObject("RTALETA2RGN");
            //Unknown Property Type: Region.CEIL_ANGLE
            var RTALETA2RGN_89 = _world.AcknexObject.GetAcknexObject("RTALETA2RGN");
            //Unknown Property Type: Region.CEIL_ANGLE
            var RTALETA3RGN_90 = _world.AcknexObject.GetAcknexObject("RTALETA3RGN");
            _world.Rotate(RTALETA3RGN_90, 0.01f);
            var RTALETA3RGN_94 = _world.AcknexObject.GetAcknexObject("RTALETA3RGN");
            //Unknown Property Type: Region.FLOOR_ANGLE
            var RTALETA3RGN_97 = _world.AcknexObject.GetAcknexObject("RTALETA3RGN");
            //Unknown Property Type: Region.FLOOR_ANGLE
            var RTALETA3RGN_100 = _world.AcknexObject.GetAcknexObject("RTALETA3RGN");
            //Unknown Property Type: Region.CEIL_ANGLE
            var RTALETA3RGN_103 = _world.AcknexObject.GetAcknexObject("RTALETA3RGN");
            //Unknown Property Type: Region.CEIL_ANGLE
            var RTALETA4RGN_104 = _world.AcknexObject.GetAcknexObject("RTALETA4RGN");
            _world.Rotate(RTALETA4RGN_104, 0.01f);
            var RTALETA4RGN_108 = _world.AcknexObject.GetAcknexObject("RTALETA4RGN");
            //Unknown Property Type: Region.FLOOR_ANGLE
            var RTALETA4RGN_111 = _world.AcknexObject.GetAcknexObject("RTALETA4RGN");
            //Unknown Property Type: Region.FLOOR_ANGLE
            var RTALETA4RGN_114 = _world.AcknexObject.GetAcknexObject("RTALETA4RGN");
            //Unknown Property Type: Region.CEIL_ANGLE
            var RTALETA4RGN_117 = _world.AcknexObject.GetAcknexObject("RTALETA4RGN");
            //Unknown Property Type: Region.CEIL_ANGLE
            //Unknown keyword: 
            yield break;
        }
        public IEnumerator PICKKEY1(IAcknexObject MY, IAcknexObject THERE)
        {
            ...
            var GET14STR_7 = _world.AcknexObject.GetAcknexObject("GET14STR");
            _world.SetSynonymObject("MESSAGE_TEXT", GET14STR_7);
            {
                var enumerator = DISPLAYMESSAGE(MY, THERE);
                while (enumerator.MoveNext())
                {
        ...
        public IEnumerator PICKKEY2(IAcknexObject MY, IAcknexObject THERE)
        {
            ...
            var GET12STR_7 = _world.AcknexObject.GetAcknexObject("GET12STR");
            _world.SetSynonymObject("MESSAGE_TEXT", GET12STR_7);
            {
                var enumerator = DISPLAYMESSAGE(MY, THERE);
                while (enumerator.MoveNext())
                {
        ...
        public IEnumerator PICKKEY3(IAcknexObject MY, IAcknexObject THERE)
        {
            ...
            var GET15STR_7 = _world.AcknexObject.GetAcknexObject("GET15STR");
            _world.SetSynonymObject("MESSAGE_TEXT", GET15STR_7);
            {
                var enumerator = DISPLAYMESSAGE(MY, THERE);
                while (enumerator.MoveNext())
                {
        ...
        public IEnumerator PICKKEY4(IAcknexObject MY, IAcknexObject THERE)
        {
            var MY_2 = MY;
            MY_2.SetFloat("INVISIBLE", 1f);
            var TICKETSND_3 = _world.AcknexObject.GetAcknexObject("TICKETSND");
            _world.PlaySound(TICKETSND_3, 0.5f);
            var KEY4_6 = _world.GetObject(ObjectType.Skill, "KEY4");
            KEY4_6.SetFloat("VAL", 1f);
            var GET13STR_7 = _world.AcknexObject.GetAcknexObject("GET13STR");
            _world.SetSynonymObject("MESSAGE_TEXT", GET13STR_7);
            {
                var enumerator = DISPLAYMESSAGE(MY, THERE);
                while (enumerator.MoveNext())
                {
        ...
        public IEnumerator GRAYTURN(IAcknexObject MY, IAcknexObject THERE)
        {
            var WAITTIME_0 = _world.GetObject(ObjectType.Skill, "WAITTIME");
            var WAITTIME_1 = _world.GetObject(ObjectType.Skill, "WAITTIME");
            var WAITTIME_1_val = WAITTIME_1.GetFloat("VAL");
            ...
            if (UnityEngine.Random.value > 0.95f)
            {
                var RIGHTTURNGRAY_9 = _world.GetObject(ObjectType.Skill, "RIGHTTURNGRAY");
                var RIGHTTURNGRAY_10 = _world.GetObject(ObjectType.Skill, "RIGHTTURNGRAY");
                var RIGHTTURNGRAY_10_val = RIGHTTURNGRAY_10.GetFloat("VAL");
                var RIGHTTURNGRAY_12 = _world.GetObject(ObjectType.Skill, "RIGHTTURNGRAY");
                var RIGHTTURNGRAY_12_val = RIGHTTURNGRAY_12.GetFloat("VAL");
                var RIGHTTURNGRAY_18 = _world.GetObject(ObjectType.Skill, "RIGHTTURNGRAY");
                var RIGHTTURNGRAY_18_val = RIGHTTURNGRAY_18.GetFloat("VAL");
                RIGHTTURNGRAY_9.SetFloat("VAL", (RIGHTTURNGRAY_12_val - 1f) * (RIGHTTURNGRAY_18_val - 1f));
            }
            var RIGHTTURNGRAY_22 = _world.GetObject(ObjectType.Skill, "RIGHTTURNGRAY");
            var RIGHTTURNGRAY_22_val = RIGHTTURNGRAY_22.GetFloat("VAL");
            if (RIGHTTURNGRAY_22_val > RIGHTTURNGRAY_22.GetFloat("MAX"))
            {
                {
                    var enumerator = TURNRIGHT(MY, THERE);
                    while (enumerator.MoveNext())
        ...
        public IEnumerator GRAYBACKOFF(IAcknexObject MY, IAcknexObject THERE)
        {
            var MY_2 = MY;
            MY_2.SetAcknexObject("EACH_TICK", null);
            var MY_5 = MY;
            ...
            var MY_8 = MY;
            MY_8.SetAcknexObject("IF_FAR", null);
            var CYCLEGRAYBACKOFF_9 = _world.AcknexObject.GetAcknexObject("CYCLEGRAYBACKOFF");
            var MY_11 = MY;
            MY_11.SetAcknexObject("EACH_CYCLE", CYCLEGRAYBACKOFF_9);
            var GRAYHIT_12 = _world.AcknexObject.GetAcknexObject("GRAYHIT");
            var MY_14 = MY;
            MY_14.SetAcknexObject("IF_HIT", GRAYHIT_12);
            {
                var enumerator = LOCATEACTOR(MY, THERE);
                while (enumerator.MoveNext())
                {
            ...
            var GRAY1TEX_18 = _world.AcknexObject.GetAcknexObject("GRAY1TEX");
            var MY_20 = MY;
            MY_20.SetAcknexObject("TEXTURE", GRAY1TEX_18);
            var MY_23 = MY;
            MY_23.SetFloat("SPEED", 0.3f);
            var MY_26 = MY;
            MY_26.SetFloat("CAREFULLY", 1f);
            var BULLET_27 = _world.AcknexObject.GetAcknexObject("BULLET");
            var MY_29 = MY;
            MY_29.SetAcknexObject("TARGET", BULLET_27);
            {
            ...
            {
                var enumerator = GRAYWANDER(MY, THERE);
                while (enumerator.MoveNext())
                {
                    var current = enumerator.Current;
                    if (current != null)
        ...
        public IEnumerator GRAYWAIT(IAcknexObject MY, IAcknexObject THERE)
        {
            var MY_2 = MY;
            MY_2.SetAcknexObject("EACH_TICK", null);
            var MY_5 = MY;
            ...
            var MY_8 = MY;
            MY_8.SetAcknexObject("IF_FAR", null);
            var CYCLEGRAYATTACK_9 = _world.AcknexObject.GetAcknexObject("CYCLEGRAYATTACK");
            var MY_11 = MY;
            MY_11.SetAcknexObject("EACH_CYCLE", CYCLEGRAYATTACK_9);
            var GRAYHIT_12 = _world.AcknexObject.GetAcknexObject("GRAYHIT");
            var MY_14 = MY;
            MY_14.SetAcknexObject("IF_HIT", GRAYHIT_12);
            var MY_17 = MY;
            ...
            MY_23.SetFloat("HEIGHT", -0.05f);
            var MY_26 = MY;
            MY_26.SetFloat("SKILL4", 0f);
            var GRAY0TEX_27 = _world.AcknexObject.GetAcknexObject("GRAY0TEX");
            var MY_29 = MY;
            MY_29.SetAcknexObject("TEXTURE", GRAY0TEX_27);
            var MY_32 = MY;
            MY_32.SetFloat("SPEED", 0f);
            var MY_35 = MY;
            MY_35.SetAcknexObject("TARGET", null);
        ...
        public IEnumerator GRAYSLEEP(IAcknexObject MY, IAcknexObject THERE)
        {
            var MY_2 = MY;
            MY_2.SetAcknexObject("EACH_TICK", null);
            var MY_5 = MY;
            ...
            MY_14.SetFloat("CAREFULLY", 0f);
            var MY_17 = MY;
            MY_17.SetFloat("SKILL4", 0f);
            var GRAY0BTEX_18 = _world.AcknexObject.GetAcknexObject("GRAY0BTEX");
            var MY_20 = MY;
            MY_20.SetAcknexObject("TEXTURE", GRAY0BTEX_18);
            var MY_23 = MY;
            MY_23.SetFloat("SPEED", 0f);
            var MY_26 = MY;
            MY_26.SetAcknexObject("TARGET", null);
            ...
            var GRAYHIT_28 = _world.AcknexObject.GetAcknexObject("GRAYHIT");
            var MY_30 = MY;
            MY_30.SetAcknexObject("EACH_CYCLE", GRAYHIT_28);
            var MY_33 = MY;
            MY_33.SetFloat("FRAGILE", 1f);
            var MY_36 = MY;
            MY_36.SetFloat("SKILL1", 0f);
            var MY_39 = MY;
            var temp_40 = MY_39.GetFloat("FLAG3");
            if (temp_40 == 1f)
            {
                {
                    var enumerator = GRAYWAIT(MY, THERE);
                    while (enumerator.MoveNext())
                    {
                        var current = enumerator.Current;
                        if (current != null)
            ...
            {
                var enumerator = GRAYFOLLOWATTACK(MY, THERE);
                while (enumerator.MoveNext())
                {
                    var current = enumerator.Current;
                    if (current != null)
        ...
        public IEnumerator GRAYWANDER(IAcknexObject MY, IAcknexObject THERE)
        {
            var MY_2 = MY;
            MY_2.SetAcknexObject("EACH_TICK", null);
            var MY_5 = MY;
            ...
            var MY_20 = MY;
            MY_20.SetFloat("SKILL4", 1f);
            var GRAY1TEX_21 = _world.AcknexObject.GetAcknexObject("GRAY1TEX");
            var MY_23 = MY;
            MY_23.SetAcknexObject("TEXTURE", GRAY1TEX_21);
            var MY_26 = MY;
            MY_26.SetFloat("SPEED", 0.3f);
            var BULLET_27 = _world.AcknexObject.GetAcknexObject("BULLET");
            var MY_29 = MY;
        ...
        public IEnumerator GRAYHIDE(IAcknexObject MY, IAcknexObject THERE)
        {
            var MY_2 = MY;
            MY_2.SetAcknexObject("EACH_TICK", null);
            var GRAYESCAPE_3 = _world.AcknexObject.GetAcknexObject("GRAYESCAPE");
            var MY_5 = MY;
            MY_5.SetAcknexObject("IF_NEAR", GRAYESCAPE_3);
            var MY_8 = MY;
            MY_8.SetAcknexObject("IF_FAR", null);
            var CYCLEGRAYHIDE_9 = _world.AcknexObject.GetAcknexObject("CYCLEGRAYHIDE");
            var MY_11 = MY;
            MY_11.SetAcknexObject("EACH_CYCLE", CYCLEGRAYHIDE_9);
            var GRAYHIT_12 = _world.AcknexObject.GetAcknexObject("GRAYHIT");
            var MY_14 = MY;
            MY_14.SetAcknexObject("IF_HIT", GRAYHIT_12);
            var MY_17 = MY;
            ...
            MY_25.SetFloat("ANGLE", temp_31 + (UnityEngine.Random.value - 0.5f) * 2.4f);
            var GRAY1TEX_40 = _world.AcknexObject.GetAcknexObject("GRAY1TEX");
            var MY_42 = MY;
            MY_42.SetAcknexObject("TEXTURE", GRAY1TEX_40);
            var MY_45 = MY;
            MY_45.SetFloat("DIST", 20f);
            var MY_48 = MY;
            MY_48.SetFloat("SPEED", 0.6f);
            {
                var startTime = Time.time;
                var endTime = startTime + TimeUtils.FramesToTime((int)320f);
                while (Time.time < endTime)
            ...
            var MY_52 = MY;
            var temp_53 = MY_52.GetFloat("SKILL4");
            if (temp_53 == 0f)
            {
                yield break;
            }
            var MY_56 = MY;
            var temp_57 = MY_56.GetFloat("FLAG3");
            if (temp_57 == 1f)
            {
                {
                    var enumerator = GRAYWAIT(MY, THERE);
        ...
        public IEnumerator GRAYWARNING(IAcknexObject MY, IAcknexObject THERE)
        {
            var MY_2 = MY;
            MY_2.SetAcknexObject("IF_NEAR", null);
            var MY_5 = MY;
            MY_5.SetAcknexObject("IF_FAR", null);
            var CYCLEGRAYWARNING_6 = _world.AcknexObject.GetAcknexObject("CYCLEGRAYWARNING");
            var MY_8 = MY;
            MY_8.SetAcknexObject("EACH_CYCLE", CYCLEGRAYWARNING_6);
            var GRAYHIT_9 = _world.AcknexObject.GetAcknexObject("GRAYHIT");
            var MY_11 = MY;
            MY_11.SetAcknexObject("IF_HIT", GRAYHIT_9);
            var MY_14 = MY;
            MY_14.SetFloat("CAREFULLY", 0f);
            var MY_17 = MY;
            MY_17.SetFloat("SKILL4", 7f);
            var GRAY7TEX_18 = _world.AcknexObject.GetAcknexObject("GRAY7TEX");
            var MY_20 = MY;
            MY_20.SetAcknexObject("TEXTURE", GRAY7TEX_18);
            var MY_23 = MY;
            MY_23.SetFloat("SPEED", 0f);
            ...
            var GRAY03SND_30 = _world.AcknexObject.GetAcknexObject("GRAY03SND");
            var GRAY7TEX_32 = _world.AcknexObject.GetAcknexObject("GRAY7TEX");
            GRAY7TEX_32.SetAcknexObject("SOUND", GRAY03SND_30);
            goto CONT;
            NOHOPE:
            var GRAY02SND_33 = _world.AcknexObject.GetAcknexObject("GRAY02SND");
            var GRAY7TEX_35 = _world.AcknexObject.GetAcknexObject("GRAY7TEX");
            GRAY7TEX_35.SetAcknexObject("SOUND", GRAY02SND_33);
            goto CONT;
            NOWAYOUT:
            var GRAY08SND_36 = _world.AcknexObject.GetAcknexObject("GRAY08SND");
            var GRAY7TEX_38 = _world.AcknexObject.GetAcknexObject("GRAY7TEX");
            GRAY7TEX_38.SetAcknexObject("SOUND", GRAY08SND_36);
            goto CONT;
            COME:
            var GRAY01SND_39 = _world.AcknexObject.GetAcknexObject("GRAY01SND");
            var GRAY7TEX_41 = _world.AcknexObject.GetAcknexObject("GRAY7TEX");
            GRAY7TEX_41.SetAcknexObject("SOUND", GRAY01SND_39);
            CONT:
            {
                var startTime = Time.time;
                var endTime = startTime + TimeUtils.FramesToTime((int)32f);
            ...
            {
                var enumerator = GRAYBACKOFF(MY, THERE);
                while (enumerator.MoveNext())
                {
                    var current = enumerator.Current;
                    if (current != null)
        ...
        public IEnumerator GRAYLOOKFOR(IAcknexObject MY, IAcknexObject THERE)
        {
            var MY_2 = MY;
            var temp_3 = MY_2.GetFloat("SKILL4");
            if (temp_3 == 10f)
            ...
            var MY_25 = MY;
            MY_25.SetAcknexObject("IF_FAR", null);
            var GRAYWANDER_26 = _world.AcknexObject.GetAcknexObject("GRAYWANDER");
            var MY_28 = MY;
            MY_28.SetAcknexObject("EACH_CYCLE", GRAYWANDER_26);
            var GRAYHIT_29 = _world.AcknexObject.GetAcknexObject("GRAYHIT");
            var MY_31 = MY;
            MY_31.SetAcknexObject("IF_HIT", GRAYHIT_29);
            var MY_34 = MY;
            MY_34.SetFloat("CAREFULLY", 0f);
            var MY_37 = MY;
            var temp_38 = MY_37.GetFloat("DISTANCE");
            if (temp_38 < 40f)
            {
                var GRAYFOLLOWATTACK_39 = _world.AcknexObject.GetAcknexObject("GRAYFOLLOWATTACK");
                var MY_41 = MY;
                MY_41.SetAcknexObject("EACH_CYCLE", GRAYFOLLOWATTACK_39);
            }
            var MY_44 = MY;
            MY_44.SetFloat("SKILL4", 10f);
            var GRAY0TEX_45 = _world.AcknexObject.GetAcknexObject("GRAY0TEX");
            var MY_47 = MY;
            MY_47.SetAcknexObject("TEXTURE", GRAY0TEX_45);
            var MY_50 = MY;
            MY_50.SetFloat("SPEED", 0f);
            var BULLET_51 = _world.AcknexObject.GetAcknexObject("BULLET");
            var MY_53 = MY;
            MY_53.SetAcknexObject("TARGET", BULLET_51);
            {
                var enumerator = GRAYTAUNT(MY, THERE);
                while (enumerator.MoveNext())
                {
                    var current = enumerator.Current;
                    if (current != null)
        ...
        public IEnumerator GRAYFOLLOWATTACK(IAcknexObject MY, IAcknexObject THERE)
        {
            var MY_2 = MY;
            MY_2.SetAcknexObject("IF_NEAR", null);
            var MY_5 = MY;
            MY_5.SetAcknexObject("IF_FAR", null);
            var CYCLEGRAYSHOOT_6 = _world.AcknexObject.GetAcknexObject("CYCLEGRAYSHOOT");
            var MY_8 = MY;
            MY_8.SetAcknexObject("EACH_CYCLE", CYCLEGRAYSHOOT_6);
            var GRAYHIT_9 = _world.AcknexObject.GetAcknexObject("GRAYHIT");
            var MY_11 = MY;
            MY_11.SetAcknexObject("IF_HIT", GRAYHIT_9);
            var MY_14 = MY;
        ...
        public IEnumerator GRAYFOLLOWWARNING(IAcknexObject MY, IAcknexObject THERE)
        {
            var MY_2 = MY;
            MY_2.SetAcknexObject("IF_NEAR", null);
            var MY_5 = MY;
        ...
        public IEnumerator GRAYTAUNT(IAcknexObject MY, IAcknexObject THERE)
        {
            if (UnityEngine.Random.value < 0.25f)
            {
                goto COME;
            ...
            var GRAY03SND_4 = _world.AcknexObject.GetAcknexObject("GRAY03SND");
            var MY_6 = MY;
            _world.PlaySound(GRAY03SND_4, 0.5f, MY_6);
            yield break;
            COME:
            var GRAY01SND_7 = _world.AcknexObject.GetAcknexObject("GRAY01SND");
            var MY_9 = MY;
            _world.PlaySound(GRAY01SND_7, 0.5f, MY_9);
            yield break;
            NOHOPE:
            var GRAY02SND_10 = _world.AcknexObject.GetAcknexObject("GRAY02SND");
            var MY_12 = MY;
            _world.PlaySound(GRAY02SND_10, 0.5f, MY_12);
            //Unknown keyword: 
            yield break;
        }
        public IEnumerator GRAYTAUNTSHOOT(IAcknexObject MY, IAcknexObject THERE)
        {
            if (UnityEngine.Random.value < 0.25f)
            {
                goto DIEWORM;
            ...
            var GRAY06SND_6 = _world.AcknexObject.GetAcknexObject("GRAY06SND");
            var MY_8 = MY;
            _world.PlaySound(GRAY06SND_6, 0.5f, MY_8);
            yield break;
            NOWAYOUT:
            var GRAY08SND_9 = _world.AcknexObject.GetAcknexObject("GRAY08SND");
            var MY_11 = MY;
            _world.PlaySound(GRAY08SND_9, 0.5f, MY_11);
            yield break;
            SHOUT:
            var GRAY04SND_12 = _world.AcknexObject.GetAcknexObject("GRAY04SND");
            var MY_14 = MY;
            _world.PlaySound(GRAY04SND_12, 0.5f, MY_14);
            yield break;
            DIEWORM:
            var GRAY05SND_15 = _world.AcknexObject.GetAcknexObject("GRAY05SND");
            var MY_17 = MY;
            _world.PlaySound(GRAY05SND_15, 0.5f, MY_17);
            //Unknown keyword: 
            yield break;
        }
        public IEnumerator GRAYAIM(IAcknexObject MY, IAcknexObject THERE)
        {
            var MY_2 = MY;
            MY_2.SetAcknexObject("IF_NEAR", null);
            var MY_5 = MY;
            MY_5.SetAcknexObject("IF_FAR", null);
            var GRAYSHOOT_6 = _world.AcknexObject.GetAcknexObject("GRAYSHOOT");
            var MY_8 = MY;
            MY_8.SetAcknexObject("EACH_CYCLE", GRAYSHOOT_6);
            var GRAYHIT_9 = _world.AcknexObject.GetAcknexObject("GRAYHIT");
            var MY_11 = MY;
            MY_11.SetAcknexObject("IF_HIT", GRAYHIT_9);
            var MY_14 = MY;
            ...
            var GRAY3TEX_18 = _world.AcknexObject.GetAcknexObject("GRAY3TEX");
            var MY_20 = MY;
            MY_20.SetAcknexObject("TEXTURE", GRAY3TEX_18);
            var MY_23 = MY;
            MY_23.SetFloat("SPEED", 0f);
            ...
            {
                var enumerator = GRAYTAUNTSHOOT(MY, THERE);
                while (enumerator.MoveNext())
                {
                    var current = enumerator.Current;
                    if (current != null)
        ...
        public IEnumerator GRAYSHOOT(IAcknexObject MY, IAcknexObject THERE)
        {
            var MY_2 = MY;
            MY_2.SetAcknexObject("IF_NEAR", null);
            var MY_5 = MY;
            MY_5.SetAcknexObject("IF_FAR", null);
            var GRAYWANDER_6 = _world.AcknexObject.GetAcknexObject("GRAYWANDER");
            var MY_8 = MY;
            MY_8.SetAcknexObject("EACH_CYCLE", GRAYWANDER_6);
            var GRAYHIT_9 = _world.AcknexObject.GetAcknexObject("GRAYHIT");
            var MY_11 = MY;
            MY_11.SetAcknexObject("IF_HIT", GRAYHIT_9);
            var MY_14 = MY;
            MY_14.SetFloat("CAREFULLY", 0f);
            var MY_17 = MY;
            var temp_18 = MY_17.GetFloat("FLAG3");
            if (temp_18 == 1f)
            {
                yield break;
            }
            ...
            var PARTICLE_20 = _world.GetSynonymObject("PARTICLE");
            if (PARTICLE_20 == null)
            {
                yield break;
            }
            var MY_23 = MY;
            MY_23.SetFloat("SKILL4", 3f);
            var GRAY3ATEX_24 = _world.AcknexObject.GetAcknexObject("GRAY3ATEX");
            var MY_26 = MY;
            MY_26.SetAcknexObject("TEXTURE", GRAY3ATEX_24);
            var MY_29 = MY;
            MY_29.SetFloat("SPEED", 0f);
            var FOLLOW_30 = _world.AcknexObject.GetAcknexObject("FOLLOW");
            var MY_32 = MY;
            MY_32.SetAcknexObject("TARGET", FOLLOW_30);
            {
                var enumerator = LOOKPLAYER(MY, THERE);
                while (enumerator.MoveNext())
                {
            ...
            var MY_35 = MY;
            var temp_36 = MY_35.GetFloat("FLAG1");
            if (temp_36 == 0f)
            {
                goto MISS;
            }
            var PARTICLE_39 = _world.GetSynonymObject("PARTICLE");
            PARTICLE_39.SetFloat("GROUND", 1f);
            var PARTICLE_42 = _world.GetSynonymObject("PARTICLE");
            PARTICLE_42.SetFloat("SPEED", 1.5f);
            var PARTICLE_45 = _world.GetSynonymObject("PARTICLE");
            PARTICLE_45.SetFloat("VSPEED", 0.1f);
            var MY_47 = MY;
            var temp_48 = MY_47.GetFloat("X");
            var PARTICLE_50 = _world.GetSynonymObject("PARTICLE");
            PARTICLE_50.SetFloat("X", temp_48);
            var MY_52 = MY;
            var temp_53 = MY_52.GetFloat("Y");
            var PARTICLE_55 = _world.GetSynonymObject("PARTICLE");
            PARTICLE_55.SetFloat("Y", temp_53);
            var PARTICLE_57 = _world.GetSynonymObject("PARTICLE");
            var PARTICLE_59 = _world.GetSynonymObject("PARTICLE");
            var temp_60 = PARTICLE_59.GetFloat("HEIGHT");
            var MY_62 = MY;
            var temp_63 = MY_62.GetFloat("FLOOR_HGT");
            PARTICLE_57.SetFloat("HEIGHT", temp_63 + 2f);
            var PRTCTEX_66 = _world.AcknexObject.GetAcknexObject("PRTCTEX");
            var PARTICLE_68 = _world.GetSynonymObject("PARTICLE");
            PARTICLE_68.SetAcknexObject("TEXTURE", PRTCTEX_66);
            var TIMEOUTPARTICLE_69 = _world.AcknexObject.GetAcknexObject("TIMEOUTPARTICLE");
            var PARTICLE_71 = _world.GetSynonymObject("PARTICLE");
            PARTICLE_71.SetAcknexObject("EACH_CYCLE", TIMEOUTPARTICLE_69);
            var LOCATEPLAYERPARTICLE_72 = _world.AcknexObject.GetAcknexObject("LOCATEPLAYERPARTICLE");
            var PARTICLE_74 = _world.GetSynonymObject("PARTICLE");
            PARTICLE_74.SetAcknexObject("EACH_TICK", LOCATEPLAYERPARTICLE_72);
            var PARTICLE_77 = _world.GetSynonymObject("PARTICLE");
            PARTICLE_77.SetFloat("INVISIBLE", 0f);
            var FOLLOW_78 = _world.AcknexObject.GetAcknexObject("FOLLOW");
            var PARTICLE_80 = _world.GetSynonymObject("PARTICLE");
            PARTICLE_80.SetAcknexObject("TARGET", FOLLOW_78);
            var PARTICLE_83 = _world.GetSynonymObject("PARTICLE");
            PARTICLE_83.SetFloat("PASSABLE", 1f);
            //Unknown keyword: LOCATE
            yield break;
            MISS:
            {
        ...
        public IEnumerator GRAYESCAPE(IAcknexObject MY, IAcknexObject THERE)
        {
            var MY_2 = MY;
            MY_2.SetAcknexObject("IF_NEAR", null);
            var GRAYHIDE_3 = _world.AcknexObject.GetAcknexObject("GRAYHIDE");
            var MY_5 = MY;
            MY_5.SetAcknexObject("IF_FAR", GRAYHIDE_3);
            var CYCLEGRAYHIDE_6 = _world.AcknexObject.GetAcknexObject("CYCLEGRAYHIDE");
            var MY_8 = MY;
            MY_8.SetAcknexObject("EACH_CYCLE", CYCLEGRAYHIDE_6);
            var GRAYHIT_9 = _world.AcknexObject.GetAcknexObject("GRAYHIT");
            var MY_11 = MY;
            MY_11.SetAcknexObject("IF_HIT", GRAYHIT_9);
            var MY_14 = MY;
        ...
        public IEnumerator GRAYIMPLODE(IAcknexObject MY, IAcknexObject THERE)
        {
            var DISTX_0 = _world.GetObject(ObjectType.Skill, "DISTX");
            var DISTX_1 = _world.GetObject(ObjectType.Skill, "DISTX");
            var DISTX_1_val = DISTX_1.GetFloat("VAL");
            ...
            var MY_68 = MY;
            MY_68.SetAcknexObject("IF_HIT", null);
            var GRAYSLEEP_69 = _world.AcknexObject.GetAcknexObject("GRAYSLEEP");
            var MY_71 = MY;
            MY_71.SetAcknexObject("EACH_CYCLE", GRAYSLEEP_69);
            var MY_74 = MY;
            MY_74.SetFloat("SKILL4", 8f);
            var GRAY0ATEX_75 = _world.AcknexObject.GetAcknexObject("GRAY0ATEX");
            var MY_77 = MY;
            MY_77.SetAcknexObject("TEXTURE", GRAY0ATEX_75);
            var MY_80 = MY;
            MY_80.SetFloat("SPEED", 0f);
            var MY_83 = MY;
            MY_83.SetAcknexObject("TARGET", null);
        ...
        public IEnumerator GRAYHIT(IAcknexObject MY, IAcknexObject THERE)
        {
            var SHOOT_FAC_1 = _world.GetObject(ObjectType.Skill, "SHOOT_FAC");
            var SHOOT_FAC_1_val = SHOOT_FAC_1.GetFloat("VAL");
            if (SHOOT_FAC_1_val == 0f)
            ...
            {
                {
                    var enumerator = GRAYIMPLODE(MY, THERE);
                    while (enumerator.MoveNext())
                    {
                        var current = enumerator.Current;
                        if (current != null)
            ...
            {
                var enumerator = GRAYHIDE(MY, THERE);
                while (enumerator.MoveNext())
                {
                    var current = enumerator.Current;
                    if (current != null)
            ...
            CONT:
            var SHOOT_FAC_14 = _world.GetObject(ObjectType.Skill, "SHOOT_FAC");
            var SHOOT_FAC_14_val = SHOOT_FAC_14.GetFloat("VAL");
            var MY_16 = MY;
            var temp_17 = MY_16.GetFloat("SKILL1");
            var MY_19 = MY;
            MY_19.SetFloat("SKILL1", temp_17 + SHOOT_FAC_14_val);
            var MY_22 = MY;
            ...
            var MY_27 = MY;
            var temp_28 = MY_27?.GetAcknexObject("TEXTURE");
            _world.SetSynonymObject("GRAY_TEX", temp_28);
            var GRAY5TEX_30 = _world.AcknexObject.GetAcknexObject("GRAY5TEX");
            var MY_32 = MY;
            MY_32.SetAcknexObject("TEXTURE", GRAY5TEX_30);
            var MY_35 = MY;
            MY_35.SetAcknexObject("IF_NEAR", null);
            var MY_38 = MY;
            MY_38.SetAcknexObject("IF_FAR", null);
            var MY_41 = MY;
            MY_41.SetAcknexObject("IF_HIT", null);
            {
                var startTime = Time.time;
                var endTime = startTime + TimeUtils.FramesToTime((int)8f);
                while (Time.time < endTime)
            ...
            var GRAYESCAPE_43 = _world.AcknexObject.GetAcknexObject("GRAYESCAPE");
            var MY_45 = MY;
            MY_45.SetAcknexObject("IF_NEAR", GRAYESCAPE_43);
            var GRAYHIDE_46 = _world.AcknexObject.GetAcknexObject("GRAYHIDE");
            var MY_48 = MY;
            MY_48.SetAcknexObject("IF_FAR", GRAYHIDE_46);
            var GRAYHIT_49 = _world.AcknexObject.GetAcknexObject("GRAYHIT");
            var MY_51 = MY;
            MY_51.SetAcknexObject("IF_HIT", GRAYHIT_49);
            var GRAY_TEX_52 = _world.GetSynonymObject("GRAY_TEX");
            var MY_54 = MY;
            MY_54.SetAcknexObject("TEXTURE", GRAY_TEX_52);
            var MY_57 = MY;
            var temp_58 = MY_57.GetFloat("FLAG3");
            if (temp_58 == 1f)
            {
                {
                    var enumerator = GRAYHIDE(MY, THERE);
            ...
            var MY_65 = MY;
            var temp_66 = MY_65.GetFloat("SKILL4");
            if (temp_66 != 4f)
            {
                {
                    var enumerator = GRAYFOLLOWATTACK(MY, THERE);
            ...
            OBSTACLE:
            {
                var enumerator = GRAYTURN(MY, THERE);
                while (enumerator.MoveNext())
                {
                    var current = enumerator.Current;
                    if (current != null)
        ...
        public IEnumerator CYCLEGRAYBACKOFF(IAcknexObject MY, IAcknexObject THERE)
        {
            {
                var enumerator = PROBE(MY, THERE);
                while (enumerator.MoveNext())
        ...
        public IEnumerator CYCLEGRAYATTACK(IAcknexObject MY, IAcknexObject THERE)
        {
            {
                var enumerator = PROBE(MY, THERE);
                while (enumerator.MoveNext())
            ...
            {
                var enumerator = GRAYLOOKFOR(MY, THERE);
                while (enumerator.MoveNext())
                {
                    var current = enumerator.Current;
                    if (current != null)
            ...
            var MY_8 = MY;
            var temp_9 = MY_8.GetFloat("FLAG3");
            if (temp_9 == 1f)
            {
                goto WARNING;
            }
            var MY_12 = MY;
            var temp_13 = MY_12.GetFloat("FLAG2");
            if (temp_13 != 0f)
            {
                goto ATTACK;
            }
            var GUN_ON_15 = _world.GetObject(ObjectType.Skill, "GUN_ON");
            var GUN_ON_15_val = GUN_ON_15.GetFloat("VAL");
            if (GUN_ON_15_val != 0f)
            {
                goto ATTACK;
            }
            ...
            {
                {
                    var enumerator = GRAYFOLLOWWARNING(MY, THERE);
                    while (enumerator.MoveNext())
                    {
                        var current = enumerator.Current;
                        if (current != null)
            ...
            ATTACK:
            var MY_22 = MY;
            MY_22.SetFloat("FLAG2", 1f);
            var MY_25 = MY;
            var temp_26 = MY_25.GetFloat("DISTANCE");
            if (temp_26 < 100f)
            {
                {
                    var enumerator = GRAYFOLLOWATTACK(MY, THERE);
        ...
        public IEnumerator CYCLEGRAYHIDE(IAcknexObject MY, IAcknexObject THERE)
        {
            {
                var enumerator = PROBE(MY, THERE);
                while (enumerator.MoveNext())
        ...
        public IEnumerator CYCLEGRAYSHOOT(IAcknexObject MY, IAcknexObject THERE)
        {
            {
                var enumerator = PROBE(MY, THERE);
                while (enumerator.MoveNext())
            ...
            var MY_2 = MY;
            var temp_3 = MY_2.GetFloat("FLAG1");
            if (temp_3 == 0f)
            {
                goto ATTACK;
            }
            var SHOT_SOUND_ON_5 = _world.GetObject(ObjectType.Skill, "SHOT_SOUND_ON");
            SHOT_SOUND_ON_5.SetFloat("VAL", 1f);
            var SHOTSECCOUNT_7 = _world.GetObject(ObjectType.Skill, "SHOTSECCOUNT");
            SHOTSECCOUNT_7.SetFloat("VAL", 0f);
            {
                var enumerator = GRAYAIM(MY, THERE);
                while (enumerator.MoveNext())
                {
                    var current = enumerator.Current;
                    if (current != null)
            ...
            ATTACK:
            var MY_10 = MY;
            var temp_11 = MY_10.GetFloat("FLAG3");
            if (temp_11 == 1f)
            {
                {
                    var enumerator = GRAYFOLLOWWARNING(MY, THERE);
        ...
        public IEnumerator CYCLEGRAYWARNING(IAcknexObject MY, IAcknexObject THERE)
        {
            {
                var enumerator = PROBE(MY, THERE);
                while (enumerator.MoveNext())
            ...
            MY_8.SetAcknexObject("EACH_CYCLE", null);
            {
                var enumerator = GRAYWARNING(MY, THERE);
                while (enumerator.MoveNext())
                {
                    var current = enumerator.Current;
                    if (current != null)
        ...
        public IEnumerator ALARMOFF(IAcknexObject MY, IAcknexObject THERE)
        {
            var RPMEZANINORGN_2 = _world.AcknexObject.GetAcknexObject("RPMEZANINORGN");
            RPMEZANINORGN_2.SetAcknexObjectAll("IF_ENTER", null);
            var TROPSDBEDACT_5 = _world.AcknexObject.GetAcknexObject("TROPSDBEDACT");
            TROPSDBEDACT_5.SetFloatAll("INVISIBLE", 0f);
            {
                var startTime = Time.time;
                var endTime = startTime + TimeUtils.TicksToTime((int)8f);
                while (Time.time < endTime)
            ...
            var TROPSDDEPACT_9 = _world.AcknexObject.GetAcknexObject("TROPSDDEPACT");
            TROPSDDEPACT_9.SetFloatAll("INVISIBLE", 0f);
            var ALARMTEX_12 = _world.AcknexObject.GetAcknexObject("ALARMTEX");
            ALARMTEX_12.SetAcknexObject("SOUND", null);
            //Unknown keyword: 
            yield break;
        }
        public IEnumerator SETTROOPB(IAcknexObject MY, IAcknexObject THERE)
        {
            var HGMAINRGN_2 = _world.AcknexObject.GetAcknexObject("HGMAINRGN");
            HGMAINRGN_2.SetAcknexObjectAll("IF_LEAVE", null);
            var TROPWAY2GBACT_5 = _world.AcknexObject.GetAcknexObject("TROPWAY2GBACT");
            TROPWAY2GBACT_5.SetFloatAll("INVISIBLE", 0f);
            //Unknown keyword: 
            yield break;
        }
        public IEnumerator HANGARTRAP(IAcknexObject MY, IAcknexObject THERE)
        {
            var RPDOORRGN_2 = _world.AcknexObject.GetAcknexObject("RPDOORRGN");
            RPDOORRGN_2.SetAcknexObjectAll("IF_ENTER", null);
            var TROPSDTRAPACT_5 = _world.AcknexObject.GetAcknexObject("TROPSDTRAPACT");
            TROPSDTRAPACT_5.SetFloatAll("INVISIBLE", 0f);
            var LNCHSDACT_8 = _world.AcknexObject.GetAcknexObject("LNCHSDACT");
            LNCHSDACT_8.SetFloatAll("INVISIBLE", 0f);
            //Unknown keyword: 
            yield break;
        }
        public IEnumerator DEPOTREINFORCE(IAcknexObject MY, IAcknexObject THERE)
        {
            var FCT01DEPOTWALL_2 = _world.AcknexObject.GetAcknexObject("FCT01DEPOTWALL");
            FCT01DEPOTWALL_2.SetAcknexObjectAll("IF_NEAR", null);
            var TROPWAY3GAACT_5 = _world.AcknexObject.GetAcknexObject("TROPWAY3GAACT");
            TROPWAY3GAACT_5.SetFloatAll("INVISIBLE", 0f);
            //Unknown keyword: 
            yield break;
        }
        public IEnumerator BEDROOMREINFORCE(IAcknexObject MY, IAcknexObject THERE)
        {
            var FCT01BEDWALL_2 = _world.AcknexObject.GetAcknexObject("FCT01BEDWALL");
            FCT01BEDWALL_2.SetAcknexObjectAll("IF_NEAR", null);
            var TROPWAY4GAACT_5 = _world.AcknexObject.GetAcknexObject("TROPWAY4GAACT");
            TROPWAY4GAACT_5.SetFloatAll("INVISIBLE", 0f);
            //Unknown keyword: 
            yield break;
        }
        public IEnumerator SETBRIEF(IAcknexObject MY, IAcknexObject THERE)
        {
            var TRCORRIDOR90RGN_2 = _world.AcknexObject.GetAcknexObject("TRCORRIDOR90RGN");
            TRCORRIDOR90RGN_2.SetAcknexObjectAll("IF_ENTER", null);
            var TROPSDBRIEFACT_5 = _world.AcknexObject.GetAcknexObject("TROPSDBRIEFACT");
            TROPSDBRIEFACT_5.SetFloatAll("INVISIBLE", 0f);
            var LNCHSDBRIEFACT_8 = _world.AcknexObject.GetAcknexObject("LNCHSDBRIEFACT");
            LNCHSDBRIEFACT_8.SetFloatAll("INVISIBLE", 0f);
            //Unknown keyword: 
            yield break;
        }
        public IEnumerator SETBACK(IAcknexObject MY, IAcknexObject THERE)
        {
            var TRCORRIDOR90RGN_2 = _world.AcknexObject.GetAcknexObject("TRCORRIDOR90RGN");
            TRCORRIDOR90RGN_2.SetAcknexObjectAll("IF_ENTER", null);
            var TROPBACKACT_5 = _world.AcknexObject.GetAcknexObject("TROPBACKACT");
            TROPBACKACT_5.SetFloatAll("INVISIBLE", 0f);
            var TROPSDBRIEFACT_8 = _world.AcknexObject.GetAcknexObject("TROPSDBRIEFACT");
            TROPSDBRIEFACT_8.SetFloatAll("BERKELEY", 1f);
            var LNCHSDBRIEFACT_11 = _world.AcknexObject.GetAcknexObject("LNCHSDBRIEFACT");
            LNCHSDBRIEFACT_11.SetFloatAll("BERKELEY", 1f);
            var TROPWAY4GAACT_14 = _world.AcknexObject.GetAcknexObject("TROPWAY4GAACT");
            TROPWAY4GAACT_14.SetFloatAll("BERKELEY", 1f);
            var TROPWAY3GAACT_17 = _world.AcknexObject.GetAcknexObject("TROPWAY3GAACT");
            TROPWAY3GAACT_17.SetFloatAll("BERKELEY", 1f);
            var TROPSDTRAPACT_20 = _world.AcknexObject.GetAcknexObject("TROPSDTRAPACT");
            TROPSDTRAPACT_20.SetFloatAll("BERKELEY", 1f);
            var LNCHSDACT_23 = _world.AcknexObject.GetAcknexObject("LNCHSDACT");
            LNCHSDACT_23.SetFloatAll("BERKELEY", 1f);
            var TROPWAY2GBACT_26 = _world.AcknexObject.GetAcknexObject("TROPWAY2GBACT");
            TROPWAY2GBACT_26.SetFloatAll("BERKELEY", 1f);
            var TROPSDBEDACT_29 = _world.AcknexObject.GetAcknexObject("TROPSDBEDACT");
            TROPSDBEDACT_29.SetFloatAll("BERKELEY", 1f);
            var TROPSDDEPACT_32 = _world.AcknexObject.GetAcknexObject("TROPSDDEPACT");
            TROPSDDEPACT_32.SetFloatAll("BERKELEY", 1f);
            var TROPSDACT_35 = _world.AcknexObject.GetAcknexObject("TROPSDACT");
            TROPSDACT_35.SetFloatAll("BERKELEY", 1f);
            //Unknown keyword: 
            yield break;
        }
        public IEnumerator SETMIBA(IAcknexObject MY, IAcknexObject THERE)
        {
            var TROPBACKACT_2 = _world.AcknexObject.GetAcknexObject("TROPBACKACT");
            TROPBACKACT_2.SetFloatAll("BERKELEY", 1f);
            var MIBMIBKA1ACT_5 = _world.AcknexObject.GetAcknexObject("MIBMIBKA1ACT");
            MIBMIBKA1ACT_5.SetFloatAll("INVISIBLE", 0f);
            var MIBMIBKA2ACT_8 = _world.AcknexObject.GetAcknexObject("MIBMIBKA2ACT");
            MIBMIBKA2ACT_8.SetFloatAll("INVISIBLE", 0f);
            //Unknown keyword: 
            yield break;
        }
        public IEnumerator SETMIBB(IAcknexObject MY, IAcknexObject THERE)
        {
            var MIBMIBKA1ACT_2 = _world.AcknexObject.GetAcknexObject("MIBMIBKA1ACT");
            MIBMIBKA1ACT_2.SetFloatAll("BERKELEY", 1f);
            var MIBMIBKA2ACT_5 = _world.AcknexObject.GetAcknexObject("MIBMIBKA2ACT");
            MIBMIBKA2ACT_5.SetFloatAll("BERKELEY", 1f);
            var MIBMIBKB1ACT_8 = _world.AcknexObject.GetAcknexObject("MIBMIBKB1ACT");
            MIBMIBKB1ACT_8.SetFloatAll("INVISIBLE", 0f);
            var MIBMIBKB2ACT_11 = _world.AcknexObject.GetAcknexObject("MIBMIBKB2ACT");
            MIBMIBKB2ACT_11.SetFloatAll("INVISIBLE", 0f);
            if (UnityEngine.Random.value > 0.7f)
            {
                yield break;
            }
            var MIBTROPBACT_16 = _world.AcknexObject.GetAcknexObject("MIBTROPBACT");
            MIBTROPBACT_16.SetFloatAll("INVISIBLE", 0f);
            var MIBLNCHBACT_19 = _world.AcknexObject.GetAcknexObject("MIBLNCHBACT");
            MIBLNCHBACT_19.SetFloatAll("INVISIBLE", 0f);
            var MIBDOUBLERGN_22 = _world.AcknexObject.GetAcknexObject("MIBDOUBLERGN");
            MIBDOUBLERGN_22.SetAcknexObjectAll("IF_ENTER", null);
            //Unknown keyword: 
            yield break;
        }
        public IEnumerator SETMIBC(IAcknexObject MY, IAcknexObject THERE)
        {
            var MIBMIBKB1ACT_2 = _world.AcknexObject.GetAcknexObject("MIBMIBKB1ACT");
            MIBMIBKB1ACT_2.SetFloatAll("BERKELEY", 1f);
            var MIBMIBKB2ACT_5 = _world.AcknexObject.GetAcknexObject("MIBMIBKB2ACT");
            MIBMIBKB2ACT_5.SetFloatAll("BERKELEY", 1f);
            var MIBTROPBACT_8 = _world.AcknexObject.GetAcknexObject("MIBTROPBACT");
            MIBTROPBACT_8.SetFloatAll("BERKELEY", 1f);
            var MIBLNCHBACT_11 = _world.AcknexObject.GetAcknexObject("MIBLNCHBACT");
            MIBLNCHBACT_11.SetFloatAll("BERKELEY", 1f);
            var MIBBLOCK1RGN_14 = _world.AcknexObject.GetAcknexObject("MIBBLOCK1RGN");
            MIBBLOCK1RGN_14.SetFloat("FLOOR_HGT", 10f);
            var MIBBLOCK1RGN_17 = _world.AcknexObject.GetAcknexObject("MIBBLOCK1RGN");
            MIBBLOCK1RGN_17.SetFloat("CEIL_HGT", 20f);
            var MIBMIBKCACT_20 = _world.AcknexObject.GetAcknexObject("MIBMIBKCACT");
            MIBMIBKCACT_20.SetFloatAll("INVISIBLE", 0f);
            var MIBTROPCACT_23 = _world.AcknexObject.GetAcknexObject("MIBTROPCACT");
            MIBTROPCACT_23.SetFloatAll("INVISIBLE", 0f);
            var MIBDRKLC1ACT_26 = _world.AcknexObject.GetAcknexObject("MIBDRKLC1ACT");
            MIBDRKLC1ACT_26.SetFloatAll("INVISIBLE", 0f);
            if (UnityEngine.Random.value > 0.5f)
            {
                yield break;
            }
            var MIBDRKLC2ACT_31 = _world.AcknexObject.GetAcknexObject("MIBDRKLC2ACT");
            MIBDRKLC2ACT_31.SetFloatAll("INVISIBLE", 0f);
            //Unknown keyword: 
            yield break;
        }
        public IEnumerator CLOSEMIB(IAcknexObject MY, IAcknexObject THERE)
        {
            var MIBMIBKCACT_2 = _world.AcknexObject.GetAcknexObject("MIBMIBKCACT");
            MIBMIBKCACT_2.SetFloatAll("BERKELEY", 1f);
            var MIBTROPCACT_5 = _world.AcknexObject.GetAcknexObject("MIBTROPCACT");
            MIBTROPCACT_5.SetFloatAll("BERKELEY", 1f);
            var MIBDRKLC1ACT_8 = _world.AcknexObject.GetAcknexObject("MIBDRKLC1ACT");
            MIBDRKLC1ACT_8.SetFloatAll("BERKELEY", 1f);
            var MIBDRKLC2ACT_11 = _world.AcknexObject.GetAcknexObject("MIBDRKLC2ACT");
            MIBDRKLC2ACT_11.SetFloatAll("BERKELEY", 1f);
            //Unknown keyword: 
            yield break;
        }
        public IEnumerator SETBIOA(IAcknexObject MY, IAcknexObject THERE)
        {
            var BIOLNCHAACT_2 = _world.AcknexObject.GetAcknexObject("BIOLNCHAACT");
            BIOLNCHAACT_2.SetFloatAll("INVISIBLE", 0f);
            var BIOTROPAACT_5 = _world.AcknexObject.GetAcknexObject("BIOTROPAACT");
            BIOTROPAACT_5.SetFloatAll("INVISIBLE", 0f);
            var BIOMIBKAACT_8 = _world.AcknexObject.GetAcknexObject("BIOMIBKAACT");
            BIOMIBKAACT_8.SetFloatAll("INVISIBLE", 0f);
            {
                var enumerator = CLOSEMIB(MY, THERE);
                while (enumerator.MoveNext())
                {
                    var current = enumerator.Current;
                    if (current != null)
        ...
        public IEnumerator SETATTACKA(IAcknexObject MY, IAcknexObject THERE)
        {
            var BIOTROPBACT_2 = _world.AcknexObject.GetAcknexObject("BIOTROPBACT");
            BIOTROPBACT_2.SetFloatAll("INVISIBLE", 0f);
            {
                var startTime = Time.time;
                var endTime = startTime + TimeUtils.TicksToTime((int)150f);
                while (Time.time < endTime)
                {
                    yield return _waitForEndOfFrame;
                }
            }
            var ALARM02SND_4 = _world.AcknexObject.GetAcknexObject("ALARM02SND");
            _world.PlaySound(ALARM02SND_4, 0.4f);
            {
                var startTime = Time.time;
                var endTime = startTime + TimeUtils.TicksToTime((int)20f);
                while (Time.time < endTime)
                {
                    yield return _waitForEndOfFrame;
                }
            }
            var ALARM02SND_7 = _world.AcknexObject.GetAcknexObject("ALARM02SND");
            _world.PlaySound(ALARM02SND_7, 0.4f);
            {
                var startTime = Time.time;
                var endTime = startTime + TimeUtils.TicksToTime((int)20f);
                while (Time.time < endTime)
            ...
            var ALARM02SND_10 = _world.AcknexObject.GetAcknexObject("ALARM02SND");
            _world.PlaySound(ALARM02SND_10, 0.4f);
            var BIOLNCHAACT_14 = _world.AcknexObject.GetAcknexObject("BIOLNCHAACT");
            BIOLNCHAACT_14.SetFloatAll("FLAG2", 1f);
            var BIOTROPAACT_17 = _world.AcknexObject.GetAcknexObject("BIOTROPAACT");
            BIOTROPAACT_17.SetFloatAll("FLAG2", 1f);
            var BIOMIBKAACT_20 = _world.AcknexObject.GetAcknexObject("BIOMIBKAACT");
            BIOMIBKAACT_20.SetFloatAll("FLAG2", 1f);
            var BIOTROPAWALL_23 = _world.AcknexObject.GetAcknexObject("BIOTROPAWALL");
            BIOTROPAWALL_23.SetAcknexObject("IF_NEAR", null);
            //Unknown keyword: 
            yield break;
        }
        public IEnumerator SETBIOREINFORCE(IAcknexObject MY, IAcknexObject THERE)
        {
            var BIOMIBKCACT_2 = _world.AcknexObject.GetAcknexObject("BIOMIBKCACT");
            BIOMIBKCACT_2.SetFloatAll("INVISIBLE", 0f);
            if (UnityEngine.Random.value > 0.5f)
            {
                goto WAY2;
            }
            var BIOWAY1_5 = _world.AcknexObject.GetAcknexObject("BIOWAY1");
            var TROPBIOREINFAACT_7 = _world.AcknexObject.GetAcknexObject("TROPBIOREINFAACT");
            TROPBIOREINFAACT_7.SetAcknexObjectAll("TARGET", BIOWAY1_5);
            goto SECOND;
            WAY2:
            var BIOWAY2_8 = _world.AcknexObject.GetAcknexObject("BIOWAY2");
            var TROPBIOREINFAACT_10 = _world.AcknexObject.GetAcknexObject("TROPBIOREINFAACT");
            TROPBIOREINFAACT_10.SetAcknexObjectAll("TARGET", BIOWAY2_8);
            SECOND:
            {
                var startTime = Time.time;
                var endTime = startTime + TimeUtils.TicksToTime((int)1f);
            ...
            var BIOWAY3_14 = _world.AcknexObject.GetAcknexObject("BIOWAY3");
            var TROPBIOREINFBACT_16 = _world.AcknexObject.GetAcknexObject("TROPBIOREINFBACT");
            TROPBIOREINFBACT_16.SetAcknexObjectAll("TARGET", BIOWAY3_14);
            goto GO;
            WAY4:
            var BIOWAY4_17 = _world.AcknexObject.GetAcknexObject("BIOWAY4");
            var TROPBIOREINFBACT_19 = _world.AcknexObject.GetAcknexObject("TROPBIOREINFBACT");
            TROPBIOREINFBACT_19.SetAcknexObjectAll("TARGET", BIOWAY4_17);
            GO:
            var TROPBIOREINFAACT_22 = _world.AcknexObject.GetAcknexObject("TROPBIOREINFAACT");
            TROPBIOREINFAACT_22.SetFloatAll("INVISIBLE", 0f);
            var TROPBIOREINFBACT_25 = _world.AcknexObject.GetAcknexObject("TROPBIOREINFBACT");
            TROPBIOREINFBACT_25.SetFloatAll("INVISIBLE", 0f);
            //Unknown keyword: 
            yield break;
        }
        public IEnumerator CLOSEBIO(IAcknexObject MY, IAcknexObject THERE)
        {
            var BIOMIBKCACT_2 = _world.AcknexObject.GetAcknexObject("BIOMIBKCACT");
            BIOMIBKCACT_2.SetFloatAll("BERKELEY", 1f);
            var BIOLNCHDACT_5 = _world.AcknexObject.GetAcknexObject("BIOLNCHDACT");
            BIOLNCHDACT_5.SetFloatAll("BERKELEY", 1f);
            var TROPBIOREINFAACT_8 = _world.AcknexObject.GetAcknexObject("TROPBIOREINFAACT");
            TROPBIOREINFAACT_8.SetFloatAll("BERKELEY", 1f);
            var TROPBIOREINFBACT_11 = _world.AcknexObject.GetAcknexObject("TROPBIOREINFBACT");
            TROPBIOREINFBACT_11.SetFloatAll("BERKELEY", 1f);
            var BIODRKLJAILACT_14 = _world.AcknexObject.GetAcknexObject("BIODRKLJAILACT");
            BIODRKLJAILACT_14.SetFloatAll("BERKELEY", 1f);
            var BIOMIBKAACT_17 = _world.AcknexObject.GetAcknexObject("BIOMIBKAACT");
            BIOMIBKAACT_17.SetFloatAll("BERKELEY", 1f);
            var BIOTROPAACT_20 = _world.AcknexObject.GetAcknexObject("BIOTROPAACT");
            BIOTROPAACT_20.SetFloatAll("BERKELEY", 1f);
            var BIOLNCHAACT_23 = _world.AcknexObject.GetAcknexObject("BIOLNCHAACT");
            BIOLNCHAACT_23.SetFloatAll("BERKELEY", 1f);
            var BIOTROPBACT_26 = _world.AcknexObject.GetAcknexObject("BIOTROPBACT");
            BIOTROPBACT_26.SetFloatAll("BERKELEY", 1f);
            //Unknown keyword: 
            yield break;
        }
        public IEnumerator SETGRAYA(IAcknexObject MY, IAcknexObject THERE)
        {
            {
                var enumerator = CLOSEBIO(MY, THERE);
                while (enumerator.MoveNext())
                {
                    var current = enumerator.Current;
                    if (current != null)
            ...
            var GRAYPRIESTAACT_2 = _world.AcknexObject.GetAcknexObject("GRAYPRIESTAACT");
            GRAYPRIESTAACT_2.SetFloatAll("INVISIBLE", 0f);
            var GSHU1ACT_5 = _world.AcknexObject.GetAcknexObject("GSHU1ACT");
            GSHU1ACT_5.SetFloatAll("INVISIBLE", 0f);
            var GSHU2ACT_8 = _world.AcknexObject.GetAcknexObject("GSHU2ACT");
            GSHU2ACT_8.SetFloatAll("INVISIBLE", 0f);
            var GSHU3ACT_11 = _world.AcknexObject.GetAcknexObject("GSHU3ACT");
            GSHU3ACT_11.SetFloatAll("INVISIBLE", 0f);
            var GSHUACT_14 = _world.AcknexObject.GetAcknexObject("GSHUACT");
            GSHUACT_14.SetFloatAll("INVISIBLE", 0f);
            var LIFT06ACT_17 = _world.AcknexObject.GetAcknexObject("LIFT06ACT");
            LIFT06ACT_17.SetFloatAll("INVISIBLE", 0f);
            var LTARGET06ACT_20 = _world.AcknexObject.GetAcknexObject("LTARGET06ACT");
            LTARGET06ACT_20.SetFloatAll("INVISIBLE", 0f);
            var LIFT05ACT_23 = _world.AcknexObject.GetAcknexObject("LIFT05ACT");
            LIFT05ACT_23.SetFloatAll("INVISIBLE", 0f);
            var LTARGET05ACT_26 = _world.AcknexObject.GetAcknexObject("LTARGET05ACT");
            LTARGET05ACT_26.SetFloatAll("INVISIBLE", 0f);
            var LIFT04ACT_29 = _world.AcknexObject.GetAcknexObject("LIFT04ACT");
            LIFT04ACT_29.SetFloatAll("INVISIBLE", 0f);
            var LTARGET04ACT_32 = _world.AcknexObject.GetAcknexObject("LTARGET04ACT");
            LTARGET04ACT_32.SetFloatAll("INVISIBLE", 0f);
            var LIFT03ACT_35 = _world.AcknexObject.GetAcknexObject("LIFT03ACT");
            LIFT03ACT_35.SetFloatAll("INVISIBLE", 0f);
            var LTARGET02ACT_38 = _world.AcknexObject.GetAcknexObject("LTARGET02ACT");
            LTARGET02ACT_38.SetFloatAll("INVISIBLE", 0f);
            var LIFT02ACT_41 = _world.AcknexObject.GetAcknexObject("LIFT02ACT");
            LIFT02ACT_41.SetFloatAll("INVISIBLE", 0f);
            var LTARGET02ACT_44 = _world.AcknexObject.GetAcknexObject("LTARGET02ACT");
            LTARGET02ACT_44.SetFloatAll("INVISIBLE", 0f);
            var LIFT01ACT_47 = _world.AcknexObject.GetAcknexObject("LIFT01ACT");
            LIFT01ACT_47.SetFloatAll("INVISIBLE", 0f);
            var LTARGET01ACT_50 = _world.AcknexObject.GetAcknexObject("LTARGET01ACT");
            LTARGET01ACT_50.SetFloatAll("INVISIBLE", 0f);
            var GYCORRIDORON4RGN_53 = _world.AcknexObject.GetAcknexObject("GYCORRIDORON4RGN");
            GYCORRIDORON4RGN_53.SetAcknexObject("IF_ENTER", null);
            if (UnityEngine.Random.value > 0f)
            {
                yield break;
            }
            var GRAYWARRIORAACT_58 = _world.AcknexObject.GetAcknexObject("GRAYWARRIORAACT");
            GRAYWARRIORAACT_58.SetFloatAll("INVISIBLE", 0f);
            //Unknown keyword: 
            yield break;
        }
        public IEnumerator SETGRAYB(IAcknexObject MY, IAcknexObject THERE)
        {
            var GRAYPRIESTBACT_2 = _world.AcknexObject.GetAcknexObject("GRAYPRIESTBACT");
            GRAYPRIESTBACT_2.SetFloatAll("INVISIBLE", 0f);
            var GRAYWARRIORAACT_5 = _world.AcknexObject.GetAcknexObject("GRAYWARRIORAACT");
            GRAYWARRIORAACT_5.SetFloatAll("INVISIBLE", 0f);
            var GRAYWARRIORBACT_8 = _world.AcknexObject.GetAcknexObject("GRAYWARRIORBACT");
            GRAYWARRIORBACT_8.SetFloatAll("INVISIBLE", 0f);
            var GRAYDRKLBACT_11 = _world.AcknexObject.GetAcknexObject("GRAYDRKLBACT");
            GRAYDRKLBACT_11.SetFloatAll("INVISIBLE", 0f);
            var GRAYWARRIORBBACT_14 = _world.AcknexObject.GetAcknexObject("GRAYWARRIORBBACT");
            GRAYWARRIORBBACT_14.SetFloatAll("INVISIBLE", 0f);
            var GRAYWARRIORBLACT_17 = _world.AcknexObject.GetAcknexObject("GRAYWARRIORBLACT");
            GRAYWARRIORBLACT_17.SetFloatAll("INVISIBLE", 0f);
            var GRAYPRIESTBBACT_20 = _world.AcknexObject.GetAcknexObject("GRAYPRIESTBBACT");
            GRAYPRIESTBBACT_20.SetFloatAll("INVISIBLE", 0f);
            var GRAYPRIESTBLACT_23 = _world.AcknexObject.GetAcknexObject("GRAYPRIESTBLACT");
            GRAYPRIESTBLACT_23.SetFloatAll("INVISIBLE", 0f);
            var PLATAFORM1RGN_26 = _world.AcknexObject.GetAcknexObject("PLATAFORM1RGN");
            PLATAFORM1RGN_26.SetAcknexObject("IF_ENTER", null);
            //Unknown keyword: 
            yield break;
        }
        public IEnumerator STARTLEVEL(IAcknexObject MY, IAcknexObject THERE)
        {
            ...
            var SHUTLEPARAM1_75 = _world.AcknexObject.GetAcknexObject("SHUTLEPARAM1");
            _world.SetSynonymObject("SHUTLEACTIONWAY1", SHUTLEPARAM1_75);
            var SHUTLEPARAM2_77 = _world.AcknexObject.GetAcknexObject("SHUTLEPARAM2");
            _world.SetSynonymObject("SHUTLEACTIONWAY2", SHUTLEPARAM2_77);
            var WMT19WAY3TEX_79 = _world.AcknexObject.GetAcknexObject("WMT19WAY3TEX");
            _world.SetSynonymObject("SHUTLETEXTUREWAY1", WMT19WAY3TEX_79);
            var WMT19WAY2TEX_81 = _world.AcknexObject.GetAcknexObject("WMT19WAY2TEX");
            _world.SetSynonymObject("SHUTLETEXTUREWAY2", WMT19WAY2TEX_81);
            {
