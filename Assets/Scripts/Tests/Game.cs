...
namespace Tests
{
    public class Game : IAcknexRuntime
    {
        ...
        public IEnumerator EXPLODEMISSILE()
        {
            ...
            MY_41.SetFloat("SPEED", 0f);
            var MY_44 = _world.GetSynonymObject("MY");
            MY_44.SetFloat("CAREFULLY", 0f);
            var MY_47 = _world.GetSynonymObject("MY");
            MY_47.SetFloat("GROUND", 0f);
            var MY_50 = _world.GetSynonymObject("MY");
            MY_50.SetFloat("HEIGHT", -0.05f);
            var EXP01TEX_51 = _world.AcknexObject.GetAcknexObject(/*ObjectType.Texture,*/"EXP01TEX");
            var MY_53 = _world.GetSynonymObject("MY");
            MY_53.SetAcknexObject("TEXTURE", EXP01TEX_51);
            var MY_56 = _world.GetSynonymObject("MY");
            //Unknown Property Type: Thing.PLAY
            yield return new WaitForTicks(4f);
            var EXPLOSION_ON_59 = _world.GetObject(ObjectType.Skill, "EXPLOSION_ON");
            EXPLOSION_ON_59.SetFloat("VAL", 0f);
            yield break;
        }
        ...
        public IEnumerator WALLTIMER()
        {
            ...
            //Unknown Property Type: Wall.IMPASSABLE
