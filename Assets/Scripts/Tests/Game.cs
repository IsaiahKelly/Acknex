...
if (CheckEquals(temp_46 , BLANKSTR_43))
{
goto NULLMESSAGE;
}
...
if (CheckEquals(HIT_DIST_29_val , 0f))
{
goto NOTVISIBLE;
}
ISVISIBLE:
...
if (CheckEquals(WEAPONSEL_1_val , 1f))
{
...
if (CheckEquals(WEAPONSEL_5_val , 2f))
{
...
if (CheckEquals(WEAPONSEL_9_val , 3f))
{
...
if (CheckEquals(WEAPONSEL_13_val , 4f))
{
...
if (CheckEquals(WEAPONSEL_17_val , 5f))
{
...
if (CheckEquals(UNDERWATER_17_val , 0f))
{
goto NOWATER;
}
{
...
if (CheckEquals(SUBMENUITEM_23_val , 1f))
{
...
if (CheckEquals(SUBMENUITEM_26_val , 2f))
{
...
if (CheckEquals(SUBMENUITEM_29_val , 3f))
{
...
if (CheckEquals(SUBMENUITEM_32_val , 4f))
{
...
if (CheckEquals(MENUITEM_7_val , 1f))
{
{
...
if (CheckEquals(MENUITEM_9_val , 2f))
{
{
...
if (CheckEquals(MENUITEM_11_val , 3f))
{
{
...
if (CheckEquals(MENUITEM_13_val , 4f))
{
{
...
if (!CheckEquals(LEVEL_STRING_27 , null))
{
goto CONT;
}
...
if (CheckEquals(HIT_DIST_30_val , 0f))
{
goto CONT;
}
...
if (CheckEquals(HIT_DIST_39_val , 0f))
{
goto CONT;
}
{
...
if (CheckEquals(MISSILECOUNTER_4_val , 16f))
{
MY_7 = MY;
...
if (!CheckEquals(temp_8 , FOLLOW_5))
{
...
if (!CheckEquals(temp_11 , FOLLOW_8))
{
...
if (!CheckEquals(DISTX_61_val , 0f))
{
MY_63 = MY;
MY_65 = MY;
...
if (CheckEquals(temp_86 , 0f))
{
//Unknown keyword: LOCATE
}
MY_89 = MY;
temp_90 =MY_89.GetFloat(205);
if (CheckEquals(temp_90 , 0f))
{
{
            var enumerator = new VANISHSTOP();
            var compiledAction = (ICompiledAction)enumerator;
...
if (!CheckEquals(LUP1_123_val , 0f))
{
...
if (!CheckEquals(LUP2_128_val , 0f))
{
...
if (!CheckEquals(LUP3_133_val , 0f))
{
...
if (!CheckEquals(LUP4_138_val , 0f))
{
...
if (CheckEquals(CHECKENDFLAG_143_val , 0f))
{
...
if (CheckEquals(MOVING_1_val , MODE_GEHEN_0_val))
{
...
if (CheckEquals(MOVING_10_val , MODE_SCHWIMMEN_9_val))
{
...
if (CheckEquals(MOVING_19_val , MODE_TAUCHEN_18_val))
{
...
if (CheckEquals(MOVING_24_val , MODE_DEATH_23_val))
{
...
if (CheckEquals(MOVING_31_val , MODE_GEHEN_30_val))
{
...
if (!CheckEquals(MOVING_38_val , MODE_SCHWIMMEN_37_val))
{
goto NO_SWIM;
}
...
if (!CheckEquals(MOVING_42_val , MODE_GEHEN_41_val))
{
goto NO_WATER;
}
...
if (CheckEquals(MOUSE_MIDDLE_46_val , 0f))
{
goto NO_MOUSE;
}
...
if (CheckEquals(KEY_SHIFT_52_val , 1f))
{
...
if (CheckEquals(MOUSE_RIGHT_65_val , 1f))
{
...
if (!CheckEquals(KEY_ALT_69_val , 1f))
{
goto NOALT;
}
...
if (!CheckEquals(MOVING_146_val , MODE_GEHEN_145_val))
{
...
if (CheckEquals(MOVING_277_val , MODE_SCHWIMMEN_276_val))
{
goto DUCK;
}
...
if (!CheckEquals(MOVING_293_val , MODE_GEHEN_292_val))
{
goto NO_JUMP;
}
...
if (!CheckEquals(TILT_DECREASE_340_val , 1f))
{
goto CALC_TILT;
}
...
if (!CheckEquals(PLAYER_VZ_348_val , 0f))
{
goto DECR_TILT;
}
goto CALC_TILT;
...
if (CheckEquals(MOVING_386_val , MODE_SCHWIMMEN_385_val))
{
...
if (CheckEquals(MOVING_395_val , MODE_TAUCHEN_394_val))
{
goto NO_HTILT;
}
...
if (CheckEquals(TILT_DECREASE_399_val , 1f))
{
goto NO_HTILT;
}
...
if (CheckEquals(RICHTER_414_val , 0f))
{
goto NO_QUAKE;
}
...
MOVING_1 = _world.GetObject(ObjectType.Skill,3242343005);
MOVING_1_val = MOVING_1.GetFloat(PropertyName.VAL);
if (CheckEquals(MOVING_1_val , 0f))
{
return false;
}
...
if (CheckEquals(MOVING_3_val , MODE_GEHEN_2_val))
{
{
            var enumerator = new SET_WALKING();
            var compiledAction = (ICompiledAction)enumerator;
...
if (CheckEquals(MOVING_5_val , MODE_SCHWIMMEN_4_val))
{
{
            var enumerator = new SET_SWIMMING();
            var compiledAction = (ICompiledAction)enumerator;
...
if (CheckEquals(MOVING_7_val , MODE_TAUCHEN_6_val))
{
{
...
UNDERWATER_1 = _world.GetObject(ObjectType.Skill,1369167822);
UNDERWATER_1_val = UNDERWATER_1.GetFloat(PropertyName.VAL);
if (CheckEquals(UNDERWATER_1_val , 1f))
{
return false;
}
...
UNDERWATER_1 = _world.GetObject(ObjectType.Skill,1369167822);
UNDERWATER_1_val = UNDERWATER_1.GetFloat(PropertyName.VAL);
if (CheckEquals(UNDERWATER_1_val , 0f))
{
return false;
}
UNDERWATER_3 = _world.GetObject(ObjectType.Skill,1369167822);
...
MOVING_1 = _world.GetObject(ObjectType.Skill,3242343005);
MOVING_1_val = MOVING_1.GetFloat(PropertyName.VAL);
if (CheckEquals(MOVING_1_val , MODE_DEATH_0_val))
{
return false;
}
...
if (CheckEquals(PLAYER_ARMOUR_13_val , 0f))
{
goto CONT;
}
...
if (!CheckEquals(PLAYER_HIT_52_val , 0f))
{
return false;
}
...
if (!CheckEquals(temp_90 , KILLPLAYER_87))
{
...
if (CheckEquals(UNDERWATER_15_val , 0f))
{
goto NOWATER;
}
{
...
if (CheckEquals(PLAYER_ARMOUR_17_val , 0f))
{
goto CONT;
}
HITSERIOUSNESS_18 = _world.GetObject(ObjectType.Skill,4168972789);
...
if (!CheckEquals(PLAYER_HIT_30_val , 0f))
{
return false;
}
...
if (!CheckEquals(UNDERWATER_12_val , 0f))
{
{
            var enumerator = new SET_BLUE();
            var compiledAction = (ICompiledAction)enumerator;
...
if (CheckEquals(HIT_DIST_66_val , 0f))
{
goto SHOOT3;
}
...
if (CheckEquals(HIT_DIST_92_val , 0f))
{
goto NOHIT;
}
...
if (CheckEquals(temp_133 , GRAN2TEX_130))
{
...
if (!CheckEquals(WEAPONSEL_153_val , 3f))
{
goto FINISH;
}
...
if (CheckEquals(HIT_DIST_123_val , 0f))
{
goto HITWALL;
}
...
if (!CheckEquals(WEAPONSEL_200_val , 5f))
{
goto FINISH;
}
...
if (!CheckEquals(GUNFIRING_24_val , 0f))
{
goto WAITFIRE;
}
MY_GUN_26 = _world.GetSynonymObject(3254523708);
if (CheckEquals(MY_GUN_26 , null))
{
goto NOGUN;
}
MY_GUN_29 = _world.GetSynonymObject(3254523708);
temp_30 =MY_GUN_29.GetFloat(204);
if (!CheckEquals(temp_30 , 1f))
{
goto WAITFIRE;
}
NOGUN:
...
if (!CheckEquals(HAS_PDA_5_val , 0f))
{
goto HASGOT;
}
...
if (CheckEquals(SECCOUNTER_1_val , 0f))
{
//Unknown keyword: PLAY_CD
}
...
if (CheckEquals(temp_3 , ENDPHASE_0))
{
goto CONT;
}
MY_6 = MY;
...
if (!CheckEquals(temp_3 , 4f))
{
goto CONT;
}
MY_6 = MY;
temp_7 =MY_6.GetFloat(205);
if (!CheckEquals(temp_7 , 1f))
{
goto CONT;
}
return false;
...
MY_2 = MY;
temp_3 =MY_2.GetFloat(176);
if (CheckEquals(temp_3 , 10f))
{
return false;
}
MY_6 = MY;
temp_7 =MY_6.GetFloat(176);
if (CheckEquals(temp_7 , 4f))
{
return false;
}
MY_10 = MY;
...
if (CheckEquals(temp_19 , FOLLOW_16))
{
return false;
}
MY_22 = MY;
...
if (CheckEquals(SHOOT_FAC_1_val , 0f))
{
goto OBSTACLE;
}
MY_2 = MY;
HIT_3 = _world.GetSynonymObject(704);
if (!CheckEquals(HIT_3 , MY_2))
{
goto EXPLOSION;
}
...
if (CheckEquals(EXPLOSION_ON_7_val , 0f))
{
goto OBSTACLE;
}
...
if (!CheckEquals(EXPLOSION_ON_54_val , 2f))
{
goto CONT;
}
MY_57 = MY;
temp_58 =MY_57.GetFloat(205);
if (CheckEquals(temp_58 , 1f))
{
{
...
if (CheckEquals(SHOT_SOUND_ON_13_val , 0f))
{
goto CONT;
}
{
...
if (CheckEquals(temp_15 , FOLLOW_12))
{
return false;
}
MY_18 = MY;
...
if (CheckEquals(HIT_DIST_37_val , 0f))
{
goto MISS;
}
...
if (CheckEquals(EXPLOSION_ON_5_val , 0f))
{
goto OBSTACLE;
}
...
if (!CheckEquals(EXPLOSION_ON_52_val , 2f))
{
goto GRANADE;
}
MY_55 = MY;
temp_56 =MY_55.GetFloat(205);
if (CheckEquals(temp_56 , 1f))
{
{
...
if (CheckEquals(SHOT_SOUND_ON_5_val , 0f))
{
goto CONT;
}
{
...
if (!CheckEquals(GUN_ON_1_val , 0f))
{
{
            var enumerator = new TROPFOLLOWATTACK();
            var compiledAction = (ICompiledAction)enumerator;
...
if (CheckEquals(MISSILE_19 , null))
{
return false;
}
MY_22 = MY;
...
if (CheckEquals(SHOT_SOUND_ON_1_val , 0f))
{
goto CONT;
}
{
...
EXPLOSION_ON_7 = _world.GetObject(ObjectType.Skill,3352630890);
EXPLOSION_ON_7_val = EXPLOSION_ON_7.GetFloat(PropertyName.VAL);
if (!CheckEquals(EXPLOSION_ON_7_val , 2f))
{
goto CONT;
}
MY_10 = MY;
...
if (!CheckEquals(GUN_ON_37_val , 0f))
{
goto HIDE;
}
...
if (!CheckEquals(SHOT_SOUND_ON_39_val , 0f))
{
goto HIDE;
}
...
if (!CheckEquals(EXPLOSION_ON_41_val , 0f))
{
goto HIDE;
}
{
...
if (!CheckEquals(TALKNURS_9_val , 0f))
{
return false;
}
...
if (!CheckEquals(TALKDOCT_9_val , 0f))
{
return false;
}
...
if (CheckEquals(DROPPED_1_val , 1f))
{
return false;
}
MY_4 = MY;
temp_5 =MY_4.GetFloat(171);
if (!CheckEquals(temp_5 , 13f))
{
return false;
}
...
if (CheckEquals(TOUCHKEY_1_val , 1f))
{
{
...
if (CheckEquals(TOUCHKEY_3_val , 2f))
{
{
...
if (CheckEquals(TOUCHKEY_5_val , 4f))
{
{
...
if (CheckEquals(TOUCHKEY_7_val , 5f))
{
{
...
if (CheckEquals(TOUCHKEY_9_val , 6f))
{
{
...
if (CheckEquals(TOUCHKEY_11_val , 7f))
{
{
...
if (CheckEquals(TOUCHKEY_13_val , 8f))
{
{
