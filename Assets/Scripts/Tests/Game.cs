...
namespace Tests
{
    public class Game : IAcknexRuntime
    {
        ...
        public Game()
        {
            ...
            _callbacks.Add("MOUSE_TOGGLE", MOUSE_TOGGLE);
            _callbacks.Add("SCAN_OBJ", SCAN_OBJ);
        ...
        {
            //Unknown Property Type: World.GODMODE
            //_world.AcknexObject.SetAcknexObject("EACH_TICK.14", temp_1);
