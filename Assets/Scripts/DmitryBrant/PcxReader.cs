...
namespace DmitryBrant.ImageFormats
{
    ...
    public static class PcxReader
    {
        ...
        public static TextureAndPalette Load(Stream stream, bool useCgaPalette = false, bool paletteOnly = false)
        {
            ...
            UInt16 xmin = ImageUtils.LittleEndian(reader.ReadUInt16());
            UInt16 ymin = ImageUtils.LittleEndian(reader.ReadUInt16());
            UInt16 xmax = ImageUtils.LittleEndian(reader.ReadUInt16());
            UInt16 ymax = ImageUtils.LittleEndian(reader.ReadUInt16());
            ...
            ImageUtils.LittleEndian(reader.ReadUInt16()); //hdpi
            ImageUtils.LittleEndian(reader.ReadUInt16()); //vdpi
            ...
            int bytesPerLine = ImageUtils.LittleEndian(reader.ReadUInt16());
