...
namespace Acknex.Interfaces
{
    public interface IAcknexObject
    {
        ...
        void SetNumber(string propertyName, float value);
        ...
        float GetNumber(string propertyName, bool fromTemplate = true);
        ...
        bool TryGetNumber(string propertyName, out float result, bool fromTemplate = true);
