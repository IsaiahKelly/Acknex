        ...
        namespace Game {
            public class CONTATO : IAcknexRuntime {
...
_callbacks.Add("OBJ_CLICK", typeof(OBJ_CLICK));
CoroutinePool.TryToRegister<OBJ_CLICK>(out _, out _);
_callbacks.Add("FREEZE_UNFREEZE", typeof(FREEZE_UNFREEZE));
CoroutinePool.TryToRegister<FREEZE_UNFREEZE>(out _, out _);
...
if (Game.CheckEquals(UNDERWATER_16_val , 0f))
{
goto CONT;
}
HERE_19 = _world.GetSynonymObject(703);
temp_20 =HERE_19?.GetAcknexObject(234);
if (Game.CheckEquals(temp_20 , null))
{
goto CONT;
}
{
...
if (Game.CheckEquals(temp_46 , BLANKSTR_43))
{
goto NULLMESSAGE;
}
...
if (Game.CheckEquals(temp_23 , null))
{
return false;
}
MY_26 = MY;
...
if (Game.CheckEquals(HIT_DIST_29_val , 0f))
{
goto NOTVISIBLE;
}
ISVISIBLE:
...
if (Game.CheckEquals(temp_36 , 1f))
{
goto ISVISIBLE;
}
NOTVISIBLE:
...
if (Game.CheckEquals(temp_18 , null))
{
goto PROBELOOP;
}
MY_21 = MY;
...
MY_5 = MY;
MY_5.SetFloat(169,temp_3 + (-0.1f * _world.GetSkillValue(SkillName.TIME_CORR)));
MY_7 = MY;
...
if (Game.CheckEquals(WEAPONSEL_1_val , 1f))
{
...
if (Game.CheckEquals(WEAPONSEL_5_val , 2f))
{
...
if (Game.CheckEquals(WEAPONSEL_9_val , 3f))
{
...
if (Game.CheckEquals(WEAPONSEL_13_val , 4f))
{
...
if (Game.CheckEquals(WEAPONSEL_17_val , 5f))
{
...
if (!Game.CheckEquals(temp_44 , null))
{
goto SECOND;
}
...
if (!Game.CheckEquals(temp_74 , null))
{
goto THIRD;
}
...
if (!Game.CheckEquals(temp_104 , null))
{
goto FOURTH;
}
...
if (!Game.CheckEquals(temp_134 , null))
{
goto FIFTH;
}
...
if (!Game.CheckEquals(temp_164 , null))
{
goto SIXTH;
}
...
if (!Game.CheckEquals(temp_194 , null))
{
goto SEVENTH;
}
...
if (!Game.CheckEquals(temp_224 , null))
{
goto EIGHTH;
}
...
if (!Game.CheckEquals(temp_254 , null))
{
goto NINETH;
}
...
if (!Game.CheckEquals(temp_284 , null))
{
goto TENTH;
}
...
if (!Game.CheckEquals(temp_314 , null))
{
goto LAST;
}
...
if (Game.CheckEquals(UNDERWATER_17_val , 0f))
{
goto NOWATER;
}
{
...
if (Game.CheckEquals(SUBMENUITEM_23_val , 1f))
{
...
if (Game.CheckEquals(SUBMENUITEM_26_val , 2f))
{
...
if (Game.CheckEquals(SUBMENUITEM_29_val , 3f))
{
...
if (Game.CheckEquals(SUBMENUITEM_32_val , 4f))
{
...
if (!Game.CheckEquals(LEVEL_STRING_27 , null))
{
goto CONT;
}
...
if (Game.CheckEquals(HIT_DIST_30_val , 0f))
{
goto CONT;
}
...
if (Game.CheckEquals(HIT_DIST_39_val , 0f))
{
goto CONT;
}
{
...
if (Game.CheckEquals(MISSILECOUNTER_4_val , 16f))
{
MY_7 = MY;
...
if (Game.CheckEquals(temp_20 , 1f))
{
return false;
}
{
...
if (!Game.CheckEquals(temp_8 , FOLLOW_5))
{
...
if (Game.CheckEquals(temp_22 , 1f))
{
...
if (!Game.CheckEquals(temp_11 , FOLLOW_8))
{
...
if (Game.CheckEquals(HIT_MINDIST_6_val , 0f))
{
goto VANISH;
}
HIT_9 = _world.GetSynonymObject(704);
temp_10 =HIT_9.GetFloat(205);
if (Game.CheckEquals(temp_10 , 0f))
{
return false;
}
HIT_12 = _world.GetSynonymObject(704);
if (Game.CheckEquals(HIT_12 , null))
{
return false;
}
...
if (!Game.CheckEquals(DISTX_61_val , 0f))
{
MY_63 = MY;
MY_65 = MY;
...
if (Game.CheckEquals(temp_86 , 0f))
{
//Unknown keyword: LOCATE
}
MY_89 = MY;
...
if (!Game.CheckEquals(temp_21 , 1f))
{
goto GRANADE4;
}
...
if (!Game.CheckEquals(temp_27 , 1f))
{
goto REFUSE;
}
...
if (!Game.CheckEquals(LUP_1_val , 0f))
{
goto IMPL1;
}
MY_3 = MY;
...
if (!Game.CheckEquals(LUP1_18_val , 0f))
{
goto IMPL2;
}
MY_20 = MY;
...
if (!Game.CheckEquals(LUP2_35_val , 0f))
{
goto IMPL3;
}
MY_37 = MY;
...
if (!Game.CheckEquals(LUP3_52_val , 0f))
{
goto IMPL4;
}
MY_54 = MY;
...
if (!Game.CheckEquals(LUP4_69_val , 0f))
{
return false;
}
MY_71 = MY;
...
if (Game.CheckEquals(temp_88 , null))
{
...
if (Game.CheckEquals(LUP1_24_val , 0f))
{
goto LIGHT2;
}
...
if (Game.CheckEquals(LUP2_47_val , 0f))
{
goto LIGHT3;
}
...
if (Game.CheckEquals(LUP3_70_val , 0f))
{
goto LIGHT4;
}
...
if (Game.CheckEquals(LUP4_93_val , 0f))
{
goto CHECKEND;
}
...
if (!Game.CheckEquals(LUP_118_val , 0f))
{
...
if (!Game.CheckEquals(LUP1_123_val , 0f))
{
...
if (!Game.CheckEquals(LUP2_128_val , 0f))
{
...
if (!Game.CheckEquals(LUP3_133_val , 0f))
{
...
if (!Game.CheckEquals(LUP4_138_val , 0f))
{
...
if (Game.CheckEquals(CHECKENDFLAG_143_val , 0f))
{
...
if (Game.CheckEquals(temp_17 , 0f))
{
goto COAST;
}
MY_20 = MY;
...
MY_23 = MY;
MY_23.SetFloat(169,temp_21 + (-0.15f * _world.GetSkillValue(SkillName.TIME_CORR)));
MY_25 = MY;
...
if (Game.CheckEquals(temp_37 , null))
{
goto CONT;
}
...
if (Game.CheckEquals(MOVING_24_val , MODE_DEATH_23_val))
{
...
if (Game.CheckEquals(MOVING_31_val , MODE_GEHEN_30_val))
{
...
if (!Game.CheckEquals(MOVING_38_val , MODE_SCHWIMMEN_37_val))
{
goto NO_SWIM;
}
...
if (!Game.CheckEquals(MOVING_42_val , MODE_GEHEN_41_val))
{
goto NO_WATER;
}
...
if (Game.CheckEquals(MOUSE_MIDDLE_46_val , 0f))
{
goto NO_MOUSE;
}
...
if (Game.CheckEquals(KEY_SHIFT_52_val , 1f))
{
...
if (Game.CheckEquals(MOUSE_RIGHT_65_val , 1f))
{
...
if (!Game.CheckEquals(KEY_ALT_69_val , 1f))
{
goto NOALT;
}
...
if (!Game.CheckEquals(MOVING_146_val , MODE_GEHEN_145_val))
{
...
if (Game.CheckEquals(FALLING_HEIGHT_213_val , 0f))
{
goto AIRBORNE;
}
HERE_216 = _world.GetSynonymObject(703);
temp_217 =HERE_216?.GetAcknexObject(242);
if (Game.CheckEquals(temp_217 , null))
{
goto FELL;
}
...
if (Game.CheckEquals(MOVING_277_val , MODE_SCHWIMMEN_276_val))
{
goto DUCK;
}
...
if (!Game.CheckEquals(MOVING_293_val , MODE_GEHEN_292_val))
{
goto NO_JUMP;
}
...
if (!Game.CheckEquals(TILT_DECREASE_340_val , 1f))
{
goto CALC_TILT;
}
...
if (!Game.CheckEquals(PLAYER_VZ_348_val , 0f))
{
goto DECR_TILT;
}
goto CALC_TILT;
...
if (Game.CheckEquals(MOVING_386_val , MODE_SCHWIMMEN_385_val))
{
...
if (Game.CheckEquals(MOVING_395_val , MODE_TAUCHEN_394_val))
{
goto NO_HTILT;
}
...
if (Game.CheckEquals(TILT_DECREASE_399_val , 1f))
{
goto NO_HTILT;
}
...
if (Game.CheckEquals(RICHTER_414_val , 0f))
{
goto NO_QUAKE;
}
...
MOVING_1 = _world.GetObject(ObjectType.Skill,3242343005);
MOVING_1_val = MOVING_1.GetFloat(PropertyName.VAL);
if (Game.CheckEquals(MOVING_1_val , MODE_DEATH_0_val))
{
return false;
}
...
if (Game.CheckEquals(PLAYER_ARMOUR_13_val , 0f))
{
goto CONT;
}
...
if (!Game.CheckEquals(PLAYER_HIT_52_val , 0f))
{
return false;
}
...
if (!Game.CheckEquals(temp_90 , KILLPLAYER_87))
{
...
if (Game.CheckEquals(UNDERWATER_15_val , 0f))
{
goto NOWATER;
}
{
...
if (Game.CheckEquals(PLAYER_ARMOUR_17_val , 0f))
{
goto CONT;
}
HITSERIOUSNESS_18 = _world.GetObject(ObjectType.Skill,4168972789);
...
if (!Game.CheckEquals(PLAYER_HIT_30_val , 0f))
{
return false;
}
...
if (Game.CheckEquals(AMMO_11_val , 0f))
{
goto NOAMMO;
}
...
if (Game.CheckEquals(HIT_DIST_58_val , 0f))
{
goto SHOOT2;
}
HIT_61 = _world.GetSynonymObject(704);
temp_62 =HIT_61.GetFloat(208);
if (Game.CheckEquals(temp_62 , 1f))
{
goto CONTHIT;
}
SHOOT2:
...
if (Game.CheckEquals(HIT_DIST_66_val , 0f))
{
goto SHOOT3;
}
...
if (Game.CheckEquals(HIT_DIST_79_val , 0f))
{
goto SHOOT4;
}
HIT_82 = _world.GetSynonymObject(704);
temp_83 =HIT_82.GetFloat(208);
if (Game.CheckEquals(temp_83 , 1f))
{
goto CONTHIT;
}
SHOOT4:
...
if (Game.CheckEquals(HIT_DIST_89_val , 0f))
{
goto SHOOT5;
}
HIT_92 = _world.GetSynonymObject(704);
temp_93 =HIT_92.GetFloat(208);
if (Game.CheckEquals(temp_93 , 1f))
{
goto CONTHIT;
}
SHOOT5:
...
if (Game.CheckEquals(HIT_DIST_97_val , 0f))
{
goto NOHIT;
}
...
AMMO_13 = _world.GetObject(ObjectType.Skill,2088896983);
AMMO_13_val = AMMO_13.GetFloat(PropertyName.VAL);
if (Game.CheckEquals(AMMO_13_val , 0f))
{
goto NOAMMO;
}
AMMO_14 = _world.GetObject(ObjectType.Skill,2088896983);
...
if (Game.CheckEquals(HIT_DIST_92_val , 0f))
{
goto NOHIT;
}
...
if (Game.CheckEquals(GRANADE_3 , null))
{
return false;
}
GUNFIRING_5 = _world.GetObject(ObjectType.Skill,3478808598);
...
if (Game.CheckEquals(temp_133 , GRAN2TEX_130))
{
...
if (!Game.CheckEquals(WEAPONSEL_153_val , 3f))
{
goto FINISH;
}
...
if (Game.CheckEquals(MISSILE_1 , null))
{
return false;
}
GUNFIRING_3 = _world.GetObject(ObjectType.Skill,3478808598);
...
if (Game.CheckEquals(HIT_DIST_134_val , 0f))
{
goto HITWALL;
}
...
if (Game.CheckEquals(temp_190 , MISS2TEX_187))
{
...
if (!Game.CheckEquals(WEAPONSEL_219_val , 4f))
{
goto FINISH;
}
...
if (Game.CheckEquals(HIT_DIST_123_val , 0f))
{
goto HITWALL;
}
...
if (!Game.CheckEquals(temp_130 , 0f))
{
...
if (!Game.CheckEquals(WEAPONSEL_200_val , 5f))
{
goto FINISH;
}
...
if (!Game.CheckEquals(GUNFIRING_24_val , 0f))
{
goto WAITFIRE;
}
MY_GUN_26 = _world.GetSynonymObject(3254523708);
if (Game.CheckEquals(MY_GUN_26 , null))
{
goto NOGUN;
}
MY_GUN_29 = _world.GetSynonymObject(3254523708);
temp_30 =MY_GUN_29.GetFloat(204);
if (!Game.CheckEquals(temp_30 , 1f))
{
goto WAITFIRE;
}
NOGUN:
...
if (Game.CheckEquals(MY_GUN_40 , null))
{
goto CONT;
}
...
if (!Game.CheckEquals(HAS_PDA_5_val , 0f))
{
goto HASGOT;
}
...
if (Game.CheckEquals(MY_GUN_49 , null))
{
goto CONT;
}
...
if (Game.CheckEquals(MY_GUN_41 , null))
{
goto CONT;
}
...
if (Game.CheckEquals(MY_GUN_45 , null))
{
goto CONT;
}
MY_GUN_48 = _world.GetSynonymObject(3254523708);
...
_world.AcknexObject.SetAcknexObject(158,null);
MY_GUN_47 = _world.GetSynonymObject(3254523708);
if (Game.CheckEquals(MY_GUN_47 , null))
{
goto CONT;
}
...
if (Game.CheckEquals(SECCOUNTER_1_val , 0f))
{
//Unknown keyword: PLAY_CD
}
...
public class MOUSE_TOGGLE : ICompiledAction {
  private int _cursor;
  public IAcknexObject MY {get; set;}
  public IAcknexObject THERE {get; set;}
  public IAcknexWorld _world {get; set;}
 ...
 public MOUSE_TOGGLE(IAcknexObject MY, IAcknexObject THERE, IAcknexWorld world) {
      this.MY = MY;
      this.THERE = THERE;
      this._world = world;
  }
...
MOUSE_MODE_0 = _world.GetObject(ObjectType.Skill,388);
MOUSE_MODE_1 = _world.GetObject(ObjectType.Skill,388);
MOUSE_MODE_1_val = MOUSE_MODE_1.GetFloat(PropertyName.VAL);
MOUSE_MODE_0.SetFloat(231,MOUSE_MODE_1_val + 2f);
//Unknown keyword: IF
return false;
//Unknown keyword: 
      return false;
  }
IAcknexObject MOUSE_MODE_0;
IAcknexObject MOUSE_MODE_1;
float MOUSE_MODE_1_val;
}
public class SCAN_OBJ : ICompiledAction {
  private int _cursor;
  public IAcknexObject MY {get; set;}
  public IAcknexObject THERE {get; set;}
  public IAcknexWorld _world {get; set;}
 ...
 public SCAN_OBJ(IAcknexObject MY, IAcknexObject THERE, IAcknexWorld world) {
      this.MY = MY;
      this.THERE = THERE;
      this._world = world;
  }
...
public class OBJ_CLICK : ICompiledAction {
  private int _cursor;
  public IAcknexObject MY {get; set;}
  public IAcknexObject THERE {get; set;}
  public IAcknexWorld _world {get; set;}
 ...
 public OBJ_CLICK(IAcknexObject MY, IAcknexObject THERE, IAcknexWorld world) {
      this.MY = MY;
      this.THERE = THERE;
      this._world = world;
  }
...
TOUCHED_0 = _world.GetSynonymObject(702);
_world.SetSynonymObject(1114677733,TOUCHED_0);
INFO_TXT_4 = _world.AcknexObject.GetAcknexObject(4157323704);
INFO_TXT_4.SetFloat(205,1f);
INFO_TXT2_7 = _world.AcknexObject.GetAcknexObject(4047664106);
INFO_TXT2_7.SetFloat(205,1f);
{
            var enumerator = CoroutinePool.Get<SCAN_OBJ>();
            var compiledAction = (ICompiledAction)enumerator;
            compiledAction.MY = MY;
            compiledAction.THERE = THERE;
            compiledAction._world = _world;
...
IAcknexObject TOUCHED_0;
IAcknexObject INFO_TXT_4;
IAcknexObject INFO_TXT2_7;
}
public class FREEZE_UNFREEZE : ICompiledAction {
  private int _cursor;
  public IAcknexObject MY {get; set;}
  public IAcknexObject THERE {get; set;}
  public IAcknexWorld _world {get; set;}
 ...
 public FREEZE_UNFREEZE() {
  }
 public FREEZE_UNFREEZE(IAcknexObject MY, IAcknexObject THERE, IAcknexWorld world) {
      this.MY = MY;
      this.THERE = THERE;
      this._world = world;
  }
...
if (Game.CheckEquals(temp_3 , ENDPHASE_0))
{
goto CONT;
}
MY_6 = MY;
...
if (!Game.CheckEquals(temp_3 , 4f))
{
goto CONT;
}
MY_6 = MY;
temp_7 =MY_6.GetFloat(205);
if (!Game.CheckEquals(temp_7 , 1f))
{
goto CONT;
}
return false;
...
if (Game.CheckEquals(temp_24 , 4f))
{
goto HIDDING;
}
MY_27 = MY;
...
MY_2 = MY;
temp_3 =MY_2.GetFloat(176);
if (Game.CheckEquals(temp_3 , 10f))
{
return false;
}
MY_6 = MY;
temp_7 =MY_6.GetFloat(176);
if (Game.CheckEquals(temp_7 , 4f))
{
return false;
}
MY_10 = MY;
...
if (Game.CheckEquals(temp_19 , FOLLOW_16))
{
return false;
}
MY_22 = MY;
...
if (Game.CheckEquals(SHOOT_FAC_1_val , 0f))
{
goto OBSTACLE;
}
MY_2 = MY;
HIT_3 = _world.GetSynonymObject(704);
if (!Game.CheckEquals(HIT_3 , MY_2))
{
goto EXPLOSION;
}
...
if (Game.CheckEquals(EXPLOSION_ON_7_val , 0f))
{
goto OBSTACLE;
}
...
if (!Game.CheckEquals(EXPLOSION_ON_54_val , 2f))
{
goto CONT;
}
MY_57 = MY;
...
if (Game.CheckEquals(SHOT_SOUND_ON_13_val , 0f))
{
goto CONT;
}
{
...
if (Game.CheckEquals(temp_19 , 0f))
{
goto CONTFLAG2;
}
goto PLAYERSEEN;
...
if (Game.CheckEquals(temp_23 , 1f))
{
goto ATTACK;
}
{
...
if (Game.CheckEquals(temp_15 , FOLLOW_12))
{
return false;
}
MY_18 = MY;
...
if (Game.CheckEquals(HIT_DIST_37_val , 0f))
{
goto MISS;
}
...
if (Game.CheckEquals(EXPLOSION_ON_5_val , 0f))
{
goto OBSTACLE;
}
...
if (!Game.CheckEquals(EXPLOSION_ON_52_val , 2f))
{
goto GRANADE;
}
MY_55 = MY;
...
if (Game.CheckEquals(SHOT_SOUND_ON_5_val , 0f))
{
goto CONT;
}
{
...
if (Game.CheckEquals(temp_19 , 1f))
{
return false;
}
{
...
if (Game.CheckEquals(temp_23 , 0f))
{
goto STOP;
}
MY_26 = MY;
...
if (Game.CheckEquals(MISSILE_19 , null))
{
return false;
}
MY_22 = MY;
...
if (Game.CheckEquals(temp_35 , 0f))
{
goto MISS;
}
...
if (!Game.CheckEquals(temp_55 , 0f))
{
...
if (Game.CheckEquals(SHOT_SOUND_ON_1_val , 0f))
{
goto CONT;
}
{
...
if (Game.CheckEquals(temp_11 , 0f))
{
goto ATTACK;
}
SHOOT:
...
if (Game.CheckEquals(temp_15 , 10f))
{
return false;
}
FOLLOW_16 = _world.AcknexObject.GetAcknexObject(2968039200);
...
EXPLOSION_ON_7 = _world.GetObject(ObjectType.Skill,3352630890);
EXPLOSION_ON_7_val = EXPLOSION_ON_7.GetFloat(PropertyName.VAL);
if (!Game.CheckEquals(EXPLOSION_ON_7_val , 2f))
{
goto CONT;
}
MY_10 = MY;
...
if (!Game.CheckEquals(temp_104 , 1f))
{
goto JUMP;
}
...
if (!Game.CheckEquals(GUN_ON_37_val , 0f))
{
goto HIDE;
}
...
if (!Game.CheckEquals(SHOT_SOUND_ON_39_val , 0f))
{
goto HIDE;
}
...
if (!Game.CheckEquals(EXPLOSION_ON_41_val , 0f))
{
goto HIDE;
}
{
...
if (!Game.CheckEquals(TALKNURS_9_val , 0f))
{
return false;
}
...
if (!Game.CheckEquals(TALKDOCT_9_val , 0f))
{
return false;
}
...
if (Game.CheckEquals(DROPPED_1_val , 1f))
{
return false;
}
MY_4 = MY;
temp_5 =MY_4.GetFloat(171);
if (!Game.CheckEquals(temp_5 , 13f))
{
return false;
}
